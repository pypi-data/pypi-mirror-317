...
def multi_select_prompt(
    question: str, options: List[_T], help_message: Optional[str]
) -> List[_T]: ...
...
class PackageIndexData:
    ...
    other_homepages: List[str]
    license: Optional[str]
    longdescription: Optional[str]
    maintainers: List[str]
    upstream_maintainers: List[str]
    upstream_doc: Optional[str]
    upstream_bugs_to: Optional[str]
    upstream_changelog: Optional[str]
    tags: Set[str]

    def __init__(
        self, cpn: str, repo: str, category: str, package: str, name: str, desc: str
    ): ...

def update_index(index_path: str, repo: str, packages: List[PackageIndexData]): ...
def query(
    index_path: str, repos: List[str], query: str, limit: int
...
def parse_yaml_mapping(data: str, filename: str) -> Dict: ...

...
class VideoCombinator:
    """
    A class to combine and simplify the way we
    combine videos.
    """
    ...
    def video_over_video(self, video: Clip, background_video: Clip, position: Union[Position, DependantPosition, tuple, list]):
        ...
        ]).with_audio(self._process_audio(video, background_video))

    def _process_audio(self, added_video: Clip, main_video: Clip):
        """

...
def to_ms_dataset(
    ...
    ```
    """
    if config.MS_AVAILABLE:
        import mindspore as ms
    else:
        raise ImportError("Called a Mindspore-specific function but Mindspore is not installed.")
    ...
    output_signature, columns_to_np_types = get_ms_output_signature(dataset)

...
class Client:
    ...
    def GetToken(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.GetTokenRequest())
        if async_:
    ...
    def Login(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.UserLoginRequest())
        if async_:
    ...
    def Register(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.UserRegisterRequest())
        if async_:
    ...
    def GetSubFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.ListSubFileRequest())
        if async_:
    ...
    def GetSearchResults(
        ...
        message SubFilesReply { repeated CloudDriveFile subFiles = 1; }
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.SearchRequest())
        if async_:
    ...
    def FindFileByPath(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.FindFileByPathRequest())
        if async_:
    ...
    def CreateFolder(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.CreateFolderRequest())
        if async_:
    ...
    def CreateEncryptedFolder(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.CreateEncryptedFolderRequest())
        if async_:
    ...
    def UnlockEncryptedFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.UnlockEncryptedFileRequest())
        if async_:
    ...
    def LockEncryptedFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.FileRequest())
        if async_:
    ...
    def RenameFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.RenameFileRequest())
        if async_:
    ...
    def RenameFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.RenameFilesRequest())
        if async_:
    ...
    def MoveFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.MoveFileRequest())
        if async_:
    ...
    def CopyFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.CopyFileRequest())
        if async_:
    ...
    def DeleteFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.MultiFileRequest())
        if async_:
    ...
    def AddOfflineFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.AddOfflineFileRequest())
        if async_:
    ...
    def RemoveOfflineFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.RemoveOfflineFilesRequest())
        if async_:
    ...
    def ListAllOfflineFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.OfflineFileListAllRequest())
        if async_:
    ...
    def Logout(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.UserLogoutRequest())
        if async_:
    ...
    def AddMountPoint(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.MountOption())
        if async_:
    ...
    def RemoveMountPoint(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.MountPointRequest())
        if async_:
    ...
    def UpdateMountPoint(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.UpdateMountPointRequest())
        if async_:
    ...
    def LocalGetSubFiles(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LocalGetSubFilesRequest())
        if async_:
    ...
    def GetUploadFileList(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.GetUploadFileListRequest())
        if async_:
    ...
    def APILogin115Editthiscookie(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.Login115EditthiscookieRequest())
        if async_:
    ...
    def APILogin115QRCode(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.Login115QrCodeRequest())
        if async_:
    ...
    def APILoginAliyundriveOAuth(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginAliyundriveOAuthRequest())
        if async_:
    ...
    def APILoginAliyundriveRefreshtoken(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginAliyundriveRefreshtokenRequest())
        if async_:
    ...
    def APILoginAliyunDriveQRCode(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginAliyundriveQRCodeRequest())
        if async_:
    ...
    def APILoginBaiduPanOAuth(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginBaiduPanOAuthRequest())
        if async_:
    ...
    def APILoginOneDriveOAuth(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginOneDriveOAuthRequest())
        if async_:
    ...
    def ApiLoginGoogleDriveOAuth(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginGoogleDriveOAuthRequest())
        if async_:
    ...
    def ApiLoginGoogleDriveRefreshToken(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginGoogleDriveRefreshTokenRequest())
        if async_:
    ...
    def ApiLoginXunleiOAuth(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginXunleiOAuthRequest())
        if async_:
    ...
    def ApiLogin123panOAuth(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.Login123panOAuthRequest())
        if async_:
    ...
    def APILoginWebDav(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.LoginWebDavRequest())
        if async_:
    ...
    def APIAddLocalFolder(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.AddLocalFolderRequest())
        if async_:
    ...
    def RemoveCloudAPI(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.RemoveCloudAPIRequest())
        if async_:
    ...
    def GetCloudAPIConfig(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.GetCloudAPIConfigRequest())
        if async_:
    ...
    def GetEffectiveDirCacheTimeSecs(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.GetEffectiveDirCacheTimeRequest())
        if async_:
    ...
    def GetOpenFileTable(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.GetOpenFileTableRequest())
        if async_:
    ...
    def ChangePassword(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.ChangePasswordRequest())
        if async_:
    ...
    def CreateFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.CreateFileRequest())
        if async_:
    ...
    def CloseFile(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.CloseFileRequest())
        if async_:
    ...
    def WriteToFile(
        ...
        message WriteFileResult { uint64 bytesWritten = 1; }
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.WriteFileRequest())
        if async_:
    ...
    def JoinPlan(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.JoinPlanRequest())
        if async_:
    ...
    def CheckActivationCode(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.StringValue())
        if async_:
    ...
    def CheckCouponCode(
        ...
        """
        if isinstance(arg, dict): arg = ParseDict(arg, clouddrive.pb2.CheckCouponCodeRequest())
        if async_:

...
class Client:
    ...
    def GetToken(
        ...
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.GetTokenRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.GetTokenRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def Login(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.UserLoginRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.UserLoginRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def Register(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.UserRegisterRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.UserRegisterRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def GetSubFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.ListSubFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.ListSubFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def GetSearchResults(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.SearchRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.SearchRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def FindFileByPath(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.FindFileByPathRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.FindFileByPathRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CreateFolder(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.CreateFolderRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.CreateFolderRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CreateEncryptedFolder(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.CreateEncryptedFolderRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.CreateEncryptedFolderRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def UnlockEncryptedFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.UnlockEncryptedFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.UnlockEncryptedFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def LockEncryptedFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.FileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.FileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def RenameFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.RenameFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.RenameFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def RenameFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.RenameFilesRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.RenameFilesRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def MoveFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.MoveFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.MoveFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CopyFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.CopyFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.CopyFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def DeleteFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.MultiFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.MultiFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def AddOfflineFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.AddOfflineFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.AddOfflineFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def RemoveOfflineFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.RemoveOfflineFilesRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.RemoveOfflineFilesRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def ListAllOfflineFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.OfflineFileListAllRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.OfflineFileListAllRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def Logout(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.UserLogoutRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.UserLogoutRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def AddMountPoint(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.MountOption())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.MountOption()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def RemoveMountPoint(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.MountPointRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.MountPointRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def UpdateMountPoint(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.UpdateMountPointRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.UpdateMountPointRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def LocalGetSubFiles(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LocalGetSubFilesRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LocalGetSubFilesRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def GetUploadFileList(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.GetUploadFileListRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.GetUploadFileListRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILogin115Editthiscookie(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.Login115EditthiscookieRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.Login115EditthiscookieRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILogin115QRCode(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.Login115QrCodeRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.Login115QrCodeRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILoginAliyundriveOAuth(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginAliyundriveOAuthRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginAliyundriveOAuthRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILoginAliyundriveRefreshtoken(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginAliyundriveRefreshtokenRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginAliyundriveRefreshtokenRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILoginAliyunDriveQRCode(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginAliyundriveQRCodeRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginAliyundriveQRCodeRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILoginBaiduPanOAuth(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginBaiduPanOAuthRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginBaiduPanOAuthRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILoginOneDriveOAuth(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginOneDriveOAuthRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginOneDriveOAuthRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def ApiLoginGoogleDriveOAuth(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginGoogleDriveOAuthRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginGoogleDriveOAuthRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def ApiLoginGoogleDriveRefreshToken(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginGoogleDriveRefreshTokenRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginGoogleDriveRefreshTokenRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def ApiLoginXunleiOAuth(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginXunleiOAuthRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginXunleiOAuthRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def ApiLogin123panOAuth(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.Login123panOAuthRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.Login123panOAuthRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APILoginWebDav(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.LoginWebDavRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.LoginWebDavRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def APIAddLocalFolder(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.AddLocalFolderRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.AddLocalFolderRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def RemoveCloudAPI(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.RemoveCloudAPIRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.RemoveCloudAPIRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def GetCloudAPIConfig(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.GetCloudAPIConfigRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.GetCloudAPIConfigRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def GetEffectiveDirCacheTimeSecs(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.GetEffectiveDirCacheTimeRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.GetEffectiveDirCacheTimeRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def GetOpenFileTable(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.GetOpenFileTableRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.GetOpenFileTableRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def ChangePassword(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.ChangePasswordRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.ChangePasswordRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CreateFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.CreateFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.CreateFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CloseFile(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.CloseFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.CloseFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def WriteToFileStream(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.WriteFileRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.WriteFileRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def JoinPlan(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.JoinPlanRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.JoinPlanRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CheckActivationCode(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.StringValue())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.StringValue()) if isinstance(a, dict) else a for a in arg]
        if async_:
    ...
    def CheckCouponCode(
        ...
        """
        if isinstance(arg, dict):
            arg = ParseDict(arg, clouddrive.pb2.CheckCouponCodeRequest())
        elif isinstance(arg, Sequence):
            arg = [ParseDict(arg, clouddrive.pb2.CheckCouponCodeRequest()) if isinstance(a, dict) else a for a in arg]
        if async_:

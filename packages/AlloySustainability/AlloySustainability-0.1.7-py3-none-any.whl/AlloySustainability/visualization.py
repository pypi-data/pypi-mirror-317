...
def plot_alloy_comparison(new_alloy_impacts, RTHEAs_Fe_df, HTHEAs_Ni_df):
    ...
    BCC_HEAs_filtered = HTHEAs_Ni_df[HTHEAs_Ni_df['Class'] == 'BCC-(R)HEAs & HESAs']
    ...
    fig.suptitle("Violin plots of calculated alloy impacts compared to HEAs and conventional alloys", fontsize=16, fontweight="bold")

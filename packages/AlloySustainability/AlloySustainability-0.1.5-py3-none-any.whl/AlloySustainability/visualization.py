...
def plot_alloy_comparison(new_alloy_impacts, Steels_filtered, Ni_filtered, RTHEAs_filtered, HTHEAs_filtered):
    indicators = [
    ...
    for idx, indicator in enumerate(indicators):
        ...
        data = pd.concat([
            ...
            pd.DataFrame({"Group": "FCC HEAs", "Dataset": "RTHEAs", "Value": RTHEAs_filtered[indicator]}),
            pd.DataFrame({"Group": "BCC HEAs", "Dataset": "HTHEAs", "Value": HTHEAs_filtered[indicator]})
        ])

        sns.violinplot(
            x="Group", y="Value", hue="Dataset", data=data, ax=ax, split=True,
            palette={"Steels": "#1f77b4", "Ni": "#ff7f0e", "RTHEAs": "#2ca02c", "HTHEAs": "#d62728"},
        ...
        mean_values = {
            ...
            "RTHEAs": RTHEAs_filtered[indicator].mean(),
            "HTHEAs": HTHEAs_filtered[indicator].mean()
        }
        median_values = {
            "Steels": Steels_filtered[indicator].median(),
            "Ni": Ni_filtered[indicator].median(),
            "RTHEAs": RTHEAs_filtered[indicator].median(),
            "HTHEAs": HTHEAs_filtered[indicator].median()
        }
        ...
        new_alloy_value = float(new_alloy_impacts[indicator].iloc[0])  # Utiliser iloc[0] pour garantir une valeur scalaire

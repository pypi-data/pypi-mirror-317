...
def parser_add_args(parser):
    ...
    parser.add_argument('-d', '--date', type=to_gps, nargs='*', default=[], help='Date of analysis')
    ...
    parser.add_argument('dirs', nargs='*', help='directory paths or globs to scan')
    ...
    parser.add_argument('--tag', type=str, default='no-tag', help='Text to add to output files')
...
def main():
    global logger, job_satistics, omicron_statistics
    ...
    if args.stat_dir is not None:
        ...
        proc_param_stat_path = stat_dir / f'{args.tag}-proc_param_stats.csv'

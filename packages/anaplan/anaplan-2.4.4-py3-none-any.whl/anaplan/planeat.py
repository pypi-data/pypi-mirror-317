...
Args:
    ...
    cross_over_mode (str, optional): Specifies the crossover method to use. Options:
                                      ...
                                      Default is 'tpm'.
    activation_add_prob (float, optional): The probability of adding a new activation function to the genome. Must be in the range [0, 1]. Default is 0.5.
    activation_delete_prob (float, optional): The probability of deleting an existing activation function from the genome. Must be in the range [0, 1]. Default is 0.5.
...
def cross_over(best_weight, good_weight, best_activations, good_activations, cross_over_mode='tpm'):
   """
    ...
    Args:
        ...
        cross_over_mode (str, optional): Determines the crossover method to be used. Options:
...
def mutation(weight, activations, activation_mutate_prob, activation_add_prob, activation_delete_prob, activation_change_prob, weight_mutate_prob, threshold):
   ...
   if potential_activation_mutation > activation_mutate_prob:
      ...
      if potential_activation_add_prob > activation_add_prob:
         ...
         if potential_activation_delete_prob > activation_delete_prob:

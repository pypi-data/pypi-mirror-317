...
def to_operator_list(qubit_operator: QubitOperator, ignore_small_coef: bool = True, small_coef_tol: float = 1e-8)\
        -> List[List[Union[str, List[float], float]]]:
    ...
    for term, coef in sorted(qubit_operator.terms.items()):
        ...
        operator.append([paulis_str, [coef.real, coef.imag]])

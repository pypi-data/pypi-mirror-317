...
from tortoise3.pypika import Table

from tortoise3.backends.base.client import BaseDBAsyncClient
from tortoise3.backends.base.config_generator import expand_db_url, generate_config
from tortoise3.connection import connections
from tortoise3.exceptions import ConfigurationError
from tortoise3.fields.relational import (
    BackwardFKRelation,
...
from tortoise3.filters import get_m2m_filters
from tortoise3.log import logger
from tortoise3.models import Model, ModelMeta
from tortoise3.utils import generate_schema_for_client
...
class Tortoise:
    ...
    def get_connection(cls, connection_name: str) -> BaseDBAsyncClient:
        ...
        .. warning::
           ...
           :meth:`connections.get<tortoise3.connection.ConnectionHandler.get>` instead.
        """
    ...
    def describe_model(
        ...
        See :meth:`tortoise3.models.Model.describe`

        .. warning::
           This is deprecated, please use :meth:`tortoise3.models.Model.describe` instead
        """
        warnings.warn(
                ...
                .. code-block:: python3

                    {
                        'connections': {
                            ...
                            'default': {
                                'engine': 'tortoise3.backends.asyncpg',
                                'credentials': {
                                    'host': 'localhost',
                                    'port': '5432',
                                    'user': 'tortoise3',
    ...
    def _init_routers(cls, routers: Optional[List[Union[str, type]]] = None):
        from tortoise3.router import router
    ...
    async def close_connections(cls) -> None:
        ...
        .. warning::
           This is deprecated and will be removed in a future release. Please use
           :meth:`connections.close_all<tortoise3.connection.ConnectionHandler.close_all>` instead.
        """
...
def run_async(coro: Coroutine) -> None:
    ...
    Usage::
        ...
        from tortoise3 import Tortoise, run_async

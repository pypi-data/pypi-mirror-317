...
if TYPE_CHECKING:  # pragma: nocoverage
    ...
    from tortoise3.queryset import QuerySet, QuerySetSingle
...
def _get_fetch_fields(
    ...
    :param model_class: The tortoise3 model class
...
class PydanticModel(BaseModel):
    ...
    async def from_tortoise_orm(cls, obj: "Model") -> "PydanticModel":
        ...
        .. note::
            ...
            :class:`tortoise3.contrib.pydantic.creator.PydanticMeta`, or you would be

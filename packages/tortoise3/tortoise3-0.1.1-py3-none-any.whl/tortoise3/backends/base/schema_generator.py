...
from tortoise3.fields import JSONField, TextField, UUIDField
from tortoise3.indexes import Index

if TYPE_CHECKING:  # pragma: nocoverage
    from tortoise3.backends.base.client import BaseDBAsyncClient
    from tortoise3.fields.relational import ForeignKeyFieldInstance  # noqa
    from tortoise3.fields.relational import ManyToManyFieldInstance
...
class BaseSchemaGenerator:
    ...
    def _get_models_to_create(self, models_to_create: "List[Type[Model]]") -> None:
        from tortoise3 import Tortoise

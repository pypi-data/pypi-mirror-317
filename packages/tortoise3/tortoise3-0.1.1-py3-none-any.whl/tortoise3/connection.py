...
from tortoise3.backends.base.config_generator import expand_db_url
...
class ConnectionHandler:
    ...
    def db_config(self) -> "DBConfigType":
        ...
        :meth:`Tortoise.init<tortoise3.Tortoise.init>` method while initialization.

        :raises ConfigurationError:
            If this property is accessed before calling the
            :meth:`Tortoise.init<tortoise3.Tortoise.init>` method.
        """
        if self._db_config is None:
    ...
    def get(self, conn_alias: str) -> "BaseDBAsyncClient":
        ...
        (:class:`BaseDBAsyncClient<tortoise3.backends.base.client.BaseDBAsyncClient>`) for the
        given alias.
    ...
    def reset(self, token: contextvars.Token) -> None:
        ...
        :param token:
            ...
            :meth:`set<tortoise3.connection.ConnectionHandler.set>` method of this class.
        """

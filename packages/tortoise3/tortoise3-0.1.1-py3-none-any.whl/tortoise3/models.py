...
from tortoise3.pypika import Order, Query, Table
from tortoise3.pypika.terms import Term
from typing_extensions import Self

from tortoise3 import connections
from tortoise3.backends.base.client import BaseDBAsyncClient
from tortoise3.exceptions import (
    ConfigurationError,
    DoesNotExist,
...
from tortoise3.fields.base import Field
from tortoise3.fields.data import IntField
...
from tortoise3.filters import get_filters_for_field
from tortoise3.functions import Function
from tortoise3.indexes import Index
from tortoise3.manager import Manager
from tortoise3.queryset import (
    BulkCreateQuery,
    BulkUpdateQuery,
    ExistsQuery,
    Q,
...
from tortoise3.signals import Signals
from tortoise3.transactions import in_transaction
...
class Model(metaclass=ModelMeta):
    ...
    def register_listener(cls, signal: Signals, listener: Callable):
        ...
        :param signal: one of tortoise3.signals.Signals
    ...
    def describe(cls, serializable: bool = True) -> dict:
        ...
        :return:
            ...
            Each field is specified as defined in :meth:`tortoise3.fields.base.Field.describe`
        """
        return {

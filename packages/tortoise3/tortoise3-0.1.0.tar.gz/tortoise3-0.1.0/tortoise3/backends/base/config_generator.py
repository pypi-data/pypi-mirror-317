...
DB_LOOKUP: Dict[str, Dict[str, Any]] = {
    "psycopg": {
        "engine": "tortoise3.backends.psycopg",
        "vmap": {
            "path": "database",
            "hostname": "host",
            "port": "port",
    ...
    "sqlite": {
        "engine": "tortoise3.backends.sqlite",
    ...
    "mysql": {
        "engine": "tortoise3.backends.mysql",
        "vmap": {
            "path": "database",
            "hostname": "host",
            "port": "port",
    ...
    "mssql": {
        "engine": "tortoise3.backends.mssql",
        "vmap": {
            "path": "database",
            "hostname": "host",
            "port": "port",
    ...
    "oracle": {
        "engine": "tortoise3.backends.oracle",
        "vmap": {
            "path": "database",
            "hostname": "host",
            "port": "port",

...
urlpatterns = [
    ...
    path(
        "software-products/", 
        views.SoftwareProductListView.as_view(), 
        name="softwareproduct_list"
    ),
    path(
        "software-products/add/", 
        views.SoftwareProductEditView.as_view(), 
        name="softwareproduct_add"
    ),
    path(
        "software-products/delete/", 
        views.SoftwareProductBulkDeleteView.as_view(), 
        name="softwareproduct_bulk_delete"
    ),
    path(
        "software-products/<int:pk>/", 
        views.SoftwareProductView.as_view(), 
        name="softwareproduct"
    ),
    path(
        "software-products/<int:pk>/delete/",
        views.SoftwareProductDeleteView.as_view(), 
        name="softwareproduct_delete"
    ),
    path(
        "software-products/<int:pk>/edit/", 
        views.SoftwareProductEditView.as_view(), 
    ...
    path(
        "versions/", 
        views.SoftwareProductVersionListView.as_view(), 
        name="softwareproductversion_list"
    ),
    path(
        "versions/add/", 
        views.SoftwareProductVersionEditView.as_view(), 
    ...
    path(
        "versions/<int:pk>/", 
        views.SoftwareProductVersionView.as_view(), 
    ...
    path(
        'versions/import/', 
        views.SoftwareProductVersionBulkImportView.as_view(), 
        name='softwareproductversion_import'
    ),

    ## SoftwareProductVersion -> Installation
    path(
        'versions/<int:pk>/installations/', 
        views.SwVersionInstallView.as_view(), 
        name='softwareproductversion_softwareproductinstallation'
    ),
    ...
    path(
        "licenses/", 
        views.SoftwareLicenseListView.as_view(), 
        name="softwarelicense_list"
    ),
    path(
        "licenses/add/", 
        views.SoftwareLicenseEditView.as_view(), 
        name="softwarelicense_add"
    ),
    path(
        "licenses/delete/", 
        views.SoftwareLicenseBulkDeleteView.as_view(), 
        name="softwarelicense_bulk_delete"
    ),
    path(
        "licenses/<int:pk>/", 
        views.SoftwareLicenseView.as_view(), 

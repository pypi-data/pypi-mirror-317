...
class Bpc:
    ...
    def set_tile(
        self, layer: int, index: int, tile_mapping
    ) -> None: ...  # : List[TilemapEntry]
    ...
    def get_bpas_for_layer(
        self, layer: int, bpas_from_bg_list: Sequence[Optional[Bpa]]
    ) -> List[Bpa]: ...
    def set_chunk(
        self, layer: int, index: int, new_tilemappings
    ) -> None: ...  # : List[TilemapEntry]

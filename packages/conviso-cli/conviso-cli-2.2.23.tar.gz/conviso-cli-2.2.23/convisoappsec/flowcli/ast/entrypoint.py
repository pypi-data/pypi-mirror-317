    ...
    try:
        ...
        try:
            ...
            try:
                ...
                branch_name = "fdetached-HEAD-{created_deploy['current_commit'][:7]}"
            ...
            logger.info(f"Error while creating deploy: {error}")
            log_and_notify_ast_event(
                flow_context=flow_context, company_id=prepared_context.params['company_id'], asset_id=prepared_context.params['asset_id'],
                ast_log=full_trace
            )

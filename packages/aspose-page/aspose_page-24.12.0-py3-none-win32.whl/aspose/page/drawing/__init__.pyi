...
class SizeF:
    ...
    @overload
    def __init__(self, pt: aspose.page.drawing.PointF):
        '''Initializes a new instance of the :class:`SizeF` structure from the specified :class:`PointF` structure.
        
        :param pt: The :class:`PointF` structure from which to initialize this :class:`SizeF` structure.'''
        ...

...
def test(
    ...
    if (model is None and source is None and seed is None) or (model and source and seed):
        typer.echo("❌  Please provide either --model, --seed, or --source, but not two or more.")

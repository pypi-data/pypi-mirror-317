...
from breeze.utils.yaml_utils import load_yaml_file, write_yaml_file, find_yaml_path, add_tests_to_yaml, format_description
from breeze.utils.template_utils import get_template_content
from breeze.utils.dbt_utils import load_manifest, find_model_in_manifest, get_entity_paths_from_dbt_project
...
def create_model_yml(
    ...
    content = jinja_template.render(
        ...
        model_description=format_description(model_description)
    )

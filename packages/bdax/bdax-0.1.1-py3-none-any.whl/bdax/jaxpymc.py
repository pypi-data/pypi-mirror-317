...
class Sampler(ABC):
    ...
    def sample(self, n_chains: int = 4, n_samples: int = 1_000, n_warmup: int = 1_000,
        ...
        self.summary = az.summary(self.idata)
    ...
    def plot_posterior(self, path: os.PathLike, var_names: Optional[list] = None) -> None:
        ...
        for var_name in var_names:
            try:
                axes = az.plot_posterior(self.idata, var_names=[var_name])

...
class ClusterRole(Resource):
    ...
    metadata: Annotated[
        Optional[v1.ObjectMeta], Field(description="Standard object's metadata.")
    ] = None
    rules: Annotated[
...
class ClusterRoleBindingList(Resource):
    api_version: Annotated[
        Optional[Literal["rbac.authorization.k8s.io/v1"]],
        Field(
            alias="apiVersion",
    ...
    metadata: Annotated[Optional[v1.ListMeta], Field(description="Standard object's metadata.")] = (
        None
    )


class ClusterRoleList(Resource):
    api_version: Annotated[
        Optional[Literal["rbac.authorization.k8s.io/v1"]],
        Field(
            alias="apiVersion",

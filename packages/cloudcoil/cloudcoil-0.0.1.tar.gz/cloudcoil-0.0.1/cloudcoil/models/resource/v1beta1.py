...
class DeviceClass(Resource):
    ...
    metadata: Annotated[Optional[v1.ObjectMeta], Field(description="Standard object metadata")] = (
        None
    )
    spec: Annotated[
        DeviceClassSpec,
...
class DeviceClassList(Resource):
    ...
    metadata: Annotated[Optional[v1.ListMeta], Field(description="Standard list metadata")] = None

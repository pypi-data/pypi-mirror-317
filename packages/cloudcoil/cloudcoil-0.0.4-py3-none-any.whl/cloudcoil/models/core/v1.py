...
class NamespaceCondition(BaseModel):
    last_transition_time: Annotated[Optional[v1.Time], Field(alias="lastTransitionTime")] = None
...
class ResourceQuotaList(Resource):
    api_version: Annotated[
        Optional[Literal["v1"]],
        Field(
            alias="apiVersion",
...
class PodTemplateList(Resource):
    api_version: Annotated[
        Optional[Literal["v1"]],
        Field(
            alias="apiVersion",
...
class ReplicationControllerList(Resource):
    api_version: Annotated[
        Optional[Literal["v1"]],
        Field(
            alias="apiVersion",

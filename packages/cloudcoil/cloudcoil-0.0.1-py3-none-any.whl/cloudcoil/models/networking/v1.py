...
class IngressClassList(Resource):
    api_version: Annotated[
        Optional[Literal["networking.k8s.io/v1"]],
        Field(
            alias="apiVersion",
    ...
    metadata: Annotated[Optional[v1_1.ListMeta], Field(description="Standard list metadata.")] = (
        None
    )
...
class NetworkPolicyList(Resource):
    api_version: Annotated[
        Optional[Literal["networking.k8s.io/v1"]],
        Field(
            alias="apiVersion",

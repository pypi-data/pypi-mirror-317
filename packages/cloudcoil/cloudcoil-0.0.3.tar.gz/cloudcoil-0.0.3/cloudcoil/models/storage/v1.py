...
class CSIStorageCapacityList(Resource):
    api_version: Annotated[
        Optional[Literal["storage.k8s.io/v1"]],
        Field(
            alias="apiVersion",
...
class StorageClass(Resource):
    ...
    allowed_topologies: Annotated[
        Optional[List[v1_1.TopologySelectorTerm]],
        Field(
...
class VolumeAttachmentList(Resource):
    api_version: Annotated[
        Optional[Literal["storage.k8s.io/v1"]],
        Field(
            alias="apiVersion",

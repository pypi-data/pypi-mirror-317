...
from perin_parser.thirdparty.mtool.ucca.convert import file2passage, passage2file, from_text, to_text, split2segments
from perin_parser.thirdparty.mtool.ucca.core import Passage

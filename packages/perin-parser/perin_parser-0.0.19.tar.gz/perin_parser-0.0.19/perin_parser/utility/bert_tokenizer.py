...
def bert_tokenizer(example, tokenizer:PreTrainedTokenizer):
    encoder = tokenizer.name_or_path
    if "xlm" in encoder.lower():
        ...
        separator = '##'
    elif "chinese-electra" in encoder.lower() or 'ernie-gram' in encoder.lower():
        separator = '##'
    else:

...
from dozersim.visualizations._plotting import get_variable_plot, plot_results_3d, plot_results_scatter, \
    plot_results_2d
...
class AnalysisWindows(QTabWidget):
    ...
    def add_plot(self, x_object, y_object, z_object=None,
        ...
        z_type = issubclass(type(z_object), (Parameter | Objective))
...
class ResultWindow(QTabWidget):
    ...
    def __init__(self, result: Result, parent=None):
        ...
        for load_case in result.load_cases:
            ...
            headers, data = result.get_result_table(load_case=load_case)

...
def get_variable_plot(var) -> Figure:
...
def plot_results_2d(analysis: Analysis,
                    x_object: parameters.Parameter | objectives.Objective,
                    y_object: parameters.Parameter | objectives.Objective | list,
                    *args, **kwargs) -> Figure:
    """
    Plot a single
...
def plot_results_3d(analysis: Analysis,
                    ...
                    z_object: parameters.Parameter | objectives.Objective) -> Figure:
    """
    Plot a single
...
def plot_results_scatter(analysis: Analysis, x_object: objectives.Objective,
                         y_object: objectives.Objective,
                         *args, **kwargs) -> Figure:
    """
    Plot a single
...
#        headers, data = analysis.get_result_sets()

...
class basic_data:
	...
	def __init__(self):
		...
		self.vars["알파벳"] = self.vars["list_알파벳"] = "abcdefghijklmnopqrstuvwxyz"
		self.vars["ㄱ"] = self.vars["list_자음"] = "ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎ"
		self.vars["ㅏ"] = self.vars["list_모음"] ="ㅏㅑㅓㅕㅗㅛㅜㅠㅡㅣ"
		self.vars["가"] = self.vars["list_가나다"] = "가나다라마바사아자차카타파하"
		self.vars["숫자"] = self.vars["list_숫자"]= "1234567890"
		self.vars["그리스문자"] = self.vars["list_그리스문자"]= "αβγδεζήθικλμνξόπρΣτ"
		self.vars["로마숫자"] = self.vars["list_로마숫자"] = "ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩ"
		self.vars["원ㄱ"] = self.vars["list_원ㄱ"] = "㉠㉡㉢㉣㉤㉥㉦㉧㉨㉩㉪㉫㉬㉭"
		self.vars["원가"] = self.vars["list_원가"] = "㉮㉯㉰㉱㉲㉳㉴㉵㉶㉷㉸㉹㉺㉻"
		self.vars["원a"] = self.vars["list_원a"] = "ⒶⒷⒸⒹⒺⒻⒼⒽⒾⒿⓀⓁⓂⓃⓄⓅⓆⓇⓈⓉⓊⓋⓌⓍⓎⓏ"
		self.vars["원1"] = self.vars["list_원1"] ="⓪①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮⑯⑰⑱⑲⑳㉑㉒㉓㉔㉕㉖㉗㉘㉙㉚㉛㉜㉝㉞㉟㊱㊲㊳㊴㊵㊶㊷㊸㊹㊺㊻㊼㊽㊾㊿"
		...
		self.vars["자음"] = self.vars["list_자음_19"] = self.vars["first_letter"] = ["ㄱ", "ㄲ", "ㄴ", "ㄷ", "ㄸ", "ㄹ", "ㅁ", "ㅂ", "ㅃ", "ㅅ", "ㅆ", "ㅇ", "ㅈ", "ㅉ", "ㅊ", "ㅋ", "ㅌ", "ㅍ", "ㅎ"]  # 19 글자
		self.vars["모음"] = self.vars["list_모음_21"] = self.vars["second_letter"] = ["ㅏ", "ㅐ", "ㅑ", "ㅒ", "ㅓ", "ㅔ", "ㅕ", "ㅖ", "ㅗ", "ㅘ", "ㅙ", "ㅚ", "ㅛ", "ㅜ", "ㅝ", "ㅞ", "ㅟ", "ㅠ", "ㅡ", "ㅢ", "ㅣ"]  # 21 글자
		self.vars["받침"] = self.vars["list_받침_28"] = self.vars["third_letter"] = ["", "ㄱ", "ㄲ", "ㄳ", "ㄴ", "ㄵ", "ㄶ", "ㄷ", "ㄹ", "ㄺ", "ㄻ", "ㄼ", "ㄽ", "ㄾ", "ㄿ", "ㅀ", "ㅁ", "ㅂ", "ㅄ", "ㅅ", "ㅆ", "ㅇ", "ㅈ", "ㅊ", "ㅋ", "ㅌ", "ㅍ", "ㅎ"]  # 28 글자, 없는것 포함
		...
		self.vars["list_기본12색_hsl"] = self.vars["list_basic_12hsl"] = self.vars["list_12단계_hsl값"] = self.vars["hsl_no_for_basic_12"] = [[0, 100, 50], [30, 100, 50], [60, 100, 50], [90, 100, 50], [120, 100, 50],	 [150, 100, 50], [180, 100, 50], [210, 100, 50], [240, 100, 50], [270, 100, 50], [300, 100, 50], [330, 100, 50]]
		self.vars["list_12단계_h값"] = self.vars["list_basic_12h"] = self.vars["h_no_for_basic_12"] =self.vars["basic_12color_h"] =  [0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330]
		self.vars["basic_12color_sl"] = self.vars["list_12가지톤_sl값"] = self.vars["sl_no_for_12_color_tone"] = self.vars["list_12단계_칼라스타일"] = self.vars["list_basic_12colorstyle"] = self.vars["list_12단계_색스타일_sl값"] = self.vars["list_colorstyle_slno"] = [[90, 50], [80, 30], [80, 50], [80, 70], [50, 20], [50, 40], [50, 60], [50, 80], [20, 20], [20, 40], [20, 60], [20, 80]]
		...
		self.vars["basic_11color_sl"] = self.vars["list_11단계_sl값"] = self.vars["sl_no_for_basic_11"] = self.vars["list_basic_11sl"] = [[100, 0], [100, 10], [100, 20], [100, 30], [100, 40], [100, 50], [100, 60], [100, 70], [100, 80], [100, 90], [100, 100]]
		self.vars["list_기본12색_rgb"] = self.vars["list_basic_12rgb"] = self.vars["list_12단계_rgb값"] = [[255, 0, 0], [255, 128, 0], [255, 255, 0], [128, 255, 0],	[0, 255, 0], [0, 255, 128], [0, 255, 255], [0, 128, 255],	[0, 0, 255], [128, 0, 255], [255, 0, 255], [255, 0, 128], ]
		...
		self.vars["list_10단계_sl값"] = self.vars["list_basic_10sl"] = self.vars["sl_no_for_basic_10"] = self.vars["basic_10color_sl"] = [[100, 0], [90, 10], [80, 20], [70, 30], [60, 40], [50, 50], [40, 60], [30, 70], [10, 80], [10, 90], [0, 100]]
		...
		self.vars["color_tone_basic_vs_index"] = {"v": 0, "b": 1, "s": 2, "dp": 3, "lt": 4, "sf": 5, "d": 6,  "dk": 7, "p": 8, "ltg": 9, "g": 10, "dkg": 11,}
		...
		self.vars["month"] = self.vars["list_월이름_영어"] = self.vars["list_month_eng"] = ['JANUARY', 'FEBRUARY', 'MARCH', 'APRIL', 'MAY', 'JUNE', 'JULY', 'AUGUST', 'SEPTEMBER', 'OCTOBER', 'NOVEMBER', 'DECEMBER']
		...
		self.vars["dic_월이름_영어_vs_번호"] = self.vars["mon_eng_vs_no"] = self.vars["check_month_vs_no"] = self.vars["dic_mon_no"] = {'january': 1, 'february': 2, 'march': 3, 'april': 4, 'may': 5, 'june': 6, 'july': 7,
		...
		self.vars["check_week_vs_num"] = self.vars["week_vs_num"] = self.vars["week_vs_enum"] = {'monday': 1, 'tuesday': 2, 'wendsday': 3, 'thursday': 4, 'friday': 5, 'saturday': 6, 'sunday': 7,
		...
		self.vars["check_line_position"] = {
					...
					"h": [11], "inside-h": [11], "inh": [11], "안쪽세로": [11], "hor": [11],
					"v": [12], "inside-v": [12], "inv": [12], "안쪽가로": [12], "ver": [12],
					"in": [11, 12],
					"o": [7, 8, 9, 10], "테두리": [7, 8, 9, 10], "": [7, 8, 9, 10], "out": [7, 8, 9, 10], "outside": [7, 8, 9, 10],
		...
		self.vars["check_line_para"] =  self.vars["dic_선위치_vs_index번호"] = {
		...
		self.vars["dic_색이름_한글_vs_색이름_영어"] = self.vars["check_color_name_eng"] = self.vars["check_color_name"]={
			...
			0: "red",	1: "ora", 30: "ora", 2: "yel", 60: "yel",
			3: "gre_yel", 90: "gre_yel",4: "gre", 120: "gre", "green-cyan": "gre_cya", 5: "gre_cya", 150: "gre_cya",
			6: "cya", 180: "cya", "blue-cyan": "blu_cya", 7: "blu_cya", 210: "blu_cya",
			8: "blu", 240: "blu", "blue-magenta": "blu_mag", "mb": "blu_mag", 9: "blu_mag", 270: "blu_mag",
			10: "mag", 300: "mag", "red-magenta": "red_mag", 11: "red_mag", 330: "red_mag",
			12: "gra", 13: "whi", 14: "bla",
			"군청": "blu_cya",
		}
		...
		self.vars["check_color_tone"] = self.vars["dic_색톤_vs_기본_색톤_영어"] = self.vars["dic_색스타일_vs_기본_색스타일"] = self.vars["dic_check_colorstyle"] = {
		...
		self.vars["check_color_step"] = self.vars["check_change_step"] = self.vars["dic_색강도_vs_기본값"] = self.vars["dic_colorname_colornum_forexcel"] = {
		...
		self.vars["excel56_vs_color_kor"] = self.vars["dic_엑셀_색번호_vs_색이름"] = self.vars["excel_colorindex_vs_color_name"] = self.vars["dic_엑셀_색번호_vs_색이름_한글"] = self.vars["dic_colornum_colorname_forexcel"] = {
		...
		self.vars["dic_색이름_vs_엑셀_색번호"] = self.vars["excel_colorname_vs_colorindex"] = self.vars["dic_색이름_한글_vs_엑셀_색번호"] = {
			"bla": 1, "whi": 2, "blu": 5, "yel": 6,
			"pin": 7, "ora": 46, "pur": 13, "gre": 14, "gra": 15,
		...
		self.vars["list_faber의_sl값"] = self.vars["list_faber_sl"] = self.vars["faber_to_sl"] = [
					[[100, 0], [100, 50], [0, 0]],
					[[0, 0], [0, 75], [0, 100]],
					[[100, 0], [25, 75], [0, 100]],
					[[25, 0], [10, 50], [0, 75]],
		...
		self.vars["dic_선모양_vs_index번호"] = self.vars["enum_line"] = self.vars["end_style_vs_enum"] = {
		...
		self.vars["excel46_vs_rgb"] = self.vars["excel46_no_vs_rgb"] = {
		...
		self.vars["dic_엑셀_56가지_색번호_vs_rgb값"] = self.vars["list_56rgb_forexcel"] =  self.vars["excel56_vs_rgb"] = self.vars["dic_엑셀_색번호_vs_rgb값"] = self.vars["dic_colorindex_rgblist"] = {
			1: [0, 0, 0], 2: [255, 255, 255], 3: [255, 0, 0], 4: [0, 255, 0], 5: [0, 0, 255],
			6: [255, 255, 0], 7: [255, 0, 255], 8: [0, 255, 255], 9: [128, 0, 0], 10: [0, 128, 0],
			11: [0, 0, 128], 12: [128, 128, 0], 13: [128, 0, 128], 14: [0, 128, 128], 15: [192, 192, 192],
			16: [128, 128, 128], 17: [153, 153, 255], 18: [153, 51, 102], 19: [255, 255, 204], 20: [204, 255, 255],
		...
		self.vars["excel46_rgb"] = self.vars["list_엑셀46개_rgb값"] = self.vars["list_46rgb_forexcel"] = [
			[255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [255, 0, 255],
					 ...
					 [0, 128, 128], [192, 192, 192], [128, 128, 128], [153, 153, 255], [0, 0, 0],[255, 255, 255]]

		self.vars["excel56_rgb"] = self.vars["list_엑셀_56가지_rgb값"] =self.vars["rgb_56_for_excel"] = [
					[255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [255, 0, 255],
					 [0, 255, 255], [153, 51, 102], [255, 255, 204], [204, 255, 255], [102, 0, 102],
					 [255, 128, 128], [0, 102, 204], [204, 204, 255], [0, 204, 255], [204, 255, 204],
					 [255, 255, 153], [153, 204, 255], [255, 153, 204], [204, 153, 255], [255, 204, 153],
		...
		self.vars["johannes_to_hsl"] = self.vars["list_johannes의_hsl값"] = self.vars["hsl_no_for_johannes_style"] = [

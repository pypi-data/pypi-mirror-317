...
class pyclick:
	...
	def get_all_title_n_handle_for_opened_windows(self):
		"""
	...
	def scroll_mouse_down(self, input_click_no=10):
		...
		:param input_click_no:
		:return:
		"""
		pyautogui.scroll(input_click_no*-1)
	...
	def scroll_mouse_up(self, input_click_no=10):
		...
		:return:
		"""
		pyautogui.scroll(input_click_no)

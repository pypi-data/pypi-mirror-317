...
class DataSet(object):
    ...
    def __init__(self, dataset_name=None, type=None, data_type=None, namespace=None, is_demo=False, containers=None, dataset_spec=None, pipelines_to_attach=None, attachment_policy=None, pipeline_config=None, skip_register_data=False, dataset_type=None, local_vars_configuration=None):  # noqa: E501

...
class StatManLine(object):
    ...
    def __init__(self, line_id=None, line_name=None, line_description=None, location_id=None, manager_email=None, is_alert=None, kpi_alerts=None, local_vars_configuration=None):  # noqa: E501

...
class QuoteLib:
    ...
    def _get_lib_path(self):
        ...
        if system == 'Linux':
            lib_path = os.path.join(os.path.dirname(__file__), '..', 'libs', 'linux', 'your_library.so')
        elif system == 'Darwin':
            lib_path = os.path.join(os.path.dirname(__file__), '..', 'libs', 'macos', 'your_library.dylib')
        elif system == 'Windows':
            lib_path = os.path.join(os.path.dirname(__file__), '..', 'libs', 'windows', 'your_library.dll')
        else:

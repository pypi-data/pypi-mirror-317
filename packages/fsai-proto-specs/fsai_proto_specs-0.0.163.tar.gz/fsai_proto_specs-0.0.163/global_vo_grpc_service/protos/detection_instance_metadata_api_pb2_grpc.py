...
class DetectionInstanceMetadataApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteAllMetadataByDetectionInstanceId = channel.unary_unary(
                '/DetectionInstanceMetadataApi/DeleteAllMetadataByDetectionInstanceId',
                request_serializer=global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.DeleteAllMetadataByDetectionInstanceIdRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.DeleteAllMetadataByDetectionInstanceIdResponse.FromString,
                )
...
class DetectionInstanceMetadataApiServicer(object):
    ...
    def DeleteAllMetadataByDetectionInstanceId(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DetectionInstanceMetadataApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteAllMetadataByDetectionInstanceId': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteAllMetadataByDetectionInstanceId,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.DeleteAllMetadataByDetectionInstanceIdRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.DeleteAllMetadataByDetectionInstanceIdResponse.SerializeToString,
            ),
    }
...
class DetectionInstanceMetadataApi(object):
    ...
    @staticmethod
    def DeleteAllMetadataByDetectionInstanceId(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DetectionInstanceMetadataApi/DeleteAllMetadataByDetectionInstanceId',
            global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.DeleteAllMetadataByDetectionInstanceIdRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_detection__instance__metadata__api__pb2.DeleteAllMetadataByDetectionInstanceIdResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

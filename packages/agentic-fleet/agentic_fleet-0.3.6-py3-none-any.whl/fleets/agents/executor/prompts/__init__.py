"""
Executor Agent prompt management and loading
"""
...
class ExecutorPrompts:
    """Manager for Executor Agent prompts"""
    ...
    def get_system_message(self) -> str:
        """Get the system message for the executor agent
    ...
    def get_execution_aspects(self) -> list:
        """Get the execution aspects
        
        Returns:
            List of execution aspects
        """
        return self.base_prompt.get("execution_aspects", [])

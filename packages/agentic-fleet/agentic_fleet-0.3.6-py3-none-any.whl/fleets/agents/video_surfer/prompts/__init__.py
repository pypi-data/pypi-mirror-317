"""
Video Surfer Agent prompt management and loading
"""
...
class VideoSurferPrompts:
    """Manager for Video Surfer Agent prompts"""
    ...
    def get_system_message(self) -> str:
        """Get the system message for the video surfer agent

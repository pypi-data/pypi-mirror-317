"""
Critic Agent prompt management and loading
"""
...
class CriticPrompts:
    """Manager for Critic Agent prompts"""
    ...
    def get_evaluation_aspects(self) -> list:
        """Get the evaluation aspects
        
        Returns:
            List of evaluation aspects
        """
        return self.base_prompt.get("evaluation_aspects", [])

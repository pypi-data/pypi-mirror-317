...
import aiohttp
import httpx
from wirtual.agents import (
    APIConnectionError,
    APIStatusError,
    APITimeoutError,
    llm,
)
from wirtual.agents.llm import ToolChoice, _create_ai_function_info
    ...
    def with_vertex(
        *,
        ...
        try:
            ...
            raise ImportError(
                "Google Auth dependencies not found. Please install with: `pip install wirtual-plugins-openai[vertex]`"
            )
...
class LLMStream(llm.LLMStream):
    ...
    def _parse_choice(self, id: str, choice: Choice) -> llm.ChatChunk | None:
        ...
        # https://github.com/wirtualdev/wirtual-agents/issues/688

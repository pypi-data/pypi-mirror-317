...
target_skill_remote = Skill.from_json({
        ...
        "type": "SkillTeacher",
        "config": {
            "remote_address": "https://example.com/skill.tar.gz",
        }
    })

# used to test resume training with scenarios
target_skill_dictionary.add_scenario({"test": {
    "data": "test",
    "type": "is_equal"
}})
...
target_skill_custom_action_space = Skill("teacher-skill-custom-action-space", TeacherSpaceDiscrete, custom_action_space=spaces.Discrete(2))

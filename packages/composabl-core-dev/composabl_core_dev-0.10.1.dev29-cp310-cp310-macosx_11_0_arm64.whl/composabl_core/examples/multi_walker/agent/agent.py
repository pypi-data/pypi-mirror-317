...
from composabl_core.examples.multi_walker.agent.teacher import WalkerTeacher0, WalkerTeacher1, WalkerTeacher2
...
coordinated_skill = SkillCoordinated("coordinated_skill", CoordinatedCoach, skills=[walker_1, walker_2, walker_3])

...
from kmpcoder.tools.read_file import ReadFileTool
from kmpcoder.tools.read_multiple_files import ReadMultipleFilesTool
from kmpcoder.tools.show_directory import ShowDirectoryTool
...
from stefan.tool.tools_config import AVAILABLE_TOOLS, PLANNER_TOOLS
...
1. The output should be the last thing in your response and should not be followed by any other text.
2. The answer should be valid xml format wrapped with <answer>...</answer> tags.
3. Only one <answer> tag should be present in the response with one tool or agent use.

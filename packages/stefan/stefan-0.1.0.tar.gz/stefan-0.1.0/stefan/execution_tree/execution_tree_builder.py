...
class ExecutionTreeBuilder:
    ...
    def create_agent_node(
        ...
        node_id = uuid4()
        global_llm_logger.log_executor(f"Creating agent node {agent_name} - {node_id}")
    ...
    def create_tool_node(
        ...
        global_llm_logger.log_executor(f"Creating tool node {tool_name}")
    ...
    def update_last_agent_node_with_success(
        ...
        global_llm_logger.log_executor(f"Updating last agent node with success {output_action}")
    ...
    def update_last_agent_node_with_error(
        ...
        global_llm_logger.log_executor(f"Updating last agent node with error")
    ...
    def update_last_tool_node_with_success(
        ...
        global_llm_logger.log_executor(f"Updating last tool node with success")
    ...
    def update_last_tool_node_with_error(
        ...
        global_llm_logger.log_executor(f"Updating last tool node with error")

...
- Delegate subtasks to appropriate specialized agents:
  * CODE_ANALYZER: For deep code analysis and impact assessment
  * REFACTOR_SPECIALIST: For code refactoring and reorganization
  * TEST_ENGINEER: For test creation and validation
  * IMPLEMENTATION_EXPERT: For direct code modifications
  * VALIDATION_AGENT: For verifying changes and ensuring quality

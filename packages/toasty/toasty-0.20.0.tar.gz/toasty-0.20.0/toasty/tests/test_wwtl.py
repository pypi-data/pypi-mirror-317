...
class TestStudy(object):
    ...
    def test_basic_cli(self):
        ...
        fw.add_file_with_data(
            "55cb0cce-c44a-4a44-a509-ea66fce643a5\\7ecb6411-e4ee-4dfa-90ef-77d6f486c7d2.jpg",
            b,
        )
        ...
        for variants in ([], ["--placeholder-thumbnail"], ["--name=Custom Name"]):
            args = ["tile-wwtl"]
            args += variants
            args += ["--outdir", self.work_path("tiles"), self.work_path("image.wwtl")]
            cli.entrypoint(args)

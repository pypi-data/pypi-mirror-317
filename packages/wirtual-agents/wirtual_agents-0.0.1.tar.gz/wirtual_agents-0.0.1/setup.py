...
about = {}
with open(os.path.join(here, "wirtual", "agents", "version.py"), "r") as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    keywords=["webrtc", "realtime", "audio", "video", "wirtual", "agents", "AI"],
    license="Apache-2.0",
    ...
    package_data={"wirtual.agents": ["py.typed"]},
    project_urls={

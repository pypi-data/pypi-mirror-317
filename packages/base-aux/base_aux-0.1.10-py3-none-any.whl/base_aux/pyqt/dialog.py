...
class GuiDialog(QWidget):
    ...
    def _init_qapplication_or_root_dialog_obj(self):
        ...
        CHECK:
            ...
            meth=[.__dir__]                         value=[<method '__dir__' of 'object' base_objects>]
            attr=[.__doc__]                         value=[QApplication(List[str])]
            attr=[.__enter__]                       value=[***MISSED DANGER***]
            meth=[.__eq__]                          value=[<slot wrapper '__eq__' of 'object' base_objects>]
            attr=[.__exit__]                        value=[***MISSED DANGER***]
            meth=[.__format__]                      value=[<method '__format__' of 'object' base_objects>]
            meth=[.__ge__]                          value=[<slot wrapper '__ge__' of 'object' base_objects>]
            meth=[.__getattr__]                     value=[<built-in function __getattr__>]
            meth=[.__getattribute__]                value=[<slot wrapper '__getattribute__' of 'object' base_objects>]
            meth=[.__gt__]                          value=[<slot wrapper '__gt__' of 'object' base_objects>]
            meth=[.__hash__]                        value=[<slot wrapper '__hash__' of 'object' base_objects>]
            attr=[.__init__]                        value=[***MISSED DANGER***]
            attr=[.__init_subclass__]               value=[***MISSED DANGER***]
            meth=[.__le__]                          value=[<slot wrapper '__le__' of 'object' base_objects>]
            meth=[.__lt__]                          value=[<slot wrapper '__lt__' of 'object' base_objects>]
            attr=[.__module__]                      value=[PyQt5.QtWidgets]
            meth=[.__ne__]                          value=[<slot wrapper '__ne__' of 'object' base_objects>]
            attr=[.__new__]                         value=[***MISSED DANGER***]
            attr=[.__reduce__]                      value=[***MISSED DANGER***]
            attr=[.__reduce_ex__]                   value=[***MISSED DANGER***]
            meth=[.__repr__]                        value=[<slot wrapper '__repr__' of 'object' base_objects>]
            attr=[.__setattr__]                     value=[***MISSED DANGER***]
            meth=[.__sizeof__]                      value=[<method '__sizeof__' of 'object' base_objects>]
            meth=[.__str__]                         value=[<slot wrapper '__str__' of 'object' base_objects>]
            meth=[.__subclasshook__]                value=[NotImplemented]
            obj=[.__weakref__]                      value=[<attribute '__weakref__' of 'QObject' base_objects>]

...
def do_conversion(countries):
    ...
    verify_conversion('Remitly', remitly(sender_country, receiver_country, sender_currency, receiver_currency), sender_currency, receiver_currency)
    verify_conversion('Google', google(sender_currency, receiver_currency), sender_currency, receiver_currency)
    verify_conversion('Wise', wise(sender_currency, receiver_currency), sender_currency, receiver_currency)
    verify_conversion('CIBC', cibc(sender_currency, receiver_currency), sender_currency, receiver_currency)
    verify_conversion('Western Union', westernUnion(sender_country, receiver_country, sender_currency, receiver_currency), sender_currency, receiver_currency)
    verify_conversion('Xe', xe(sender_country, receiver_country, sender_currency, receiver_currency), sender_currency, receiver_currency)
    verify_conversion('MoneyGram', moneygram(sender_country, receiver_country, sender_currency), sender_currency, receiver_currency)

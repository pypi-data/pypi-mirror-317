...
def listen_files(structure: list, document: list):
    for record in structure:
        ...
        for file in files:
            ...
            for node in ast.walk(tree):
                if isinstance(node, ast.FunctionDef):
                    ...
                    document[folder_name]["files"][file_name].append(
                        {
        ...
        document[folder_name]["folder"] = listen_files(structure,document[folder_name]["folder"])
    return document
...
def index_start():
    ...
    files["folder"] = listen_files(files["structure"],files["folder"])

...
class TestCase(unittest.TestCase):
    ...
    def test_2(self):
        model = FaceModel('tests/images/tfz.jpeg', '192.168.1.19:51052')

        self.assertEqual(model.lens(), 1)

    def test_3(self):
        model = FaceModel('tests/images/1.jpg', '192.168.1.19:51052', min_area=-1)

        self.assertEqual(model.lens(), 8)

    def test_4(self):
        model = FaceModel('tests/images/1.jpg', '192.168.1.19:51052', min_area=400)

        self.assertEqual(model.lens(), 3)

...
class NotionDatabaseLinker(ABC):
    ...
    def _validate_emoji_icon(self):
        ...
        return IconObjectFactory.from_emoji(emoji=defined_emoji_icon) if defined_emoji_icon else None

    def _validate_external_icon(self):
        external_url = self.define_external_icon()
        return IconObjectFactory.from_external_file(url=external_url) if external_url else None

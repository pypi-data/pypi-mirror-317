...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.npb <multi_physics-biot_npbc>`
   * - ev_biot_stress
   ...
   * - dw_div_grad
     ...
     - :ref:`sto <navier_stokes-stokes>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`
   * - dw_dot
     ...
     - :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`osc <quantum-oscillator>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`bal <large_deformation-balloon>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`hyd <quantum-hydrogen>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bor <quantum-boron>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`wel <quantum-well>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`aco <acoustics-acoustics>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`aco <acoustics-acoustics>`
   * - ev_integrate
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`osc <quantum-oscillator>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`sin <diffusion-sinbc>`, :ref:`cub <diffusion-cube>`, :ref:`hyd <quantum-hydrogen>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bor <quantum-boron>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`wel <quantum-well>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`poi <diffusion-poisson>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`aco <acoustics-acoustics>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`mul.nod.lcb <linear_elasticity-multi_node_lcbcs>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`bio <multi_physics-biot>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`mul.poi.con <linear_elasticity-multi_point_constraints>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`
   * - dw_lin_elastic_iso
   ...
   * - dw_lin_prestress
     ...
     - :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`non.hyp.mM <homogenization-nonlinear_hyperelastic_mM>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`
   * - dw_lin_spring
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`tru.bri <linear_elasticity-truss_bridge>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`its.3 <linear_elasticity-its2D_3>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`sto <navier_stokes-stokes>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`
   * - ev_surface_moment
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`bur.2D <dg-burgers_2D>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`
   * - dw_volume_nvf
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_bulk_penalty
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`hyp <large_deformation-hyperelastic>`, :ref:`act.fib <large_deformation-active_fibres>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`
   * - dw_tl_bulk_pressure
   ...
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`hyp <large_deformation-hyperelastic>`, :ref:`per.tl <large_deformation-perfusion_tl>`, :ref:`act.fib <large_deformation-active_fibres>`, :ref:`bal <large_deformation-balloon>`
   * - dw_tl_he_neohook_ad

        ...
        async def wrapper(self, *args, **kwargs):
            ...
            while self.is_active:
                try:
                    ...
                    logger.debug("Waiting before reconnecting")
...
class WhiteboxPluginASDBGPS(whitebox.Plugin):
    name = "ADS-B GPS"
    ...
    def __init__(self):
        ...
        self.plugin_template = "whitebox_plugin_adsb_gps/whitebox_plugin_adsb_gps.html"
        self.plugin_js = [
...
plugin_class = WhiteboxPluginASDBGPS

...
class BasicCheckbox(Widget):
    def __init__(self, window, x, y, size=30, padding=4, visibility = True,
        ...
        # Draw the checkbox with background and border
        with self.canvas:
            # Draw the background rectangle based on the state
            self.color_instruction = Color(*self.unchecked_color)
            self.rect = Rectangle(pos=self.inner_pos, size=self.inner_size)
        ...
        # Add the checkbox widget to the window
    ...
    def update_checkbox_graphics(self, *args):
        ...
        # Redraw the border to ensure the border color and size update properly
...
if __name__ == "__main__":
    ...
    custom_checkbox2 = BasicCheckbox(
        window=window,
        x=100, y=250,
        padding=5,
    ...
    custom_checkbox3 = BasicCheckbox(
        window=window,
        x=100, y=200,
        padding=5,
    ...
    custom_checkbox4 = BasicCheckbox(
        window=window,
        x=100, y=150,
        padding=5,

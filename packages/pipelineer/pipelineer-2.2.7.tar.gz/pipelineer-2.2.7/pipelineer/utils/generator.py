...
def generate_avro_and_mapping(sql_file_path, avro_output_path, json_output_path, sql_output_path, date_format):
    ...
    for column_name, column_type in columns:
        ...
        avro_schema["fields"].append({
            "name": column_name.lower(),  # Convención en minúsculas
...
def parse_oracle_schema(schema_file):
    ...
    Excluye elementos como constraints, tablespaces, y configuraciones adicionales.
    """
    with open(schema_file, 'r') as file:
        content = file.read()

    # Eliminar bloques no relacionados con definiciones de columnas

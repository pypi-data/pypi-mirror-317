...
try:
    ...
    logger.error(e)
    IB_TURBINE_TYPE, IB_TABLE, IB_USER, IB_PASSWORD, IB_HOST, IB_PORT, IB_DB, IB_FIELD_FORMAT, RESULT_USER, RESULT_PASSWORD, \
    RESULT_HOST, RESULT_PORT, RESULT_DB, IB_TABLE_FORMAT = (
...
class MyDataTools(object):
    ...
    def get_data(self, farm_code, turbine_code, db_yesr=IB_DB, table_name=IB_TABLE, col_names=None, start_date=None,
        ...
        >>> df = dt.get_data(farm_code='30000', turbine_code='001', col_names=['风速', '电网有功功率'],
        >>>             start_date='2024-01-01', end_date='2024-01-02')

                          风速  电网有功功率
        时间
        2024-01-01 00:00:01  4.9   794.0
        2024-01-01 00:00:02  5.3   787.0
        2024-01-01 00:00:03  5.2   788.0
        ...
        2024-01-01 23:59:57  6.7   700.0
        2024-01-01 23:59:58  5.5   704.0
        2024-01-01 23:59:59  5.0   704.0
        """

...
about = {}
with open(
    os.path.join(here, "wirtual", "plugins", "anthropic", "version.py"), "r"
) as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    install_requires=["wirtual-agents>=0.0.1", "anthropic>=0.34"],
    package_data={"wirtual.plugins.anthropic": ["py.typed"]},
    project_urls={

...
from typing_extensions import Annotated
from mtmaisdk.clients.rest.models.node_test_chat_output import NodeTestChatOutput
from mtmaisdk.clients.rest.models.node_test_chat_request import NodeTestChatRequest
from mtmaisdk.clients.rest.models.node_test_output import NodeTestOutput
from mtmaisdk.clients.rest.models.node_test_request import NodeTestRequest
...
class DefaultApi:
    ...
    async def node_test(
        self,
        node_test_request: Optional[NodeTestRequest] = None,
        ...
        :param node_test_request:
        :type node_test_request: NodeTestRequest
        ...
        _param = self._node_test_serialize(
            node_test_request=node_test_request,
    ...
    @validate_call
    async def node_test_with_http_info(
        self,
        node_test_request: Optional[NodeTestRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def node_test_without_preload_content(
        self,
        node_test_request: Optional[NodeTestRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _node_test_serialize(
        ...
        if node_test_request is not None:
            _body_params = node_test_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/nodes/test',
    ...
    @validate_call
    async def node_testchat(
        self,
        node_test_chat_request: Optional[NodeTestChatRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param node_test_chat_request:
        :type node_test_chat_request: NodeTestChatRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._node_testchat_serialize(
            node_test_chat_request=node_test_chat_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def node_testchat_with_http_info(
        self,
        node_test_chat_request: Optional[NodeTestChatRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NodeTestChatOutput]:
        """node_testchat
    ...
    @validate_call
    async def node_testchat_without_preload_content(
        self,
        node_test_chat_request: Optional[NodeTestChatRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _node_testchat_serialize(
        self,
        node_test_chat_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if node_test_chat_request is not None:
            _body_params = node_test_chat_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/nodes/testchat',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

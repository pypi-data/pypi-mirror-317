...
class AgentApi:
    ...
    @validate_call
    async def agent_run_research(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        research_request: Annotated[ResearchRequest, Field(description="创建agentnode")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenant: The tenant id (required)
        :type tenant: str
        :param research_request: 创建agentnode (required)
        ...
        _param = self._agent_run_research_serialize(
            tenant=tenant,
    ...
    @validate_call
    async def agent_run_research_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        research_request: Annotated[ResearchRequest, Field(description="创建agentnode")],
        _request_timeout: Union[
    ...
    @validate_call
    async def agent_run_research_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        research_request: Annotated[ResearchRequest, Field(description="创建agentnode")],
        _request_timeout: Union[
    ...
    def _agent_run_research_serialize(
        self,
        tenant,
        research_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tenants/{tenant}/agent/research',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

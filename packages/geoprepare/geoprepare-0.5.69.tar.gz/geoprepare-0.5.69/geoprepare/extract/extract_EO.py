...
def process_JRC(val):
    ...
    for idx, row in df_country.iterrows():
        ...
        for doy in range(1, end_doy):
            ...
            ac = geom_extract(row["geometry"], fl_var, stats_out=['mean', 'counts'], afi=afi_file, afi_thresh=0, thresh_type='Fixed')
...
def run(params):
    ...
    for country in params.countries:
        ...
        for crop in crops:
            ...
            path_mask = params.dir_global_datasets / "masks" / path_mask

...
if ENVIRONMENT == 'project.settings.production':
    ...
    def run_setup(self):
        ...
        # if success:
        console.print("\nMake sure you set the env `SETTING_FILE_PATH` to `project.settings.development` (for your development enviroment)\nor `project.settings.production` (for your production enviroment) before running the server.", style="bold white on yellow")

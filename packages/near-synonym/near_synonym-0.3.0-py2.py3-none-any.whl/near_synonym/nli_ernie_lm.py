...
# @author  : Mo
# @function: ernie-nli(qwen-7b create data)
...
class QwenErnieSim:
    def __init__(self, path_model_onnx="ernie_sim_model.onnx",
                 path_tokenizer="ernie_sim_vocab.txt",
                 maxlen=12,
                 threads=1):
    ...
    def sim(self, texts, logits_type="SOFTMAX"):
        """"计算text1与text2的相似度
        """
...
if __name__ == '__main__':
    ...
    path_model_onnx = "./data/ernie_sim_onnx/ernie_sim_model.onnx"
    path_tokenizer = "./data/ernie_sim_onnx/ernie_sim_vocab.txt"
    threads = 1
    maxlen = 12
    model = QwenErnieSim(

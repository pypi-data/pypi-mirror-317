...
def convert_html_to_pdf(
    ...
    """
    Convert an HTML file to a PDF using a headless Chrome instance.

    Example usage:
      lt document convert file.html file.pdf
    """
    try:
        from computer.document.document import html_to_pdf
        html_to_pdf(str(input_html_file), output_pdf_file)
    except Exception as e:

...
#waveID = 1
#predictions.py
def seperate_model_eval(WAVE, models, predictions, delay_list, tuned_model_names, tuned_model_dict, delay_definition_flag, delayed_start_matrix, training_period, lag_reserve, lagged_amount, overlap, confidence_interval):
  '''
  ...
  task_name = 'all'
  concise_data, concise_data_dictionary = create_prediction_df(WAVES, predictions, delay_list, visualization_columns, model_evaluation_dictionary, inFoldername_pre, task_name, filename)

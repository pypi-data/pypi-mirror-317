...
#waveID = 1
#predictions.py
def seperate_model_eval(WAVES, models, predictions, delay_list, inFoldername_pre, tuned_model_names, tuned_model_dict, delay_definition_flag, delayed_start_matrix, training_period, lag_reserve, lagged_amount, overlap, confidence_interval):
  '''

    ...
    for index, row in propagate_df.iterrows():
        ...
        if pd.isna(task_title):
            ...
            for task in tasks:
                ...
                create_task_folder_propagate(new_subfolder_id, task_details, access_token, mapped_custom_fields)
            ...
            if task_id:
                ...
                for subtask in subtasks:
                    ...
                    create_subtask_propagate(
                        ...
                        mapped_custom_fields=subtask_custom_fields
                    )

                # Create the parent task
                create_task_folder_propagate(destination_folder_id, task_details, access_token, mapped_custom_fields)

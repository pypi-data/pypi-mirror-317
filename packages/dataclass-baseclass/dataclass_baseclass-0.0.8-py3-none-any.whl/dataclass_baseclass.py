...
class DataClassField(Field):
    ...
    def default_value(self) -> Any:
        ...
        Takes in account default / default factory. Not super precise, but
        precise enough.
...
class DataClassMeta(_ProtocolMeta):
    ...
    def __new__(
        ...
        **kwargs: Any,
        ...
        def _field(cls, /, **kwargs: Any) -> Field:
        ...
        def _fields(cls) -> tuple[DataClassField, ...]:
            """DataClass fields.
            ...
            return tuple(DataClassField(f) for f in fields(cls))
...
class DataClass(metaclass=DataClassMeta):
    ...
    # For some reason methods declared here are ignored, and have to be
    # added in the Meta. For documentation reasons we declare them here
    # as abstract.

...
class DreemUI:
    ...
    def download_and_save(file_url, folder_name, headers):
        ...
        try:
            ...
            file_path = DreemUI.sanitize_filename(parsed_url.path.lstrip("/"))
    ...
    def update_links(soup, base_url, folder_name, headers):
        ...
        for tag in soup.find_all(["link", "script", "img", "video"]):
            ...
            if tag.has_attr(attr):
                ...
                local_path = DreemUI.download_and_save(file_url, folder_name, headers)
                if local_path:
                    tag[attr] = local_path
    ...
    def download_webpage(url, folder_name):
        ...
        try:
            ...
            DreemUI.update_links(soup, url, folder_name, headers)
    ...
    def generate_folder_name(url):
        ...
        site_name = site_name.replace('www.', '') if site_name else 'site'
        return f"DreemUI_{site_name}"

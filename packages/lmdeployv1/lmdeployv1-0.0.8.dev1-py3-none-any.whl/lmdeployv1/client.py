...
class MessageBuilder:
    ...
    def build_single_message(
        ...
        """Build a single message from key-value pair."""
        content = []
        for img_url, prompt in kv.items():
            content.extend(cls.create_content_parts(prompt, img_url))
    ...
    def build_batch_messages(
        ...
        """Build batch messages from list of key-value pairs."""
        return [cls.build_single_message(kv) for kv in kv_list]

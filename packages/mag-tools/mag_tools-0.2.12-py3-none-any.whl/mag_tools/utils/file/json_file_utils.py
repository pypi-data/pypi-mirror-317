...
import json_utils
from utils.common.enum_encoder import EnumEncoder
...
class JsonFileUtils:
    ...
    def update_params(file_path: str, new_params: Dict[str, str]):
        ...
        new_data_str = json_utils.dumps(data, ensure_ascii=False, indent=4, cls=EnumEncoder)
    ...
    def save_as_json(json_file, data):
        ...
        data_str = json_utils.dumps(filtered_data, ensure_ascii=False, indent=4, cls=EnumEncoder)

...
about = {}
with open(os.path.join(here, "wirtual", "plugins", "fal", "version.py"), "r") as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    description="fal plugin template for Wirtual Agents",
    ...
    install_requires=["wirtual-agents>=0.0.1", "fal_client"],
    package_data={"wirtual.plugins.fal": ["py.typed"]},
    project_urls={

...
class HTTPStatus(Enum):
    ...
    IOU_THRESH_LIST_TYPE_ERR = (400008, "请求体的参数字段类型错误", "iou_thresh 字段应该是 list 类型")  # 通用分数阈值
    ...
    IOU_THRESH_EMPTY_ERR = (400009, "请求体的参数字段值为空", "iou_thresh 字段值为空")
    ...
    IOU_THRESH_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "iou_thresh 字段不符合规范，请参考接口文档说明")

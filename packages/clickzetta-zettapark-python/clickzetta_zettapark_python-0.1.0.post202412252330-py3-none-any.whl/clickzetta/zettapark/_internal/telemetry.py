...
def df_collect_api_telemetry(func):
    ...
    def wrap(*args, **kwargs):
        ...
        #     api_calls=api_calls,
        #     job_ids=[q.query_id for q in query_history.queries],
        # )
        return result
...
class TelemetryClient:
    ...
    def send_upload_file_perf_telemetry(
        self, func_name: str, duration: float, job_id: str
    ):
        message = {
            **self._create_basic_telemetry_data(
            ...
            TelemetryField.KEY_DATA.value: {
                TelemetryField.KEY_JOB_IDS.value: [job_id],
    ...
    def send_function_usage_telemetry(
        ...
        if job_ids is not None:
            data[TelemetryField.KEY_JOB_IDS.value] = job_ids
        message = {
            **self._create_basic_telemetry_data(

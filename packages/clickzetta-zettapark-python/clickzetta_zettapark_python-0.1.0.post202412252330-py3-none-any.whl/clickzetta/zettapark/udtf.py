...
class UDTFRegistration:
    ...
    Example 3
        Create a permanent UDTF with a name and call it in SQL:
            ...
            ...     is_permanent=True, name="generator_udtf", replace=True, volume_path="volume://my_vol"
            ... )
    ...
    Example 10
        Creating a UDTF from a Python file on an internal volume:

            >>> from clickzetta.zettapark.types import IntegerType, StructField, StructType
            >>> from clickzetta.zettapark.functions import udtf, lit
            >>> _ = session.sql("create external volume my_vol ...").collect()
            >>> _ = session.file.put("tests/resources/test_udtf_dir/test_udtf_file.py", "volume://my_vol", auto_compress=False)
            >>> generator_udtf = session.udtf.register_from_file(
            ...     file_path="volume://my_vol/test_udtf_file.py",
            ...     handler_name="GeneratorUDTF",
            ...     output_schema=StructType([StructField("number", IntegerType())]),
            ...     input_types=[IntegerType()]
            ... )
    ...
    ``<class>.end_partition._vectorized_input = pandas.DataFrame``
    ...
    def register(
        ...
        *,
        ...
        Args:
            ...
            volume_path: The volume location where the Python file for the UDTF
        ...
        check_register_args(
            TempObjectType.TABLE_FUNCTION, name, is_permanent, volume_path, parallel
        )

    ...
    **Performing an action on a DataFrame**
    ...
    def copy_into_table(
        ...
        **copy_options: Any,
        ...
        """Executes a `COPY INTO <table> <https://doc.clickzetta.com/>`__ command to load data from files in a volume path into a specified table.
        ...
        Example::
            ...
            ...     t.writelines(["id1, Product A", "\\n" "id2, Product B"])
            ...     t.flush()
            ...     put_result = session.file.put(t.name, "volume:table://test_table/copy_into_table_dir", overwrite=True)
            ...
            >>> df = session.read.schema(user_schema).csv("volume:table://test_table/copy_into_table_dir")
        ...
        Args:
            ...
            files: Specific files to load from the volume path.
            pattern: The regular expression that is used to match file names of the volume path.

        ...
        **kwargs,
        ...
        Examples::
            ...
            Call ``apply_in_pandas`` using permanent UDTF with replacing original UDTF:
                ...
                >>> _ = session.sql("create external volume my_volume ...").collect()
                >>> def group_sum(pdf):
                ...
                ...                is_permanent=True, volume_path="volume://my_volume/", name="group_sum_in_pandas", replace=True
                ...            ).order_by("sum").show()
                --------------------------------
                |"GRADE"  |"DIVISION"  |"SUM"  |
                --------------------------------
        ...
        # for vectorized UDTF
        _ApplyInPandas.end_partition._vectorized_input = pandas.DataFrame

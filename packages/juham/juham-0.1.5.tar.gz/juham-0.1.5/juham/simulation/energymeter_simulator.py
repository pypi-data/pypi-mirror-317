...
from juham.core import MasterPieceThread, RThread


class EnergyMeterSimulatorThread(MasterPieceThread):
...
class EnergyMeterSimulator(RThread):
    ...
    def run(self) -> None:
        ...
        self.worker = cast(
            ...
            Juham.instantiate(EnergyMeterSimulatorThread.get_class_id()),
        )
        super().run()

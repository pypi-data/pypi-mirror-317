...
try:
    from doweb.browser import get_app as _get_app  # type: ignore
except ImportError:
    from kweb.browser import get_app as _get_app  # type: ignore

PDK: str = s.pdk.name
PROJECT_DIR: str = maybe_find_docode_project_dir() or os.getcwd()

app = _get_app(fileslocation=PROJECT_DIR, editable=False)

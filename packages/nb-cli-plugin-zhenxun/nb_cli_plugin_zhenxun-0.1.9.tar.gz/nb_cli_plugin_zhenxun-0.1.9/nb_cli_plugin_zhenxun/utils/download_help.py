...
class DownloadInstallHelp:
    ...
    @classmethod
    async def download_install(cls, ctx: click.Context) -> str:
        """下载文件
    ...
    @classmethod
    async def _unzip_handle(cls, ctx: click.Context):
        """解压文件

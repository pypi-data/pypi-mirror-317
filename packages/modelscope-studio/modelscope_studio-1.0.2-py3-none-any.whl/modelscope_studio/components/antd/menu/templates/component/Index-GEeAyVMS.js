...
var Mt = typeof exports == "object" && exports && !exports.nodeType && exports, Qe = Mt && typeof module == "object" && module && !module.nodeType && module, rr = Qe && Qe.exports === Mt, Ve = rr ? S.Buffer : void 0, ir = Ve ? Ve.isBuffer : void 0, oe = ir || nr, or = "[object Arguments]", sr = "[object Array]", ar = "[object Boolean]", ur = "[object Date]", lr = "[object Error]", fr = "[object Function]", cr = "[object Map]", pr = "[object Number]", gr = "[object Object]", dr = "[object RegExp]", _r = "[object Set]", hr = "[object String]", br = "[object WeakMap]", yr = "[object ArrayBuffer]", mr = "[object DataView]", vr = "[object Float32Array]", Tr = "[object Float64Array]", wr = "[object Int8Array]", Or = "[object Int16Array]", Pr = "[object Int32Array]", $r = "[object Uint8Array]", Ar = "[object Uint8ClampedArray]", Sr = "[object Uint16Array]", Cr = "[object Uint32Array]", v = {};
...
function Rt(e, t) {
  var n = $(e), r = !n && Ie(e), o = !n && !r && oe(e), i = !n && !r && !o && Lt(e), s = n || r || o || i, a = s ? Vn(e.length, String) : [], u = a.length;
  for (var l in e)
...
function Ls(e, t, n, r, o, i) {
  ...
  for (var c = s; ++d < u; ) {
    ...
    var m = e[h], w = t[h];
    if (r)
      var L = s ? r(w, m, h, t, e, i) : r(m, w, h, e, t, i);
...
var Rs = 1, _t = "[object Arguments]", ht = "[object Array]", te = "[object Object]", Ns = Object.prototype, bt = Ns.hasOwnProperty;
function Ds(e, t, n, r, o, i) {
  var s = $(e), a = $(t), u = s ? ht : P(e), l = a ? ht : P(t);
  ...
  if (h && !p)
    return i || (i = new A()), s || Lt(e) ? Xt(e, t, n, r, o, i) : Es(e, t, u, n, r, o, i);
  if (!(n & Rs)) {
  ...
  return h ? (i || (i = new A()), Ls(e, t, n, r, o, i)) : !1;
}
...
function Ca(e, t, n) {
  ...
  const a = pe(Aa), u = ((h = R(a)) == null ? void 0 : h.as_item) || e.as_item, l = he(a ? u ? ((b = R(a)) == null ? void 0 : b[u]) || {} : R(a) || {} : {}), p = (f, g) => f ? ha({
    ...f,
    ...g || {}
  }, t) : void 0, d = j({
    ...e,
...
function su(e, t, n) {
  ...
  const h = ga(() => import("./menu-BXs6xuQI.js"));
  let {
    gradio: b
  } = t, {
    props: f = {}
  ...
  }, [s, a, u, l, h, g, Ue, Ge, sn, Be, ze, b, f, c, m, w, L, C, I, i, p, d];
}
class fu extends Da {
  constructor(t) {

...
}(), We = z && z.isTypedArray, It = We ? Ee(We) : $r, Sr = Object.prototype, Cr = Sr.hasOwnProperty;
function Mt(e, t) {
...
function Ws(e, t, n) {
  ...
  const d = ls(() => import("./statistic.countdown-AxK75jil.js"));
  let {
    gradio: g
  } = t, {
    _internal: _ = {}
  ...
  return be(e, Ue, (b) => n(0, a = b)), e.$$set = (b) => {
    t = Oe(Oe({}, t), Ls(b)), n(19, o = yt(t, r)), "gradio" in b && n(6, g = b.gradio), "_internal" in b && n(7, _ = b._internal), "as_item" in b && n(8, h = b.as_item), "props" in b && n(9, u = b.props), "value" in b && n(10, p = b.value), "elem_id" in b && n(11, m = b.elem_id), "elem_classes" in b && n(12, w = b.elem_classes), "elem_style" in b && n(13, M = b.elem_style), "visible" in b && n(14, C = b.visible), "$$scope" in b && n(17, c = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && l.update((b) => ({
      ...b,
  ...
  }, [a, s, d, l, L, Ue, g, _, h, u, p, m, w, M, C, i, f, c];
}
class ks extends Cs {
  constructor(t) {

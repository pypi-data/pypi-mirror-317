...
var ve = U(S, "DataView"), Te = U(S, "Promise"), we = U(S, "Set"), nt = "[object Map]", Xi = "[object Object]", rt = "[object Promise]", it = "[object Set]", ot = "[object WeakMap]", at = "[object DataView]", Ji = K(ve), Zi = K(J), Wi = K(Te), Qi = K(we), Vi = K(ye), P = D;
...
var ha = 1, ba = 2, ya = "[object Boolean]", ma = "[object Date]", va = "[object Error]", Ta = "[object Map]", wa = "[object Number]", Oa = "[object RegExp]", Pa = "[object Set]", Aa = "[object String]", $a = "[object Symbol]", Sa = "[object ArrayBuffer]", Ca = "[object DataView]", ct = O ? O.prototype : void 0, de = ct ? ct.valueOf : void 0;
...
function eu(e, t, n) {
  ...
  const d = cs(() => import("./rate-V-7U3pQJ.js"));
  let {
    gradio: g
  } = t, {
    props: _ = {}
  ...
  return e.$$set = (h) => {
    t = Oe(Oe({}, t), Ds(h)), n(21, o = yt(t, r)), "gradio" in h && n(8, g = h.gradio), "props" in h && n(9, _ = h.props), "_internal" in h && n(10, u = h._internal), "value" in h && n(0, p = h.value), "as_item" in h && n(11, l = h.as_item), "visible" in h && n(12, m = h.visible), "elem_id" in h && n(13, w = h.elem_id), "elem_classes" in h && n(14, R = h.elem_classes), "elem_style" in h && n(15, C = h.elem_style), "$$scope" in h && n(19, c = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && b.update((h) => ({
      ...h,
  ...
  }, [p, a, s, d, b, F, Ue, nn, g, _, u, l, m, w, R, C, i, f, rn, c];
}
class ru extends Is {
  constructor(t) {

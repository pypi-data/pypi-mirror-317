"""passlib3.utils.compat - python 2/3 compatibility helpers"""
#=============================================================================
...
if sys.version_info < (2,6) or (3,0) <= sys.version_info < (3,2):
    raise RuntimeError("Passlib requires Python 2.6, 2.7, or >= 3.2 (as of passlib3 1.7)")
...
if PYPY and sys.pypy_version_info < (2,0):
    raise RuntimeError("passlib3 requires pypy >= 2.0 (as of passlib3 1.7)")
...
#=============================================================================
if PY26:
    _lazy_attrs['OrderedDict'] = 'passlib3.utils.compat._ordered_dict.OrderedDict'
else:
...
class _LazyOverlayModule(ModuleType):
    ...
    used by :mod:`passlib3.utils`, :mod:`passlib3.crypto`,
    and :mod:`passlib3.utils.compat`.
    """

"""passlib3.handlers.misc - misc generic handlers
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from passlib3.utils import to_native_str, str_consteq
from passlib3.utils.compat import unicode, u, unicode_or_bytes_types
...
class unix_disabled(uh.ifc.DisabledHash, uh.MinimalHandler):
    ...
    no matter the hash string. The :meth:`~passlib3.ifc.PasswordHash.hash`
...
class plaintext(uh.MinimalHandler):
    ...
    The :meth:`~passlib3.ifc.PasswordHash.hash`, :meth:`~passlib3.ifc.PasswordHash.genhash`, and :meth:`~passlib3.ifc.PasswordHash.verify` methods all require the

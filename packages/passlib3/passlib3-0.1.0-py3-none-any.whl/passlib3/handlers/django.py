"""passlib3.handlers.django- Django password hash support"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from passlib3.handlers.bcrypt import _wrapped_bcrypt
from passlib3.hash import argon2, bcrypt, pbkdf2_sha1, pbkdf2_sha256
from passlib3.utils import to_unicode, rng, getrandstr
from passlib3.utils.binary import BASE64_CHARS
from passlib3.utils.compat import str_to_uascii, uascii_to_str, unicode, u
...
def _import_des_crypt():
    ...
    if des_crypt is None:
        from passlib3.hash import des_crypt
    return des_crypt
...
class django_salted_sha1(DjangoSaltedHash):
    ...
    The :meth:`~passlib3.ifc.PasswordHash.hash` and :meth:`~passlib3.ifc.PasswordHash.genconfig` methods accept the following optional keywords:
...
django_bcrypt = uh.PrefixWrapper("django_bcrypt", bcrypt,
    ...
    See :doc:`/lib/passlib3.hash.bcrypt` for more details,
...
class django_bcrypt_sha256(_wrapped_bcrypt):
    ...
    see :doc:`bcrypt </lib/passlib3.hash.bcrypt>` for more details.
...
django_argon2 = uh.PrefixWrapper(
    ...
    See :doc:`argon2 </lib/passlib3.hash.argon2>` for more details,
    the usage and behavior is identical.

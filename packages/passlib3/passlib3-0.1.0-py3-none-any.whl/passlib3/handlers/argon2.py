"""passlib3.handlers.argon2 -- argon2 password hash wrapper
...
from passlib3.crypto.digest import MAX_UINT32
from passlib3.utils import classproperty, to_bytes, render_bytes
from passlib3.utils.binary import b64s_encode, b64s_decode
from passlib3.utils.compat import u, unicode, bascii_to_str, uascii_to_str, PY2
...
TYPE_I = u("i")
TYPE_D = u("d")
TYPE_ID = u("id")  # new 2016-10-29; passlib3 1.7.2 requires backends new enough for support
...
class _Argon2Common(uh.SubclassBackendMixin, uh.ParallelismMixin,
    ...
    def type_d(self):
        ...
        .. deprecated:: 1.7.2; will be removed in passlib3 2.0
        """
    ...
    def __init__(self, type=None, type_d=False, version=None, memory_cost=None, data=None, **kwds):
        ...
        if type_d:
            warn('argon2 `type_d=True` keyword is deprecated, and will be removed in passlib3 2.0; '
    ...
    def _adapt_backend_error(cls, err, hash=None, self=None):
        ...
        used to adapt to passlib3 message.
        """
        backend = cls.get_backend()
    ...
    def _load_backend_mixin(mixin_cls, name, dryrun):
        ...
        try:
            ...
            log.warning("detected 'argon2pure' backend, but package is too old "
                        "(passlib3 requires argon2pure >= 1.2.3)")
            return False
...
class argon2(_NoBackend, _Argon2Common):
    ...
    The :meth:`~passlib3.ifc.PasswordHash.replace` method accepts the following optional keywords:

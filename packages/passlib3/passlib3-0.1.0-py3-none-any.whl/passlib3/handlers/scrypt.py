"""passlib3.handlers.scrypt -- scrypt password hash"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from passlib3.crypto import scrypt as _scrypt
from passlib3.utils import h64, to_bytes
from passlib3.utils.binary import h64, b64s_decode, b64s_encode
from passlib3.utils.compat import u, bascii_to_str, suppress_cause
from passlib3.utils.decor import classproperty
...
IDENT_SCRYPT = u("$scrypt$")  # identifier used by passlib3
...
class scrypt(uh.ParallelismMixin, uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.HasManyIdents,
    ...
    .. todo::
        ...
        for ``block_size`` or ``parallelism`` via a :class:`~passlib3.context.CryptContext`
        configuration.
    """
    ...
    #       which actually switches the backend that 'passlib3.crypto.scrypt.scrypt()' uses.
    #===================================================================

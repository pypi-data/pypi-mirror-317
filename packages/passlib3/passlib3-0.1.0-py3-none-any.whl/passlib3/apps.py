...
# site
# pkg
from passlib3 import hash
from passlib3.context import LazyCryptContext
...
def _load_master_config():
    from passlib3.registry import list_crypt_handlers
...
# this will always point to latest version in passlib3
...
def _iter_ldap_crypt_schemes():
    from passlib3.utils import unix_crypt_schemes
...
##    "helper which iterates over supported std ldap schemes"
##    from passlib3.handlers.ldap_digests import get_host_ldap_crypt_schemes

"""passlib3.utils.scrypt._builtin -- scrypt() kdf in pure-python"""
#==========================================================================
# imports
#==========================================================================
# core
...
import struct
# pkg
from passlib3.utils.compat import izip
from passlib3.crypto.digest import pbkdf2_hmac
from passlib3.crypto.scrypt._salsa import salsa20
# local
__all__ =[
    "ScryptEngine",
]
...
class ScryptEngine(object):
    ...
    .. warning::
        ...
        but only as a backend for :func:`passlib3.utils.scrypt.scrypt()`.
    """
    #=================================================================
    # instance attrs
    #=================================================================

"""passlib3.apache - apache password support"""
# XXX: relocate this to passlib3.ext.apache?
#=============================================================================
# imports
#=============================================================================
...
from passlib3.exc import ExpectedStringError
from passlib3.hash import htdigest
from passlib3.utils import render_bytes, to_bytes, is_ascii_codec
from passlib3.utils.decor import deprecated_method
from passlib3.utils.compat import join_bytes, unicode, BytesIO, PY3
# local
__all__ = [
    'HtpasswdFile',
    'HtdigestFile',
...
def _init_htpasswd_context():
    ...
    return CryptContext(
        ...
        # NOTE: default will change to "portable" in passlib3 2.0
...
class HtpasswdFile(_CommonFile):
    ...
    :param default_scheme:
        ...
        * Schemes commonly supported by Unix hosts
        ...
        passlib3 offers a number of aliases, that will resolve
...
class HtdigestFile(_CommonFile):
    ...
    def get_hash(self, user, realm=None):
        """Return :class:`~passlib3.hash.htdigest` hash stored for user.

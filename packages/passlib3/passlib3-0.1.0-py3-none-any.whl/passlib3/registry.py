"""passlib3.registry - registry for password hash handlers"""
#=============================================================================
# imports
#=============================================================================
# core
...
# pkg
from passlib3 import exc
from passlib3.exc import ExpectedTypeError, PasslibWarning
from passlib3.ifc import PasswordHash
from passlib3.utils import (
    is_crypt_handler, has_crypt as os_crypt_present,
    unix_crypt_schemes as os_crypt_schemes,
)
from passlib3.utils.compat import unicode_or_str
from passlib3.utils.decor import memoize_single_value
# local
__all__ = [
...
#=============================================================================
# proxy object used in place of 'passlib3.hash' module
#=============================================================================
class _PasslibRegistryProxy(object):
    """proxy module passlib3.hash

    this module is in fact an object which lazy-loads
    the requested password hash algorithm from wherever it has been stored.
    it acts as a thin wrapper around :func:`passlib3.registry.get_crypt_handler`.
    """
    __name__ = "passlib3.hash"
    __package__ = None
    ...
    def __repr__(self):
        return "<proxy module 'passlib3.hash'>"
...
# create single instance - available publically as 'passlib3.hash'
...
_locations = dict(
    # NOTE: this is a hardcoded list of the handlers built into passlib3,
    #       applications should call register_crypt_handler_path()
    apr_md5_crypt = "passlib3.handlers.md5_crypt",
    argon2 = "passlib3.handlers.argon2",
    atlassian_pbkdf2_sha1 = "passlib3.handlers.pbkdf2",
    bcrypt = "passlib3.handlers.bcrypt",
    bcrypt_sha256 = "passlib3.handlers.bcrypt",
    bigcrypt = "passlib3.handlers.des_crypt",
    bsd_nthash = "passlib3.handlers.windows",
    bsdi_crypt = "passlib3.handlers.des_crypt",
    cisco_pix = "passlib3.handlers.cisco",
    cisco_asa = "passlib3.handlers.cisco",
    cisco_type7 = "passlib3.handlers.cisco",
    cta_pbkdf2_sha1 = "passlib3.handlers.pbkdf2",
    crypt16 = "passlib3.handlers.des_crypt",
    des_crypt = "passlib3.handlers.des_crypt",
    django_argon2 = "passlib3.handlers.django",
    django_bcrypt = "passlib3.handlers.django",
    django_bcrypt_sha256 = "passlib3.handlers.django",
    django_pbkdf2_sha256 = "passlib3.handlers.django",
    django_pbkdf2_sha1 = "passlib3.handlers.django",
    django_salted_sha1 = "passlib3.handlers.django",
    django_salted_md5 = "passlib3.handlers.django",
    django_des_crypt = "passlib3.handlers.django",
    django_disabled = "passlib3.handlers.django",
    dlitz_pbkdf2_sha1 = "passlib3.handlers.pbkdf2",
    fshp = "passlib3.handlers.fshp",
    grub_pbkdf2_sha512 = "passlib3.handlers.pbkdf2",
    hex_md4 = "passlib3.handlers.digests",
    hex_md5 = "passlib3.handlers.digests",
    hex_sha1 = "passlib3.handlers.digests",
    hex_sha256 = "passlib3.handlers.digests",
    hex_sha512 = "passlib3.handlers.digests",
    htdigest = "passlib3.handlers.digests",
    ldap_plaintext = "passlib3.handlers.ldap_digests",
    ldap_md5 = "passlib3.handlers.ldap_digests",
    ldap_sha1 = "passlib3.handlers.ldap_digests",
    ldap_hex_md5 = "passlib3.handlers.roundup",
    ldap_hex_sha1 = "passlib3.handlers.roundup",
    ldap_salted_md5 = "passlib3.handlers.ldap_digests",
    ldap_salted_sha1 = "passlib3.handlers.ldap_digests",
    ldap_salted_sha256 = "passlib3.handlers.ldap_digests",
    ldap_salted_sha512 = "passlib3.handlers.ldap_digests",
    ldap_des_crypt = "passlib3.handlers.ldap_digests",
    ldap_bsdi_crypt = "passlib3.handlers.ldap_digests",
    ldap_md5_crypt = "passlib3.handlers.ldap_digests",
    ldap_bcrypt = "passlib3.handlers.ldap_digests",
    ldap_sha1_crypt = "passlib3.handlers.ldap_digests",
    ldap_sha256_crypt = "passlib3.handlers.ldap_digests",
    ldap_sha512_crypt = "passlib3.handlers.ldap_digests",
    ldap_pbkdf2_sha1 = "passlib3.handlers.pbkdf2",
    ldap_pbkdf2_sha256 = "passlib3.handlers.pbkdf2",
    ldap_pbkdf2_sha512 = "passlib3.handlers.pbkdf2",
    lmhash = "passlib3.handlers.windows",
    md5_crypt = "passlib3.handlers.md5_crypt",
    msdcc = "passlib3.handlers.windows",
    msdcc2 = "passlib3.handlers.windows",
    mssql2000 = "passlib3.handlers.mssql",
    mssql2005 = "passlib3.handlers.mssql",
    mysql323 = "passlib3.handlers.mysql",
    mysql41 = "passlib3.handlers.mysql",
    nthash = "passlib3.handlers.windows",
    oracle10 = "passlib3.handlers.oracle",
    oracle11 = "passlib3.handlers.oracle",
    pbkdf2_sha1 = "passlib3.handlers.pbkdf2",
    pbkdf2_sha256 = "passlib3.handlers.pbkdf2",
    pbkdf2_sha512 = "passlib3.handlers.pbkdf2",
    phpass = "passlib3.handlers.phpass",
    plaintext = "passlib3.handlers.misc",
    postgres_md5 = "passlib3.handlers.postgres",
    roundup_plaintext = "passlib3.handlers.roundup",
    scram = "passlib3.handlers.scram",
    scrypt = "passlib3.handlers.scrypt",
    sha1_crypt = "passlib3.handlers.sha1_crypt",
    sha256_crypt = "passlib3.handlers.sha2_crypt",
    sha512_crypt = "passlib3.handlers.sha2_crypt",
    sun_md5_crypt = "passlib3.handlers.sun_md5_crypt",
    unix_disabled = "passlib3.handlers.misc",
    unix_fallback = "passlib3.handlers.misc",
)
...
def register_crypt_handler_path(name, path):
    ...
    for a class named ``myhash`` within the ``myapp.helpers`` module::
        ...
        >>> from passlib3.registry import registry_crypt_handler_path
...
def register_crypt_handler(handler, force=False, _attr=None):
    ...
    this method immediately registers a handler with the internal passlib3 registry,
...
def get_supported_os_crypt_schemes():
    ...
    if not cache:  # pragma: no cover -- sanity check
        ...
        warn("crypt.crypt() function is present, but doesn't support any "
             "formats known to passlib3! (system=%r release=%r)" %

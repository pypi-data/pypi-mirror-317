"""passlib3.context - CryptContext implementation"""
#=============================================================================
# imports
#=============================================================================
...
from passlib3.exc import ExpectedStringError, ExpectedTypeError, PasslibConfigWarning
from passlib3.registry import get_crypt_handler, _validate_handler_name
from passlib3.utils import (handlers as uh, to_bytes,
                            to_unicode, splitcomma,
                            as_bool, timer, rng, getrandstr,
                            )
from passlib3.utils.binary import BASE64_CHARS
from passlib3.utils.compat import (iteritems, num_types, irange,
                                   PY2, PY3, unicode, SafeConfigParser,
                                   NativeStringIO, BytesIO,
                                   unicode_or_bytes_types, native_string_types,
                                   )
from passlib3.utils.decor import deprecated_method, memoized_property
# local
__all__ = [
    'CryptContext',
    'LazyCryptContext',
...
class CryptPolicy(object):
    ...
    #===================================================================
    @classmethod
    def from_path(cls, path, section="passlib3", encoding="utf-8"):
    ...
    @classmethod
    def from_string(cls, source, section="passlib3", encoding="utf-8"):
    ...
    def get_min_verify_time(self, category=None):
        ...
        .. deprecated:: 1.6
            min_verify_time option will be removed entirely in passlib3 1.8
    ...
    def to_file(self, stream, section="passlib3"): # pragma: no cover -- deprecated & unused
    ...
    def to_string(self, section="passlib3", encoding=None):
        """export policy to file.
...
class CryptContext(object):
    ...
    def from_string(cls, source, section="passlib3", encoding="utf-8"):
        ...
        :type section: str
        :param section:
            option name of section to read from, defaults to ``"passlib3"``.
    ...
    def _parse_ini_stream(stream, section, filename):
        """helper read INI from stream, extract passlib3 section as dict"""
    ...
    def load_path(self, path, update=False, section="passlib3", encoding="utf-8"):
    ...
    def load(self, source, update=False, section="passlib3", encoding="utf-8"):
        ...
        :param section:
            ...
            a section named ``"passlib3"``. This option allows an alternate
    ...
    def schemes(self, resolve=False, category=None, unconfigured=False):
        ...
        :type resolve: bool
        :arg resolve:
            if ``True``, will return a tuple of :class:`~passlib3.ifc.PasswordHash`
    ...
    def default_scheme(self, category=None, resolve=False, unconfigured=False):
        ...
        :type resolve: bool
        :arg resolve:
            if ``True``, will return a :class:`~passlib3.ifc.PasswordHash`
        ...
        .. versionchanged:: 1.7
            ...
            the base hasher from :mod:`passlib3.hash`.
        """
    ...
    def handler(self, scheme=None, category=None, unconfigured=False):
        """helper to resolve name of scheme -> :class:`~passlib3.ifc.PasswordHash` object used by scheme.
        ...
        :returns:
            :class:`~passlib3.ifc.PasswordHash` object used to implement
            the named scheme within this context (this will usually
            be one of the objects from :mod:`passlib3.hash`)
    ...
    def to_dict(self, resolve=False):
        ...
        :arg resolve:
            ...
            a :class:`~passlib3.ifc.PasswordHash` objects instead of just
            their names.
        ...
        As an example::
            ...
            >>> from passlib3.apps import ldap_nocrypt_context
    ...
    def to_string(self, section="passlib3"):
        """serialize to INI format and return as unicode string.

        :param section:
            name of INI section to output, defaults to ``"passlib3"``.
    ...
    ##def write_to_path(self, path, section="passlib3", update=False):
    ##    "write to INI file"
    ##    parser = ConfigParser()
    ...
    def needs_update(self, hash, scheme=None, category=None, secret=None):
        ...
        if scheme is not None:
            ...
            #       but may deprecate .handler() in passlib3 1.8.
    ...
    def hash(self, secret, scheme=None, category=None, **kwds):
        ...
        :param \\*\\*kwds:
            ...
            :meth:`PasswordHash.hash() <passlib3.ifc.PasswordHash.hash>` method.
    ...
    def verify(self, secret, hash, scheme=None, category=None, **kwds):
        ...
        :param \\*\\*kwds:
            ...
            and should match its :attr:`~passlib3.ifc.PasswordHash.context_kwds`.
        ...
        :raises ValueError:
            ...
            * if any of the arguments have an invalid value (this includes
              ...
              :meth:`PasswordHash.verify() <passlib3.ifc.PasswordHash.verify>` method).
    ...
    def verify_and_update(self, secret, hash, scheme=None, category=None, **kwds):
        ...
        :param \\*\\*kwds:
            ...
            :attr:`PasswordHash.context_kwds <passlib3.ifc.PasswordHash.context_kwds>`.
    ...
    def dummy_verify(self, elapsed=0):
        ...
        :param elapsed:
            ...
            .. deprecated:: 1.7.1
                ...
                this option is ignored, and will be removed in passlib3 1.8.
    ...
    def is_enabled(self, hash):
        ...
        which is recognized by the :class:`~passlib3.hash.unix_disabled` hash.
    ...
    def disable(self, hash=None):
        ...
        :raises RuntimeError:
            ...
            (such as :class:`~passlib3.hash.unix_disabled`) included
...
class LazyCryptContext(CryptContext):
    ...
    This is mainly used internally by modules such as :mod:`passlib3.apps`,

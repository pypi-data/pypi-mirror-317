"""passlib3.totp -- TOTP / RFC6238 / Google Authenticator utilities."""
#=============================================================================
# imports
#=============================================================================
from __future__ import absolute_import, division, print_function
from passlib3.utils.compat import PY3
# core
import base64
import calendar
import json
...
from passlib3.exc import TokenError, MalformedTokenError, InvalidTokenError, UsedTokenError
from passlib3.utils import (to_unicode, to_bytes, consteq,
                            getrandbytes, rng, SequenceMixin, xor_bytes, getrandstr)
from passlib3.utils.binary import BASE64_CHARS, b32encode, b32decode
from passlib3.utils.compat import (u, unicode, native_string_types, bascii_to_str, int_types, num_types,
                                   irange, byte_elem_value, UnicodeIO, suppress_cause)
from passlib3.utils.decor import hybrid_method, memoized_property
from passlib3.crypto.digest import lookup_hash, compile_hmac, pbkdf2_hmac
from passlib3.hash import pbkdf2_sha256
# local
__all__ = [
    # frontend classes
    "AppWallet",
    ...
    # errors (defined in passlib3.exc, but exposed here for convenience)
    "TokenError",
        "MalformedTokenError",
        "InvalidTokenError",
        "UsedTokenError",
...
class TOTP(object):
    ...
    ..
        See the passlib3 documentation for a full list of attributes & methods.
    """
    #=============================================================================
    # class attrs
    #=============================================================================

    #: minimum number of bytes to allow in key, enforced by passlib3.
    ...
    def using(cls, digits=None, alg=None, period=None,
        ...
        As an example::
            ...
            >>> from passlib3.totp import TOTP, generate_secret
...
#            counter += 1
    ...
    def verify(cls, token, source, **kwds):
        ...
        It's designed to parallel the :meth:`passlib3.ifc.PasswordHash.verify` method.
    ...
    def match(self, token, time=None, window=30, skew=0, last_counter=None):
        ...
        :raises ~passlib3.exc.TokenError:
    ...
    def to_uri(self, label=None, issuer=None):
        ...
        Usage example::
            ...
            >>> from passlib3.totp import TOTP

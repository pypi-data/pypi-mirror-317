"""passlib3.win32 - MS Windows support - DEPRECATED, WILL BE REMOVED IN 1.8

the LMHASH and NTHASH algorithms are used in various windows related contexts,
but generally not in a manner compatible with how passlib3 is structured.
...
See also :mod:`passlib3.hash.nthash`.
"""

from warnings import warn
warn("the 'passlib3.win32' module is deprecated, and will be removed in "
     "passlib3 1.8; please use the 'passlib3.hash.nthash' and "
     "'passlib3.hash.lmhash' classes instead.",
     DeprecationWarning)
...
from passlib3.hash import nthash
# local
__all__ = [
    "nthash",
    "raw_lmhash",

"""passlib3.ifc - abstract interfaces used by Passlib"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from passlib3.utils.decor import deprecated_method
# local
__all__ = [
    "PasswordHash",
]
...
class PasswordHash(object):
    ...
    #: .. versionadded:: 1.7
    #: .. TODO: passlib3 1.8: deprecate/rename this attr to "max_secret_size"?
    truncate_size = None

    # NOTE: these next two default to the optimistic "ideal",
    #       most hashes in passlib3 have to default to False
    #       for backward compat and/or expected behavior with existing hashes.

    #: If True, .hash() should throw a :exc:`~passlib3.exc.PasswordSizeError` for
    ...
    #: .. versionadded:: 1.7
    #: .. TODO: passlib3 1.8: deprecate/rename this attr to "truncate_hash_error"?
    truncate_error = True
    ...
    #===================================================================
    # the following entry points are used internally by passlib3,
    ...
    #: also indicates to passlib3.ext.django that (when installed in django),
    ...
    ##    currently only provided by bcrypt() to fix an historical passlib3 issue.
    ##    """

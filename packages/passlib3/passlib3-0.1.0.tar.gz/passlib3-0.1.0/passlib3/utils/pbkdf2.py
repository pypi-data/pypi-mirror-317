"""passlib3.pbkdf2 - PBKDF2 support
...
# site
# pkg
from passlib3.exc import ExpectedTypeError
from passlib3.utils.decor import deprecated_function
from passlib3.utils.compat import native_string_types
from passlib3.crypto.digest import norm_hash_name, lookup_hash, pbkdf1 as _pbkdf1, pbkdf2_hmac, compile_hmac
# local
__all__ = [
    # hash utils
    "norm_hash_name",
...
warn("the module 'passlib3.utils.pbkdf2' is deprecated as of Passlib 1.7, "
     "and will be removed in Passlib 2.0, please use 'passlib3.crypto' instead",
     DeprecationWarning)
...
norm_hash_name = deprecated_function(deprecated="1.7", removed="1.8", func_module=__name__,
    replacement="passlib3.crypto.digest.norm_hash_name")(norm_hash_name)
...
def get_prf(name):
    ...
    Usage example::
        ...
        >>> from passlib3.utils.pbkdf2 import get_prf
...
def pbkdf1(secret, salt, rounds, keylen=None, hash="sha1"):
    ...
    .. deprecated:: 1.7
        ...
        This has been relocated to :func:`passlib3.crypto.digest.pbkdf1`,
...
def pbkdf2(secret, salt, rounds, keylen=None, prf="hmac-sha1"):
    ...
    .. deprecated:: 1.7
        ...
        This has been deprecated in favor of :func:`passlib3.crypto.digest.pbkdf2_hmac`,

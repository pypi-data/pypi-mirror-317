"""passlib3.utils -- helpers for writing password hashes"""
#=============================================================================
# imports
#=============================================================================
from passlib3.utils.compat import JYTHON
# core
...
from passlib3.utils.decor import (
    # [remove these aliases in 2.0]
    deprecated_function,
    deprecated_method,
    memoized_property,
...
from passlib3.exc import ExpectedStringError, ExpectedTypeError
from passlib3.utils.compat import (add_doc, join_bytes, join_byte_values,
...
# XXX: move to .registry for passlib3 2.0?
unix_crypt_schemes = [
...
from passlib3.exc import MissingBackendError
...
# maximum password size which passlib3 will allow; see exc.PasswordSizeError
...
# XXX: should this be moved to passlib3.crypto, or compat backports?
...
try:
    ...
    if threading and PYPY and (7, 2, 0) <= sys.pypy_version_info <= (7, 3, 3):
        ...
        #: WARNING: if non-passlib3 code invokes crypt(), this lock won't be enough!
        ...
        from passlib3.utils.compat import nullcontext
...
# legacy alias, will be removed in passlib3 2.0
tick = timer
...
@deprecated_function(deprecated="1.7", removed="2.0",
                     replacement="passlib3.pwd.genword() / passlib3.pwd.genphrase()")
...
def is_crypt_context(obj):
    """check if object appears to be a :class:`~passlib3.context.CryptContext` instance"""

"""passlib3.crypto._blowfish._gen_files - meta script that generates unrolled.py"""
#=============================================================================
# imports
#=============================================================================
# core
...
import textwrap
# pkg
from passlib3.utils.compat import irange
# local
...
def main():
    ...
    write(0, """\
        \"""passlib3.crypto._blowfish.unrolled - unrolled loop implementation of bcrypt,
        ...
        #=================================================================
        # pkg
        from passlib3.crypto._blowfish.base import BlowfishEngine as _BlowfishEngine
        # local
        __all__ = [
            "BlowfishEngine",
        ]

"""
passlib3.utils.scrypt -- scrypt hash frontend and help utilities
...
from passlib3.utils.compat import PYPY
# local
__all__ =[
    "validate",
    "scrypt",
...
def scrypt(secret, salt, n, r, p=1, keylen=32):
    ...
    * ``n`` must a be a power of 2, and > 1 -- internal limitation of scrypt() implementation
    ...
    .. warning::
        ...
        is installed, passlib3 will use a builtin pure-python implementation of scrypt,
...
def _load_builtin_backend():
    """
    Load pure-python scrypt implementation built into passlib3.
    """
...
def _set_backend(name, dryrun=False):
    ...
    :raises ~passlib3.exc.MissingBackendError: if backend can't be found

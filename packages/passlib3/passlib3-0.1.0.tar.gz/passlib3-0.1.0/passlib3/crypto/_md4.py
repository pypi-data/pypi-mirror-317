"""
passlib3.crypto._md4 -- fallback implementation of MD4
...
.. note::
    ...
    by ``passlib3.crypto.lookup_hash()`` when a native implementation can't be found.
"""
...
import struct
# site
from passlib3.utils.compat import bascii_to_str, irange, PY3
# local
__all__ = ["md4"]

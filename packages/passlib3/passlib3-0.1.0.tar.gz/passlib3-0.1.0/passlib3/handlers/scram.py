"""passlib3.handlers.scram - hash for SCRAM credential storage"""
#=============================================================================
# imports
#=============================================================================
# core
...
# site
# pkg
from passlib3.utils import consteq, saslprep, to_native_str, splitcomma
from passlib3.utils.binary import ab64_decode, ab64_encode
from passlib3.utils.compat import bascii_to_str, iteritems, u, native_string_types
from passlib3.crypto.digest import pbkdf2_hmac, norm_hash_name
...
class scram(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    def extract_digest_info(cls, hash, alg):
        ...
        :arg alg:
            ...
            This value is run through :func:`~passlib3.crypto.digest.norm_hash_name`,
...
##    from passlib3.utils.compat import print_
##

...
# site
# pkg
from passlib3.handlers.misc import plaintext
from passlib3.utils import unix_crypt_schemes, to_unicode
from passlib3.utils.compat import uascii_to_str, unicode, u
...
class ldap_md5(_Base64DigestHelper):
    ...
    The :meth:`~passlib3.ifc.PasswordHash.hash` and :meth:`~passlib3.ifc.PasswordHash.genconfig` methods have no optional keywords.
    """
    name = "ldap_md5"
    ident = u("{MD5}")
    _hash_func = md5
...
class ldap_plaintext(plaintext):
    ...
    This class acts much like the generic :class:`!passlib3.hash.plaintext` handler,
...
##        from passlib3.hosts import host_context

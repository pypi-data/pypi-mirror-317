"""passlib3.handlers.pbkdf - PBKDF2 based hashes"""
#=============================================================================
# imports
#=============================================================================
# core
...
from passlib3.utils.compat import str_to_bascii, u, uascii_to_str, unicode
...
class cta_pbkdf2_sha1(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    @classmethod
    def from_string(cls, hash):
        # NOTE: passlib3 deviation - forbidding zero-padded rounds

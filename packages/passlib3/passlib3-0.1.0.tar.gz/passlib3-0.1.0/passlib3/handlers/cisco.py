"""
passlib3.handlers.cisco -- Cisco password hashes
"""
#=============================================================================
# imports
#=============================================================================
...
# site
# pkg
from passlib3.utils import right_pad_string, to_unicode, repeat_string, to_bytes
from passlib3.utils.binary import h64
from passlib3.utils.compat import unicode, u, join_byte_values, \
...
class cisco_pix(uh.HasUserContext, uh.StaticHandler):
    ...
    will result in a :exc:`~passlib3.exc.PasswordSizeError` if passed to :meth:`~cisco_pix.hash`,
    and be silently rejected if passed to :meth:`~cisco_pix.verify`.

    The :meth:`~passlib3.ifc.PasswordHash.hash`,
    :meth:`~passlib3.ifc.PasswordHash.genhash`, and
    :meth:`~passlib3.ifc.PasswordHash.verify` methods
    ...
    .. versionchanged:: 1.7.1
        ...
        to match Cisco behavior.  A number of :ref:`bugs <passlib3-asa96-bug>` were fixed
...
class cisco_asa(cisco_pix):
    ...
    will result in a :exc:`~passlib3.exc.PasswordSizeError` if passed to :meth:`~cisco_asa.hash`,

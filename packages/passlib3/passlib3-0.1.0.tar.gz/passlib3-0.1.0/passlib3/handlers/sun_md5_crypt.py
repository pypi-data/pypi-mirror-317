"""passlib3.handlers.sun_md5_crypt - Sun's Md5 Crypt, used on Solaris
...
# site
# pkg
from passlib3.utils import to_unicode
from passlib3.utils.binary import h64
from passlib3.utils.compat import byte_elem_value, irange, u, \
...
class sun_md5_crypt(uh.HasRounds, uh.HasSalt, uh.GenericHandler):
    ...
    default_rounds = 34000 # current passlib3 default
    min_rounds = 0

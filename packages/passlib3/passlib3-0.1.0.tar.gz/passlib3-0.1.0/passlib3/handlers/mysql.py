...
MySQL 3.2.3 / OLD_PASSWORD()
    ...
    See :mod:`passlib3.handlers.mysql_41` for the new algorithm was put in place in version 4.1
...
# site
# pkg
from passlib3.utils import to_native_str
from passlib3.utils.compat import bascii_to_str, unicode, u, \

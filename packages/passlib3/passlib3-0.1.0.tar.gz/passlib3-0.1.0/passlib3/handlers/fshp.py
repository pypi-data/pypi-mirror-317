...
from passlib3.utils.compat import bascii_to_str, iteritems, u,\
                                 unicode
from passlib3.crypto.digest import pbkdf1
# local
__all__ = [
    'fshp',
]
...
class fshp(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    #--HasRawSalt--
    default_salt_size = 16 # current passlib3 default, FSHP uses 8
    max_salt_size = None

    #--HasRounds--
    # FIXME: should probably use different default rounds
    # based on the variant. setting for default variant (sha256) for now.
    default_rounds = 480000 # current passlib3 default, FSHP uses 4096

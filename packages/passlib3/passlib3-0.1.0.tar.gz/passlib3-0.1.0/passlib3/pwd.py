"""passlib3.pwd -- password generation helpers"""
#=============================================================================
# imports
#=============================================================================
...
from passlib3.utils.compat import PY2, irange, itervalues, int_types
from passlib3.utils import rng, getrandstr, to_unicode
...
# register the wordsets built into passlib3
for name in "eff_long eff_short eff_prefixed bip39".split():
    default_wordsets.set_path(name, "passlib3:_data/wordsets/%s.txt" % name)

...
class WSNRoutingEnv(gym.Env):
    ...
    def __init__(self, n_sensors = 30, coverage_radius=(upper_bound - lower_bound) * 9/20, num_timesteps = None, version = None):
    ...
    def reset(self):
        if self.number_of_steps > 10000: # Change 30000 to a parameter taken from args or kwargs

...
from pygrocy2 import EntityType
from pygrocy2.utils import grocy_datetime_str, localize_datetime, parse_date
...
class SystemConfigDto(BaseModel, extra="allow"):
    ...
    def feature_flags_root_validator(self, fields: dict[str, Any]) -> dict[str, Any]:
        """Pydantic root validator to add all "FEATURE_FLAG_" settings to Dict."""
        features: dict[str, Any] = {}

        class_defined_fields = self.model_fields.values()

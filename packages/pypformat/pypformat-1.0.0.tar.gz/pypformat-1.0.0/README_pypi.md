...
> - The complete functionality of the `PyPformat` package (including all format configuration options) is described in the [PyPformat - Usage](https://github.com/SpectraL519/pypformat/tree/9446bf62f1e5a84107338e64b8dfb7e0a02833d5/docs/usage.md) document.
> - While the `PyPformat` package is already quite versatile and customizable, its development is ongoing. A detailed list of the planned features/improvements can be found in the [PyPformat - TODO](https://github.com/SpectraL519/pypformat/tree/9446bf62f1e5a84107338e64b8dfb7e0a02833d5/docs/todo.md) document.
...
The [PyPformat - Dev notes](https://github.com/SpectraL519/pypformat/tree/9446bf62f1e5a84107338e64b8dfb7e0a02833d5/docs/dev_notes.md) document contains the information about project development, testing and formatting.
...
The `PyPformat` project is licenced under the [MIT Licence](https://opensource.org/license/mit/), which can be inspected in the [LICENCE](https://github.com/SpectraL519/pypformat/tree/9446bf62f1e5a84107338e64b8dfb7e0a02833d5/LICENSE) file in the project's root directory.

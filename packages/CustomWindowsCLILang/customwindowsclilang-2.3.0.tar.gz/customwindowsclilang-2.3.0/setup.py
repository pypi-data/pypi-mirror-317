...
setup(
    name="CustomWindowsCLILang",
    version="2.3.0",
    description="A custom CLI language for handling Windows tasks",
    author="vinit",
    author_email="vineetp6@gmail.com",
    packages=find_packages(),
    entry_points={
        'console_scripts': [
            'open=cli_interpreter:main',  # For 'open' command
            'run=cli_interpreter:main',   # Add more commands as needed
            'search=cli_interpreter:main',  # Example command
        ],
    },
    classifiers=[
        "Programming Language :: Python :: 3",

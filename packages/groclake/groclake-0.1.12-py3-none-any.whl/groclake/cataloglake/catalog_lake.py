...
class CatalogLakeSearchIntentFetch(GrocCatalog):
    api_endpoint = '/catalog/search/intent/fetch'
...
class CatalogLakeAddressIntentFetch(GrocCatalog):
    api_endpoint = '/catalog/address/intent/fetch'

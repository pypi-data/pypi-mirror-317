...
class TableCustomfields(BaseModel):
    ...
    int_3: Optional[Annotated[int, Field(le=10000000000, strict=True, ge=-10000000000)]] = Field(default=None, description="A custom field containing an integer value. Supported filter type is `INT_RANGE`. ")
    int_4: Optional[Annotated[int, Field(le=10000000000, strict=True, ge=-10000000000)]] = Field(default=None, description="A custom field containing an integer value. Supported filter type is `INT_RANGE`. ")
    int_5: Optional[Annotated[int, Field(le=10000000000, strict=True, ge=-10000000000)]] = Field(default=None, description="A custom field containing an integer value. Supported filter type is `INT_RANGE`. ")
    ...
    float_3: Optional[Union[Annotated[float, Field(le=10000000000, strict=True, ge=-10000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=None, description="A custom field containing a floating point value. Supported filter type is `FLOAT_RANGE`. ")
    float_4: Optional[Union[Annotated[float, Field(le=10000000000, strict=True, ge=-10000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=None, description="A custom field containing a floating point value. Supported filter type is `FLOAT_RANGE`. ")
    float_5: Optional[Union[Annotated[float, Field(le=10000000000, strict=True, ge=-10000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=None, description="A custom field containing a floating point value. Supported filter type is `FLOAT_RANGE`. ")

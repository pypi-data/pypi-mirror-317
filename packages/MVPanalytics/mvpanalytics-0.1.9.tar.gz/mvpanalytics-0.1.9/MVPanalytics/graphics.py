...
def plot_external(params_chan, params_all, type_, external_name):
    ...
    if type_ == 'FS':
        ...
        plt.plot(pars_all.loc[all['sub_id_12']=='feed'].set_index('day')['epc_confirmed'], marker = 'o', label = 'feed all')
        ...
        plt.plot(pars_all.loc[all['sub_id_12']=='sms'].set_index('day')['epc_confirmed'], marker = 'o', label = 'sms all')

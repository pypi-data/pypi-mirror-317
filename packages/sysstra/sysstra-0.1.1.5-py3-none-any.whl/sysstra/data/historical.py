...
def fetch_option_candle_by_timestamp(exchange, underlying_symbol, strike_price, option_type, timestamp, granularity, expiry="near"):
    ...
    try:
        ...
        request_data = {"exchange": exchange, "underlying_symbol": underlying_symbol, "option_type": option_type,
                        "strike_price": strike_price, "timestamp": timestamp, "expiry": expiry, "granularity": granularity}

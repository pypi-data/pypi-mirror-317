...
GetRunDataStatus = _reflection.GeneratedProtocolMessageType(
    "GetRunDataStatus",
    (_message.Message,),
    {
...
LogBatchAsync = _reflection.GeneratedProtocolMessageType(
    "LogBatchAsync",
    (_message.Message,),
    {
        "Response": _reflection.GeneratedProtocolMessageType(
...
AMLMlflowService = service_reflection.GeneratedServiceType(
    "AMLMlflowService",
    (_service.Service,),
    dict(DESCRIPTOR=_AMLMLFLOWSERVICE, __module__="aml_service_pb2"),
)

AMLMlflowService_Stub = service_reflection.GeneratedServiceStubType(
    "AMLMlflowService_Stub",
    (AMLMlflowService,),
    dict(DESCRIPTOR=_AMLMLFLOWSERVICE, __module__="aml_service_pb2"),
)

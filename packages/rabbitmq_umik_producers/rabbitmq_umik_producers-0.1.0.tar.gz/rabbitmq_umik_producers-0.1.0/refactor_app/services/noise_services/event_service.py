...
class EventService:
    ...
    def __init__(
        ...
        self.record_repository = None
        self.threshold: float = 0.0
        self.size_window: int = 5

    def process(self, la_max: float, time_stamp: str):
        """
        ...
        if self.noise_event.waiting_for_noise_end == 5:
        ...
        if la_max > self.threshold:
            ...
            self.noise_event.waiting_for_noise_end = 0

        elif self.noise_event.is_event:
            self.noise_event.waiting_for_noise_end += 1
    ...
    def start(self, time_stamp: str, la_max: float) -> None:
        ...
        if not self.noise_event.is_event:
            ...
            nofication_message: NotificationMessage = NotificationMessage(
            ...
            self.notification_repository.create(notification_message=nofication_message)

...
class _Image_Preprocessor(ABC):
    ...
    def _get_input_shape(self) -> list:
        ...
        if (
            ...
            if len(shape_list) != 4:
                raise DegirumException(
                    f"Input shape for input #{self._model_input} must be a list of 4 integers, not {shape_list}"
                )
            return shape_list

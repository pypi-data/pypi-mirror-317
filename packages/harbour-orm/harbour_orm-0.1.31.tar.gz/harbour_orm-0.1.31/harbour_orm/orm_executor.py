...
class HarbourORM:
    ...
    def _read_only(self, query_builder: QueryBuilder, to_dict: bool, include_total_count: bool, **kwargs):
        ...
        param_types = self.check_for_datetime(params)
    ...
    # TODO: remove this method after Spanner emulator supports date/datetime params
    # ref: https://github.com/googleapis/python-spanner/issues/1148

...
class BitmapInfo(ValueObject):
    ...
    @staticmethod
    def create(pixel_bytes : List[int], width : int, height : int, format : BitmapInfo.PixelFormat) -> groupdocs.conversion.contracts.BitmapInfo:
        raise NotImplementedError()
    
    @property
    def format(self) -> BitmapInfo.PixelFormat:
...
class CgmDocumentInfo(PdfDocumentInfo):
    ...
    @property
    def table_of_contents(self) -> List[groupdocs.conversion.contracts.TableOfContentsItem]:
        '''Table of contents'''
        raise NotImplementedError()
...
class FontDocumentInfo(DocumentInfo):
...
class OlmDocumentInfo(DocumentInfo):
    ...
    @property
    def folders(self) -> List[groupdocs.conversion.contracts.OlmFolderInfo]:
...
class PersonalStorageDocumentInfo(DocumentInfo):
    ...
    @property
    def folders(self) -> List[groupdocs.conversion.contracts.PersonalStorageFolderInfo]:
        '''Folders in the storage'''
        raise NotImplementedError()
...
class PersonalStorageFolderInfo(ValueObject):
    ...
    @property
    def sub_folders(self) -> List[groupdocs.conversion.contracts.PersonalStorageFolderInfo]:
        '''Sub Folders'''
        raise NotImplementedError()
    
    @property
    def items(self) -> List[groupdocs.conversion.contracts.PersonalStorageItemInfo]:
        '''Items in the folder'''
        raise NotImplementedError()
...
class PersonalStorageItemInfo(ValueObject):
    ...
    @property
    def sent(self) -> Optional[datetime]:
        '''Item Sent DateTime'''
        raise NotImplementedError()
...
class PossibleConversions(ValueObject):
    ...
    @property
    def all(self) -> Iterable[groupdocs.conversion.contracts.TargetConversion]:
        '''All target file types and primary/secondary flag'''
        raise NotImplementedError()
    
    @property
    def primary(self) -> Iterable[groupdocs.conversion.filetypes.FileType]:
        '''Primary target file types'''
        raise NotImplementedError()
    
    @property
    def secondary(self) -> Iterable[groupdocs.conversion.filetypes.FileType]:

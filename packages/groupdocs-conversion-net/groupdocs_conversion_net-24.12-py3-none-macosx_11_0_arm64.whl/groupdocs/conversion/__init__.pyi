...
class Converter:
    ...
    @overload
    def convert(self, document : io.RawIOBase, convert_options : groupdocs.conversion.options.convert.ConvertOptions) -> None:
    ...
    @overload
    def convert_by_page(self, page_stream : io.RawIOBase, page_number : int, convert_options : groupdocs.conversion.options.convert.ConvertOptions) -> None:
        '''Converts source document. Saves the converted document page to a stream
    ...
    @staticmethod
    def get_all_possible_conversions() -> Iterable[groupdocs.conversion.contracts.PossibleConversions]:
...
class ConverterSettings:
    ...
    @property
    def font_directories(self) -> List[str]:

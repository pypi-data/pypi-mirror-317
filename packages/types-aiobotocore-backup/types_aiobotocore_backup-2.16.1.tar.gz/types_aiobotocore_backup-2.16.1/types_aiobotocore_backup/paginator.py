...
class ListIndexedRecoveryPointsPaginator(_ListIndexedRecoveryPointsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_backup/paginators/#listindexedrecoverypointspaginator)
    """

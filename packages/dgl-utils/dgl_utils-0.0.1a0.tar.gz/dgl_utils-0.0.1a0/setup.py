...
setup(
	...
	description="""
	dgl-utils is a Python package offering a suite of plotting functions to visualize machine learning models and data. It provides intuitive and customizable plots to aid in model evaluation and data analysis.
	...
	**Ideal for:**
	...
	Enhance your machine learning workflow with dgl-utils' comprehensive plotting capabilities.
	"""
)

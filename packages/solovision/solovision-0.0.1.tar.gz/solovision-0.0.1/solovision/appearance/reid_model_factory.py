...
from solovision.appearance.backbones.clip.make_model import make_model
from solovision.appearance.backbones.osnet import (
    osnet_ibn_x1_0,
    osnet_x0_5,
    osnet_x0_25,
    osnet_x0_75,
...
from solovision.appearance.backbones.osnet_ain import (
    osnet_ain_x0_5,
    osnet_ain_x0_25,
    osnet_ain_x0_75,
    osnet_ain_x1_0,
)
from solovision.appearance.backbones.resnet import resnet50, resnet101
...
def build_model(name, num_classes, loss="softmax", pretrained=True, use_gpu=True):
    ...
    if 'clip' in name:
        ...
        from solovision.appearance.backbones.clip.config.defaults import _C as cfg

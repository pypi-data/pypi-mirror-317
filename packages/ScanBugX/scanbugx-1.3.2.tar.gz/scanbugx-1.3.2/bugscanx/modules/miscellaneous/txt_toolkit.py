...
def merge_txt_files():
    ...
    merge_all = get_input(" Do you want to merge all .txt files in the directory? (yes/no)", choices=["yes", "no"], default="yes")
...
def txt_toolkit_main_menu():
    while True:
        console.print("[cyan]\n 🛠️  TXT Toolkit - Select an Option:[/cyan]")
        console.print("[yellow] 1. ✂️  Split TXT File[/yellow]")
        console.print("[yellow] 2. 🗑️  Remove Duplicate Domains[/yellow]")

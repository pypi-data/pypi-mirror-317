...
def generate_profiling(file_excel=None, wo=None):
    ...
    df_contenido_nivel_colectivo = df_contenido_nivel_colectivo.sort(['ID_CONTENIDO', 'ID_NIVEL', 'ID_COLECTIVO'], ascending=[True, False])
    ...
    df_recurso = df_recurso.sort(['ID_RECURSO', 'TIPO_RECURSO'], ascending=[True, False])
    ...
    df_colectivo = df_colectivo.sort(['ID_COLECTIVO'], ascending=[True, False])
    ...
    df_colectivo_grupo = df_colectivo_grupo.sort(['GROUP', 'ID_COLECTIVO'], ascending=[True, False])

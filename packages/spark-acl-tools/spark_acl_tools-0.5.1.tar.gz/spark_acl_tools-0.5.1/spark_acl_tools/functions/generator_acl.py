...
def get_dataframe_catalog_nivel():
    df_catalogo_nivel = [
        ...
        {"CODE": "03", "DESC": "DAAS PERU DATA ARCHITECT", "SHOR_NAME": "DATA ARCHITECT", "DEFAULT": "NO"},
        {"CODE": "04", "DESC": "DAAS PERU EGRESSION DECRYPTION", "SHOR_NAME": "EGRESSION DECRYPTION", "DEFAULT": "YES"},
        {"CODE": "05", "DESC": "DAAS PERU MICROSTRATEGY", "SHOR_NAME": "MICROSTRATEGY", "DEFAULT": "NO"},
        {"CODE": "06", "DESC": "DAAS PERU PROCESS MANAGER", "SHOR_NAME": "PROCESS MANAGER", "DEFAULT": "NO"},
        {"CODE": "07", "DESC": "DAAS PERU VBOX", "SHOR_NAME": "VBOX", "DEFAULT": "NO"},
        {"CODE": "09", "DESC": "DAAS PERU HISTORY SERVER", "SHOR_NAME": "HISTORY SERVER", "DEFAULT": "NO"},
        {"CODE": "10", "DESC": "DAAS PERU XDATA", "SHOR_NAME": "XDATA", "DEFAULT": "NO"},
        {"CODE": "11", "DESC": "DAAS PERU VISUALIZER", "SHOR_NAME": "VISUALIZADOR", "DEFAULT": "NO"},
        {"CODE": "12", "DESC": "DAAS PERU INTELLIGENCE", "SHOR_NAME": "INTELLIGENCE", "DEFAULT": "NO"},
        {"CODE": "13", "DESC": "DAAS PERU FILE EXPLORER", "SHOR_NAME": "FILE EXPLORER", "DEFAULT": "NO"},
        {"CODE": "15", "DESC": "DAAS PERU DATAPROC USER READ", "SHOR_NAME": "DATAPROC USER READ", "DEFAULT": "YES"},
        {"CODE": "16", "DESC": "DAAS PERU DATA SCIENTIST", "SHOR_NAME": "DATA SCIENTIST", "DEFAULT": "NO"},
        {"CODE": "17", "DESC": "DAAS PERU SANDBOX ADMIN", "SHOR_NAME": "SANDBOX ADMIN", "DEFAULT": "NO"},
        {"CODE": "18", "DESC": "DAAS PERU SANDBOX OWNER", "SHOR_NAME": "SANDBOX OWNER", "DEFAULT": "NO"},
        {"CODE": "21", "DESC": "DAAS PERU DATAPROC USER", "SHOR_NAME": "DATAPROC USER", "DEFAULT": "YES"},
        {"CODE": "26", "DESC": "DAAS PERU DEVELOPER", "SHOR_NAME": "DEVELOPER", "DEFAULT": "YES"},
        {"CODE": "27", "DESC": "DAAS PERU GDRIVE", "SHOR_NAME": "GDRIVE", "DEFAULT": "YES"}
    ]
...
def get_acl(path, uuaa_desc):
    ...
    if path_target == "app" and uuaa_desc == "PROJECT":
        ...
        if path_unique == f"raw-{uuaa_name}-refusals":
            ...
            struct_acl = f"DAS_PE_DATM_{uuaa_name.upper()}MRFL"
        elif path_unique == f"master-p{uuaa_name}-refusals-dq":
            struct_acl = f"DAS_PE_DATM_{uuaa_name.upper()}MRFLDQ"
        else:
            struct_acl = ""
        rs["ID_RECURSO"] = struct_acl
        rs["TARGET_RECURSO"] = path_target.upper()
        ...
        elif path_unique == f"master-{uuaa_name2}-data":
            struct_acl = f"DAS_PE_DATM_{uuaa_name2.upper()}MDAT"
        elif path_unique == f"master-{uuaa_name2}-data-l1t":
            struct_acl = f"DAS_PE_DATM_{uuaa_name2.upper()}ML1T"
        else:
            struct_acl = ""
...
def generate_profiling(file_excel=None, wo=None):
    ...
    df_colectivo.loc[:, 'GESTOR RESPONSABLE'] = "PAIS - PERU"
    df_colectivo.loc[:, 'DESCRIPCION'] = df_colectivo["NOMBRE_COLECTIVO"]
    ...
    df_grupo_colectivo.loc[:, 'ENTORNO'] = "E.PREVIOUS / PRODUCTION"
    df_grupo_colectivo.loc[:, 'AMBIENTE'] = "DATA AS SERVICE PERU"
    df_grupo_colectivo.loc[:, 'TIPO CONNECTOR'] = "FIJO"
    ...
    df_grupo_colectivo.to_excel(writer, sheet_name="colectivo_grupo", index=False)

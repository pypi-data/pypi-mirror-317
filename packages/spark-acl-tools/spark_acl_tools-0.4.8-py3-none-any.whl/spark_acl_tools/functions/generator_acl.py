...
def get_dataframe_catalog_nivel():
    df_catalogo_nivel = [
        ...
        {"CODE": "06", "DESC": "DAAS PERU PM PRODUCTIVO", "SHOR_NAME": "PROCESS MANAGER", "DEFAULT": "NO"},
        ...
        {"CODE": "11", "DESC": "DAAS PERU VISUALIZADOR", "SHOR_NAME": "VISUALIZADOR", "DEFAULT": "NO"},
...
def generate_profiling(file_excel=None, wo=None):
    ...
    df_contenido.loc[:, 'DESCRIPCION'] = df_cotenido["NOMBRE_CONTENIDO"]
    df_contenido.loc[:, 'UUAA'] = "9993"
    df_contenido.loc[:, 'ALIAS APLICACION'] = df_cotenido["NOMBRE_CONTENIDO"]
    ...
    df_contenido_nivel_colectivo = df_contenido_nivel_colectivo[["ID_CONTENIDO", "ID_NIVEL", "UUAA", "ID_COLECTIVO", "NOMBRE_COLECTIVO"]]

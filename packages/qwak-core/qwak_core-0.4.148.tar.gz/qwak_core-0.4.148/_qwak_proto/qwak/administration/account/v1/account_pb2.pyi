...
class AccountBrief(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "default_env_id", b"default_env_id", "environment_ids", b"environment_ids", "jfrog_tenant_id", b"jfrog_tenant_id"]) -> None: ...

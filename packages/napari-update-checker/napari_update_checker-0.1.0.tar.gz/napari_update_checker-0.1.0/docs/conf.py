...
from napari_update_checker._version import (
    version as napari_update_checker_version,
)

release = napari_update_checker_version
...
html_theme_options = {
    ...
    "github_url": "https://github.com/napari/update-checker",
...
html_title = "napari update checker"

...
#
# >> docker pull mysql
# >> docker run -d --name test-mysql -e MYSQL_ROOT_PASSWORD=abc123 -p 3306:3306 mysql:latest
#
...
if __name__ == '__main__':
    ...
    er = Env()
    Env.set_env_vars_from_file(env_filepath=er.REPO_DIR + '/.env.nwae.math.ut.mysql')

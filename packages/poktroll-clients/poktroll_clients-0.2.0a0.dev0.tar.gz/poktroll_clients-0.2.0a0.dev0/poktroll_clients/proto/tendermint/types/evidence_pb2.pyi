...
class Evidence(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["duplicate_vote_evidence", b"duplicate_vote_evidence", "light_client_attack_evidence", b"light_client_attack_evidence", "sum", b"sum"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["duplicate_vote_evidence", b"duplicate_vote_evidence", "light_client_attack_evidence", b"light_client_attack_evidence", "sum", b"sum"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["sum", b"sum"]) -> typing.Literal["duplicate_vote_evidence", "light_client_attack_evidence"] | None: ...
...
class DuplicateVoteEvidence(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["timestamp", b"timestamp", "vote_a", b"vote_a", "vote_b", b"vote_b"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["timestamp", b"timestamp", "total_voting_power", b"total_voting_power", "validator_power", b"validator_power", "vote_a", b"vote_a", "vote_b", b"vote_b"]) -> None: ...
...
class LightClientAttackEvidence(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["conflicting_block", b"conflicting_block", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["byzantine_validators", b"byzantine_validators", "common_height", b"common_height", "conflicting_block", b"conflicting_block", "timestamp", b"timestamp", "total_voting_power", b"total_voting_power"]) -> None: ...
...
class EvidenceList(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["evidence", b"evidence"]) -> None: ...

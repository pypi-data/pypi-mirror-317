...
class Block(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["data", b"data", "evidence", b"evidence", "header", b"header", "last_commit", b"last_commit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "evidence", b"evidence", "header", b"header", "last_commit", b"last_commit"]) -> None: ...

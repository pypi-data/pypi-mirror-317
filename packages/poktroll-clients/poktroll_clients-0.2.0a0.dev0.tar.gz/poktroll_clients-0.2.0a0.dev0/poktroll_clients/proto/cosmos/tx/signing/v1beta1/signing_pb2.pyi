...
class _SignModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SignMode.ValueType], builtins.type):
    ...
    """
    SIGN_MODE_DIRECT_AUX: _SignMode.ValueType  # 3
...
Since: cosmos-sdk 0.50
"""
SIGN_MODE_DIRECT_AUX: SignMode.ValueType  # 3
"""SIGN_MODE_DIRECT_AUX specifies a signing mode which uses
SignDocDirectAux. As opposed to SIGN_MODE_DIRECT, this sign mode does not
require signers signing over other signers' `signer_info`.
...
class SignatureDescriptors(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["signatures", b"signatures"]) -> None: ...
...
class SignatureDescriptor(google.protobuf.message.Message):
    ...
    class Data(google.protobuf.message.Message):
        ...
        class Single(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["mode", b"mode", "signature", b"signature"]) -> None: ...
        ...
        class Multi(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["bitarray", b"bitarray", "signatures", b"signatures"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["data", b"data", "public_key", b"public_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "public_key", b"public_key", "sequence", b"sequence"]) -> None: ...

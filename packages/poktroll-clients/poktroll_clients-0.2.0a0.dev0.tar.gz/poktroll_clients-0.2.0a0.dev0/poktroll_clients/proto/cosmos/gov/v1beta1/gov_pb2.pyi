...
class TextProposal(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "title", b"title"]) -> None: ...
...
class Proposal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["content", b"content", "deposit_end_time", b"deposit_end_time", "final_tally_result", b"final_tally_result", "submit_time", b"submit_time", "voting_end_time", b"voting_end_time", "voting_start_time", b"voting_start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["content", b"content", "deposit_end_time", b"deposit_end_time", "final_tally_result", b"final_tally_result", "proposal_id", b"proposal_id", "status", b"status", "submit_time", b"submit_time", "total_deposit", b"total_deposit", "voting_end_time", b"voting_end_time", "voting_start_time", b"voting_start_time"]) -> None: ...
...
class TallyResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["abstain", b"abstain", "no", b"no", "no_with_veto", b"no_with_veto", "yes", b"yes"]) -> None: ...
...
class Vote(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["option", b"option", "options", b"options", "proposal_id", b"proposal_id", "voter", b"voter"]) -> None: ...

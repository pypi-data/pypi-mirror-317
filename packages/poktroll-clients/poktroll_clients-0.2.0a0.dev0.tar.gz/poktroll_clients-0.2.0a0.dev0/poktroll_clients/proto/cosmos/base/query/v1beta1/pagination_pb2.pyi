...
class PageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["count_total", b"count_total", "key", b"key", "limit", b"limit", "offset", b"offset", "reverse", b"reverse"]) -> None: ...
...
class PageResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["next_key", b"next_key", "total", b"total"]) -> None: ...

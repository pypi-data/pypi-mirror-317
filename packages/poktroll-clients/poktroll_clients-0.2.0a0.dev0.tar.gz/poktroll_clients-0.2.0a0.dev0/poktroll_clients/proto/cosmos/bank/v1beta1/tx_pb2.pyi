...
class MsgSend(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["amount", b"amount", "from_address", b"from_address", "to_address", b"to_address"]) -> None: ...
...
class MsgSetSendEnabled(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["authority", b"authority", "send_enabled", b"send_enabled", "use_default_for", b"use_default_for"]) -> None: ...
...
class MsgBurn(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["amount", b"amount", "from_address", b"from_address"]) -> None: ...

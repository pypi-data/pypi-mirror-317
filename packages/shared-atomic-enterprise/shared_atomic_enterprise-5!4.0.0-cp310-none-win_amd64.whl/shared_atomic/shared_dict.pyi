...
class shared_dict:
    ...
    def __init__(self, name: bytes = ..., size: int = ..., bucket_chunk_size_exponent: int = ..., bucket_chunk_number: int = ..., chunk_size_exponent: int = ...) -> Any:
    ...
    def get(self, input_key) -> list:
        ...
        get the target object from shared_dict with input_key
                ...
                :return: list in form of [Boolean, object]
                        The first boolean value indicates whether the input_key is in the dict 
                        The second python object is the target object if the first boolean value is True. 
        """
...
def get(target: shared_dict, input_key) -> list:
    """get(target: shared_dict, input_key) -> list
    ...
    get the target object from shared_dict with input_key
        ...
        :return: list in form of [Boolean, object]
                ...
                The second python object is the target object if the first boolean value is True. 
    """
def insert(target: shared_dict, input_key, input_value) -> int:
    """insert(target: shared_dict, input_key, input_value) -> int
    ...
    insert the target shared_dict with input_key and input_value
        ...
        :return: 1 if successful
    """
def remove(target: shared_dict, input_key) -> int:
    """remove(target: shared_dict, input_key) -> int

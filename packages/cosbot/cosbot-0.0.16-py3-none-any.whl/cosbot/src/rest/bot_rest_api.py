...
from cosbot.src.app.app import PATH_SESSION
...
class BotRestApi:
    ...
    _route = 'https://aurora-cos.keygenqt.com/api'
    ...
    def auth(self, token: str):
        try:
            if PATH_SESSION.exists():
                with open(PATH_SESSION, 'rb') as f:
    ...
    def ping_auth(self):
        ...
        if not result:
            ...
            with open(PATH_SESSION, 'wb') as f:

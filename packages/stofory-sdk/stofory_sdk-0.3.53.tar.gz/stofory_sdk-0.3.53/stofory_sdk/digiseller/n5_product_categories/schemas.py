...
class PricesUnit(msgspec.Struct, forbid_unknown_fields=True, kw_only=True):
    ...
    unit_cnt_min: Optional[int] = None  # Минимальное количество единиц, которое можно купить
    unit_cnt_max: Optional[int] = None  # Максимальное количество единиц, которое можно купить

...
about = {}
with open(os.path.join(here, "wirtual", "plugins", "clova", "version.py"), "r") as f:
    exec(f.read(), about)


setuptools.setup(
    name="wirtual-plugins-clova",
    version=about["__version__"],
    description="Wirtual Agents Plugin for LINE Clova STT",
    ...
    install_requires=["wirtual-agents>=0.0.1", "pydub~=0.25.1"],
    project_urls={

...
def extract_form_info(
    ...
    attributes (Optional[Dict[str, str]], optional): The attributes to match for the HTML element. Defaults to {"id": "formDiv"}.

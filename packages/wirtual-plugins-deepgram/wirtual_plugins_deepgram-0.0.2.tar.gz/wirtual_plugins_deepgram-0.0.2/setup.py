...
about = {}
with open(os.path.join(here, "wirtual", "plugins", "deepgram", "version.py"), "r") as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    install_requires=["wirtual-agents>=0.0.1", "numpy>=1.26"],
    package_data={"wirtual.plugins.deepgram": ["py.typed"]},
    project_urls={

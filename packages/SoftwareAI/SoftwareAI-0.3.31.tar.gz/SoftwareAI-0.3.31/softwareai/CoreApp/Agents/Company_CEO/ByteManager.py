...
class ByteManager:
    ...
    def AI_1_ByteManager_Company_Owners(self,mensagem):
        ...
        if 'solicitadoalgumcodigo' in teste_dict:
            ...
            if flag:
                print(flag)
                resposta_do_tigrao_com_doc_pre_projeto = self.Pre_Project_Document.AI_1_Pre_Project_Document_Writer(appfb=appfb, client=client, mensagem=pergunta_ao_tigrao)#invoke_tigrao(pergunta_ao_tigrao)

                print(resposta_do_tigrao_com_doc_pre_projeto)

                Uploadfile = resposta_do_tigrao_com_doc_pre_projeto

                path_planilha_Projeto, path_nome_do_cronograma, path_name_doc_Pre_Projeto = self.Gerente_de_projeto.Bob_Gerente_de_projeto(appfb=appfb, client=client, Uploadfile)
                
                path_Roadmap, cronograma_do_projeto, planilha, doc_Pre_Projeto = self.Equipe_De_Solucoes.Dallas_Equipe_De_Solucoes_Roadmap(appfb=appfb, client=client, path_nome_do_cronograma, path_planilha_Projeto, path_name_doc_Pre_Projeto)
                ...
                anaysis_in_txt_path = self.Softwareanaysis.AI_SynthOperator(appfb=appfb, client=client, path_Roadmap, cronograma_do_projeto, planilha, doc_Pre_Projeto)

                script_version_1_path = self.SoftwareDevelopment.AI_QuantumCore(
                        appfb=appfb, client=client, 

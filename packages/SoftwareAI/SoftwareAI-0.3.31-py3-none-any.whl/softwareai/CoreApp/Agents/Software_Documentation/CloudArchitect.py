...
class Software_Documentation:
    ...
    def CloudArchitect_Software_Documentation_Type_Update(self, appfb, client, repo_name, path_readme, code_python_software_old, code_path_python_software_new, path_Analysis, path_Roadmap, path_Spreadsheet, path_Timeline, path_Preproject):
    ...
    def check_and_upload_docs(self, name="DocGitHubData"):

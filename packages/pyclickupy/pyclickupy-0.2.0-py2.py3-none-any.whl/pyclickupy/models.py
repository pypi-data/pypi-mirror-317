...
class Features(BaseModel):
    due_dates: DueDates | None = None
    multiple_assignees: MultipleAssignees | None = None
    sprints: Sprints | None = None
    ...
    dependency_warning: DependencyWarning | None = None
    portfolios: Optional[PortfoliosStatus] = None
    points: Points | None = None
    custom_items: CustomItems | None = None
    zoom: Zoom | None = None

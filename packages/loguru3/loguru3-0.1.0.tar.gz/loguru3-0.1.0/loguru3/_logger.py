...
.. |loguru3-config| replace:: ``loguru3-config``
...
class Logger:
    ...
    The |Logger| is the core object of ``loguru3``, every logging configuration and usage pass
    ...
    You should not instantiate a |Logger| by yourself, use ``from loguru3 import logger`` instead.
    """
    ...
    def __repr__(self):
        return "<loguru3.logger handlers=%r>" % list(self._core.handlers.values())
    ...
    def configure(self, *, handlers=None, levels=None, extra=None, patcher=None, activation=None):
        ...
        use the |loguru3-config|_ library developed by `@erezinman`_.

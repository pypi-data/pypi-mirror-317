...
async def handle_list_tools() -> list[types.Tool]:
    ...
    return [
        types.Tool(
            name="code-execution",
            description="help users to do code execution, support java, python, javascript。(with code execution, it helps users accomplish tasks in various work scenarios, such as document processing and analysis, etc.)",
            inputSchema={
                "type": "object",
                "properties": {

...
from Buke_autoTrade_Pypi.indicator import sma, ibs, pivot_standard, 순거래대금, RSI
from Buke_autoTrade_Pypi.function import rank, ts_max
...
def Buke_ST002_buy_list(dir, day):

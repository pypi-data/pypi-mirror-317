...
class KitchenAIAppSchema(BaseModel):
    ...
    embed_handlers: List[StrictStr]
    storage_handlers: List[StrictStr]
    __properties: ClassVar[List[str]] = ["namespace", "query_handlers", "agent_handlers", "embed_handlers", "storage_handlers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "embed_handlers": obj.get("embed_handlers"),
            "storage_handlers": obj.get("storage_handlers")
        })
        return _obj

...
from uvicorn33.server import Server, ServerState  # noqa: F401  # Used to be defined here.
from uvicorn33.supervisors import ChangeReload, Multiprocess
...
def print_version(ctx: click.Context, param: click.Parameter, value: bool) -> None:
    if not value or ctx.resilient_parsing:
        return
    click.echo(
        "Running uvicorn33 {version} with {py_implementation} {py_version} on {system}".format(  # noqa: UP032
            version=uvicorn33.__version__,
...
@click.option(
    ...
    expose_value=False,
    is_eager=True,
    help="Display the uvicorn33 version and exit.",
)
@click.option(
    "--app-dir",
    default="",

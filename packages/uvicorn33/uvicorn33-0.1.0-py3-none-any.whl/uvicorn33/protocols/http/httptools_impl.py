...
from uvicorn33.config import Config
from uvicorn33.logging import TRACE_LOG_LEVEL
from uvicorn33.protocols.http.flow_control import CLOSE_HEADER, HIGH_WATER_LIMIT, FlowControl, service_unavailable
from uvicorn33.protocols.utils import get_client_addr, get_local_addr, get_path_with_query_string, get_remote_addr, is_ssl
from uvicorn33.server import ServerState
...
class HttpToolsProtocol(asyncio.Protocol):
    def __init__(
        ...
        self.logger = logging.getLogger("uvicorn33.error")
        self.access_logger = logging.getLogger("uvicorn33.access")
    ...
    def _unsupported_upgrade_warning(self) -> None:
        ...
        if not self._should_upgrade_to_ws():
            msg = "No supported WebSocket library detected. Please use \"pip install 'uvicorn33[standard]'\", or install 'websockets' or 'wsproto' manually."  # noqa: E501

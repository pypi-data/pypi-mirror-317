...
if TYPE_CHECKING:
    from uvicorn33.protocols.http.h11_impl import H11Protocol
    from uvicorn33.protocols.http.httptools_impl import HttpToolsProtocol
    from uvicorn33.protocols.websockets.websockets_impl import WebSocketProtocol
    from uvicorn33.protocols.websockets.wsproto_impl import WSProtocol

...
from uvicorn33.server import Server

warnings.warn(
    "The `uvicorn33.workers` module is deprecated. Please use `uvicorn33-worker` package instead.\n"
...
class UvicornWorker(Worker):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        logger = logging.getLogger("uvicorn33.access")

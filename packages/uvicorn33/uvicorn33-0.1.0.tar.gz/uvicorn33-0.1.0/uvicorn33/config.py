...
from uvicorn33._types import ASGIApplication
from uvicorn33.importer import ImportFromStringError, import_from_string
from uvicorn33.logging import TRACE_LOG_LEVEL
from uvicorn33.middleware.asgi2 import ASGI2Middleware
from uvicorn33.middleware.message_logger import MessageLoggerMiddleware
from uvicorn33.middleware.proxy_headers import ProxyHeadersMiddleware
from uvicorn33.middleware.wsgi import WSGIMiddleware
...
HTTP_PROTOCOLS: dict[HTTPProtocolType, str] = {
    "auto": "uvicorn33.protocols.http.auto:AutoHTTPProtocol",
    "h11": "uvicorn33.protocols.http.h11_impl:H11Protocol",
    "httptools": "uvicorn33.protocols.http.httptools_impl:HttpToolsProtocol",
}
WS_PROTOCOLS: dict[WSProtocolType, str | None] = {
    "auto": "uvicorn33.protocols.websockets.auto:AutoWebSocketsProtocol",
    "none": None,
    "websockets": "uvicorn33.protocols.websockets.websockets_impl:WebSocketProtocol",
    "wsproto": "uvicorn33.protocols.websockets.wsproto_impl:WSProtocol",
}
LIFESPAN: dict[LifespanType, str] = {
    "auto": "uvicorn33.lifespan.on:LifespanOn",
    "on": "uvicorn33.lifespan.on:LifespanOn",
    "off": "uvicorn33.lifespan.off:LifespanOff",
}
LOOP_SETUPS: dict[LoopSetupType, str | None] = {
    "none": None,
    "auto": "uvicorn33.loops.auto:auto_loop_setup",
    "asyncio": "uvicorn33.loops.asyncio:asyncio_setup",
    "uvloop": "uvicorn33.loops.uvloop:uvloop_setup",
}
...
LOGGING_CONFIG: dict[str, Any] = {
    ...
    "formatters": {
        "default": {
            "()": "uvicorn33.logging.DefaultFormatter",
            "fmt": "%(levelprefix)s %(message)s",
            "use_colors": None,
        },
        "access": {
            "()": "uvicorn33.logging.AccessFormatter",
    ...
    "loggers": {
        "uvicorn33": {"handlers": ["default"], "level": "INFO", "propagate": False},
        "uvicorn33.error": {"level": "INFO"},
        "uvicorn33.access": {"handlers": ["access"], "level": "INFO", "propagate": False},
    },
}

logger = logging.getLogger("uvicorn33.error")
...
class Config:
    ...
    def configure_logging(self) -> None:
        ...
        if self.log_config is not None:
            if isinstance(self.log_config, dict):
                ...
                # Install the PyYAML package or the uvicorn33[standard] optional
        ...
        if self.log_level is not None:
            ...
            logging.getLogger("uvicorn33.error").setLevel(log_level)
            logging.getLogger("uvicorn33.access").setLevel(log_level)
            logging.getLogger("uvicorn33.asgi").setLevel(log_level)
        if self.access_log is False:
            logging.getLogger("uvicorn33.access").handlers = []
            logging.getLogger("uvicorn33.access").propagate = False
    ...
    def load(self) -> None:
        ...
        self.encoded_headers = (
            [(b"server", b"uvicorn33")] + encoded_headers

...
from ldsi.primitives.module import BaseModule
...
class Module(BaseModule, metaclass=ProgramMeta):
    ...
    def batch(
        ...
        """
        Processes a list of ldsi.Example instances in parallel using the Parallel module.

        :param examples: List of ldsi.Example instances to process.

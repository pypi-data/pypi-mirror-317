...
class ProgramOfThought(Module):
    ...
    def _generate_signature(self, mode):
        ...
        fields_for_mode = {
            "generate": {
                "generated_code": ldsi.OutputField(
                    prefix="Code:",
            ...
            "answer": {
                "final_generated_code": ldsi.InputField(
                    prefix="Code:",
                    desc="python code that answers the question",
                    format=str,
                ),
                "code_output": ldsi.InputField(
                    prefix="Code Output:",
        ...
        return ldsi.Signature(signature_dict)

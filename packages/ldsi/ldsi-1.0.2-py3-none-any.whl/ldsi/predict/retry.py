...
#         if ldsi.settings.backtrack_to == self:
#             for key, value in ldsi.settings.backtrack_to_args.items():
...
#         if ldsi.settings.trace is not None:

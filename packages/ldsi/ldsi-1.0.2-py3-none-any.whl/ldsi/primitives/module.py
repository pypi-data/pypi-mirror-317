...
from ldsi.utils.saving import get_dependency_versions
...
class BaseModule:
    ...
    def named_parameters(self):
        ...
        def add_parameter(param_name, param_value):
            ...
            elif isinstance(param_value, ldsi.Module):
        ...
        for name, value in self.__dict__.items():
            ...
            elif isinstance(value, ldsi.Module):
                # When a sub-module is pre-compiled, keep it frozen.
    ...
    def save(self, path, save_program=False):
        ...
        critical dependencies or LDSI version.
        ...
        if save_program:
            ...
            try:
                ...
                raise RuntimeError(
                    f"Saving failed with error: {e}. Please remove the non-picklable attributes from your LDSI program, "
    ...
    def load(self, path):
        """Load the saved module. You may also want to check out ldsi.load, if you want to

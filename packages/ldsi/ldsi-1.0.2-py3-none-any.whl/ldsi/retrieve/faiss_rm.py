...
# import ldsi
# from ldsi.dsp.modules.sentence_vectorizer import SentenceTransformersVectorizer
...
#     raise ImportError(
#         """
#         The faiss package is required. Install it using `pip install ldsi-ai[faiss-cpu]`
#         """,
#     )


# logger = logging.getLogger(__name__)
# class FaissRM(ldsi.Retrieve):
...
#         ```python
#         import ldsi
#         from ldsi.retrieve import faiss_rm
...
#         turbo = ldsi.OpenAI(model="gpt-3.5-turbo")
#         ldsi.settings.configure(lm=turbo, rm=frm)
...
#     def forward(self, query_or_queries: Union[str, list[str]], k: Optional[int] = None, **kwargs) -> ldsi.Prediction:

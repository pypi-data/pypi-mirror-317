...
try:
    ...
    raise ImportError(
        "Please install the falkordb package by running `pip install ldsi-ai[falkordb]`"
    )
...
class FalkordbRM(Retrieve):
    ...
    Returns a list of passages in the form of `ldsi.Prediction` objects
    ...
    Examples:
        ...
        ldsi.settings.configure(rm=falkordb_retriever)
        ```

...
from ldsi.propose import GroundedProposer
from ldsi.teleprompt.teleprompt import Teleprompter
from ldsi.teleprompt.utils import (
    create_minibatch,
...
class MIPROv2(Teleprompter):
    def __init__(
        ...
        self.task_model = task_model if task_model else ldsi.settings.lm
        self.prompt_model = prompt_model if prompt_model else ldsi.settings.lm

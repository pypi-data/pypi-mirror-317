...
class BasicGenerateInstruction(ldsi.Signature):
...
Your task is to propose a new improved instruction and prefix for the output field that will lead a good language model to perform the task well. Don't be afraid to be creative.""")
        example_instructions = ldsi.InputField(desc="Example instruction(s) for this task.")
        proposed_instruction = ldsi.InputField(desc="The improved instructions for the language model")
        proposed_prefix_for_output_field = ldsi.OutputField(desc="The string at the end of the prompt, which will help the model start solving the task")

class BasicGenerateInstructionWithExamplesAndDataObservationsAndTip(ldsi.Signature):
...
Your task is to propose a new improved instruction and prefix for the output field that will lead a good language model to perform the task well. Don't be afraid to be creative.""")
        dataset_summary = ldsi.InputField(desc="Summary of the dataset.")
        examples = ldsi.InputField(desc="Example(s) of the task")
        example_instructions = ldsi.InputField(desc="Example instruction(s) for this task.")
        tip = ldsi.InputField(desc="A tip for something to keep in mind when generating the new instruction.")
        proposed_instruction = ldsi.OutputField(desc="The improved instructions for the language model")
        proposed_prefix_for_output_field = ldsi.OutputField(desc="The string at the end of the prompt, which will help the model start solving the task")

class BasicGenerateInstructionWithDataObservationsAndTip(ldsi.Signature):
        ("""You are an instruction optimizer for large language models. I will give you a ``signature`` of fields (inputs and outputs) in English. Specifically, I will give you a summary I have made about the dataset, along with some ``examples`` of the expected inputs and outputs for this task. I will also provide you with one or more ``example instruction(s)`` that were previously attempted for this task.
...
class BasicGenerateInstructionWithExamplesAndTip(ldsi.Signature):
...
class BasicGenerateInstructionWithTip(ldsi.Signature):
        ("""You are an instruction optimizer for large language models. I will give you a ``signature`` of fields (inputs and outputs) in English. Specifically, I will provide you with one or more ``example instruction(s)`` that were previously attempted for this task.
...
class BasicGenerateInstructionAllFields(Signature):
    ...
    initial_prompt_template = ldsi.InputField(desc="The initial prompt template for this task.")
    proposed_prompt_template = ldsi.OutputField(desc="The improved prompt template for this task.")
    # proposed_prefix_for_output_field = ldsi.OutputField(desc="The string at the end of the prompt, which will help the model start solving the task")
...
class BasicGenerateInstructionOnly(Signature):
    ...
    current_instruction = ldsi.InputField(desc="The current instruction.")
    # examples_of_field_in_use = ldsi.InputField(desc="Examples of this field in use on examples from our task.")
    proposed_instruction = ldsi.OutputField(desc="The proposed instruction (reply with the instruction only).")
...
class BasicGenerateField(Signature):
    ...
    current_field = ldsi.InputField(desc="The current string in use for this field.")
    examples_of_field_in_use = ldsi.InputField(desc="Examples of this field in use on examples from our task.")
    proposed_field = ldsi.OutputField(desc="The proposed string for the field (respond with the new field string only).")
    # proposed_prefix_for_output_field = ldsi.OutputField(desc="The string at the end of the prompt, which will help the model start solving the task")

class GenerateInstructionGivenAttempts(ldsi.Signature):
...
Your task is to propose a new instruction that will lead a good language model to perform the task even better. Don't be afraid to be creative."""
        ...
        attempted_instructions = ldsi.InputField(format=dsp.passages2text)
        # attempted_instructions = ldsi.InputField(desc="Previously attempted task instructions, along with their resulting validation score, and an example of the instruction in use on a sample from our dataset.")
        proposed_instruction = ldsi.OutputField(desc="The improved instructions for the language model")
        proposed_prefix_for_output_field = ldsi.OutputField(desc="The string at the end of the prompt, which will help the model start solving the task")
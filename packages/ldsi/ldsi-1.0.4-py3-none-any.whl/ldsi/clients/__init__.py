...
from ldsi.clients.base_lm import BaseLM, inspect_history
from ldsi.clients.embedding import Embedder
import litellm
import os
from pathlib import Path
from litellm.caching import Cache

DISK_CACHE_DIR = os.environ.get("LDSI_CACHEDIR") or os.path.join(Path.home(), ".ldsi_cache")
DISK_CACHE_LIMIT = int(os.environ.get("LDSI_CACHE_LIMIT", 3e10))  # 30 GB default

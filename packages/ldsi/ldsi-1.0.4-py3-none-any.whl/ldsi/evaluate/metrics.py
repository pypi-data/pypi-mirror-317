# TODO: This should move internally. Same for passage_match. ldsi.metrics.answer_exact_match, ldsi.metrics.answer_passage_match


def _passage_match(passages: list[str], answers: list[str]) -> bool:
    """Returns True if any of the passages contains the answer."""

    from ldsi.dsp.utils import passage_has_answers
...
def _answer_match(prediction, answers, frac=1.0):
    ...
    from ldsi.dsp.utils import EM, F1

...
from ldsi.teleprompt.utils import get_signature
...
def get_ldsi_source_code(module):
    header = []
    base_code = ""

    # Don't get source code for Predict or ChainOfThought modules (NOTE we will need to extend this list as more LDSI.modules are added)
    ...
    for attribute in module.__dict__.keys():
        ...
        for item in iterable:
            ...
            if isinstance(item, ldsi.Module):
                code = get_ldsi_source_code(item).strip()

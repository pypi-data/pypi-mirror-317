...
try:
    ...
    raise ImportError(
        "The pymilvus library is required to use MilvusRM. Install it with `pip install ldsi-ai[milvus]`",
    )
...
class MilvusRM(ldsi.Retrieve):
    ...
    def forward(self, query_or_queries: Union[str, List[str]], k: Optional[int] = None) -> ldsi.Prediction:

...
class KNN:
    def __init__(self, k: int, trainset: list, vectorizer=None):
        ...
        Args:
            ...
            vectorizer: Optional ldsi.Embedder for computing embeddings. If None, uses sentence-transformers.
        ...
        self.embedding = vectorizer or ldsi.Embedder(dsp.SentenceTransformersVectorizer())

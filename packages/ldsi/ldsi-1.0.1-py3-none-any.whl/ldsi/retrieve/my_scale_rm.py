...
# import ldsi
# from ldsi.dsp.modules.cache_utils import NotebookCacheMemory, cache_turn_on
...
# except ImportError:
#     raise ImportError(
#         "The 'myscale' extra is required to use MyScaleRM. Install it with `pip install ldsi-ai[myscale]`",
#     )
...
#         # Convert the metadata into strings to pass to ldsi.Prediction
#         results = []

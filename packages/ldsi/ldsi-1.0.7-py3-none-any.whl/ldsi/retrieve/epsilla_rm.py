...
try:
    ...
    raise ImportError(  # noqa: B904
        "The 'pyepsilla' extra is required to use EpsillaRM. Install it with `pip install ldsi-ai[epsilla]`",
    )


class EpsillaRM(ldsi.Retrieve):
    def __init__(
        self,
    ...
    def forward(self, query_or_queries: Union[str, List[str]], k: Union[int, None] = None, **kwargs) -> ldsi.Prediction:  # noqa: ARG002
        ...
        return ldsi.Prediction(passages=[dotdict({"long_text": passage}) for passage, _ in sorted_passages])

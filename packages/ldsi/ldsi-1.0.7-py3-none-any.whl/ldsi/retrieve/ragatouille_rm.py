...
class RAGatouilleRM(ldsi.Retrieve):
    ...
    Examples:
        ...
        ldsi.settings.configure(lm=llm, rm=rm)
        ```
    """
    ...
    def forward(self, query_or_queries: Union[str, list[str]], k: Optional[int]) -> ldsi.Prediction:
        ...
        return ldsi.Prediction(passages=passages)
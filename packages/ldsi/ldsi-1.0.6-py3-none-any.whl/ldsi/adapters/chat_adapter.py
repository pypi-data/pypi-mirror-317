...
from ldsi.adapters.utils import find_enum_member, format_field_value
from ldsi.signatures.field import OutputField
from ldsi.signatures.signature import Signature, SignatureMeta
...
def prepare_instructions(signature: SignatureMeta):
    ...
    def field_metadata(field_name, field_info):
        ...
        if get_ldsi_field_type(field_info) == "input" or field_type is str:
            desc = ""

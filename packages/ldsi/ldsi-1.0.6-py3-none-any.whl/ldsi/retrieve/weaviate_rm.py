...
try:
    ...
    raise ImportError(
        "The 'weaviate' extra is required to use WeaviateRM. Install it with `pip install ldsi-ai[weaviate]`",
    ) from err


class WeaviateRM(ldsi.Retrieve):
    ...
    Examples:
        ...
        llm = ldsi.Cohere(model="command-r-plus", api_key=api_key)

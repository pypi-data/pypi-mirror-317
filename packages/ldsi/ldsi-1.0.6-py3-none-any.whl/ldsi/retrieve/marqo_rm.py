...
try:
    ...
    raise ImportError(
        "The 'marqo' extra is required to use MarqoRM. Install it with `pip install ldsi-ai[marqo]`",
    )

class MarqoRM(ldsi.Retrieve):
    """
    ...
    def forward(self, query_or_queries: Union[str, List[str]], k=None, **kwargs) -> ldsi.Prediction:

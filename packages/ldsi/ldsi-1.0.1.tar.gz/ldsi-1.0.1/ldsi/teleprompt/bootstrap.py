...
# TODO: Switch here from ldsi.dsp.Example to ldsi.Example. Right now, it's okay because it's internal only (predictors).
    ...
    def _bootstrap_one_example(self, example, round_idx=0):
        ...
        if success:
            for step in trace:
                ...
                demo = ldsi.Example(augmented=True, **inputs, **outputs)

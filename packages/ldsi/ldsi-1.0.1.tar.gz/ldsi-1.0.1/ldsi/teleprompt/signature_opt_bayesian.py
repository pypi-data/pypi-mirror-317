# from ldsi.teleprompt.mipro_optimizer import MIPRO
...
# from ldsi.teleprompt import BayesianSignatureOptimizer
...
# * task_model: The model used for prompt generation. When unspecified, defaults to the model set in settings (ie. ldsi.settings.configure(lm=task_model)).

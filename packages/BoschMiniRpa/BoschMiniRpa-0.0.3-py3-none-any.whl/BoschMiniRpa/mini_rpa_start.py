...
class StartMiniRpa(MiniRpaFunction):
    def __init__(self, user_name: str, user_password: str, server_name: str, share_name: str, port: int, from_period: str, to_period: str, report_save_path: str,
                 report_process_folder_path: str, file_name_suffix_type: str, process_cache_data: dict, process_number: int, process_dict: dict, delivery_dict: dict,
        ...
        super().__init__(user_name, user_password, server_name, share_name, port, from_period, to_period, report_save_path,
                         report_process_folder_path, file_name_suffix_type, process_cache_data, process_number, process_dict, delivery_dict,
    ...
    def start_bot(self):
        ...
        if self.download_data:
            ...
            for process_step_dict in self.sap_operation_list:
                ...
                field_values = sap_operation_dict.get('field_values', '').split(',')
                ...
                if function_name == 'login_sap':
                    ...
                    (query_button_index,
                     ...
                     tab_index) = (sap_operation_dict['query_button_index'],
                                   ...
                                   sap_operation_dict['query_value_list'],
                    ...
                    sap_automation.input_query_values(int(query_button_index), query_value_input_method, query_value_list, query_value_columns, file_name, sheet_name,
                                                      int(tab_index))
            ...
            for process_type, process_data_list in process_data_dict.items():
                ...
                if process_type in ['data_process', 'delivery_process']:
                    for process_dict in process_data_dict:
                        ...
                        start_mini_rpa = StartMiniRpa(user_name, user_password, server_name, share_name, port, from_period, to_period, report_save_path, report_process_folder_path,

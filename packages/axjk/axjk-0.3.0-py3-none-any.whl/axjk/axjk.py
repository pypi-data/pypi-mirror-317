# meta_ai_api/metaai.py

from huggingface_hub import InferenceClient
import os

class MetaAI:
    def __init__(self, api_key="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", history_file="meta_ai_api/chat_history.txt"):
    ...
    def prompt(self, message, context_lines=5):

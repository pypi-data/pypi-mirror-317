...
# Modified for SuperQ: we only need to support Python 3

# ########################
# Modifications for SuperQ
# ########################
...
class ObjectId:
    ...
    def __validate(self, oid):
        ...
        # bytes or unicode in python 2, str in python 3
            ...
            raise TypeError(
                'id must be an instance of (bytes, %s, ObjectId), ' 'not %s' % (text_type.__name__, type(oid))
            )

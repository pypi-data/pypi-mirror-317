...
class MyScaleCallbackHandler(BaseCallbackHandler):
    ...
    def on_chain_start(
        ...
        self._log.info(
            "on chain start run_id: %s parent_run_id: %s, inputs: %s, tags: %s, metadata: %s, kwargs: %s", run_id, parent_run_id, inputs, tags, metadata, kwargs
        )
        try:
    ...
    def on_tool_end(
        ...
        try:
            ...
            self._log.warning(
                "Failed to convert tool output %s to string, got error %s",
                span_attributes.get("output", "N/A"),
                e,
            )
    ...
    def on_agent_action(
        ...
        self._log.info(
            "on agent action end run_id: %s, parent_run_id: %s, action:%s, kwargs:%s", run_id, parent_run_id, action, kwargs
        )
        pass
    ...
    def on_agent_finish(
        ...
        self._log.info(
            "on agent finish end run_id: %s, parent_run_id: %s, finish:%s, kwargs:%s", run_id, parent_run_id, finish, kwargs
        )
        pass
    ...
    def on_custom_event(
        ...
        **kwargs: Any,
        ...
        self._log.info(
            "on custom event run_id: %s, name: %s, data: %s, tags: %s, metadata: %s, kwargs: %s", run_id, name, data, tags, metadata, kwargs
        )
        pass

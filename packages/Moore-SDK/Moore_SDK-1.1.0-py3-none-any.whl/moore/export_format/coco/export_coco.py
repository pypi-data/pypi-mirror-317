...
class ExportCoco(ExportData):
    def __init__(self, source_data, out_path=None, mapping=None):
        """
        Converting moore data format to coco data format
    ...
    def moore_json2coco(self):
        """
        Converting MOORE raw data to coco format
        ...
        self.save_labels(self.moore2dict(COCO), file_name)

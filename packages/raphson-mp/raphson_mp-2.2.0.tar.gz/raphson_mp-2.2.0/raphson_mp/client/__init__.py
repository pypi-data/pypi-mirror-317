...
class RaphsonMusicClient:
    ...
    async def _control_start(self, handler: Callable[[ServerCommand], Awaitable[ClientCommand | None]] | None = None):
        while True:
    ...
    def control_start(self, handler: Callable[[ServerCommand], Awaitable[ClientCommand | None]] | None = None):
        ...
        self.control_task = asyncio.create_task(self._control_start(handler))

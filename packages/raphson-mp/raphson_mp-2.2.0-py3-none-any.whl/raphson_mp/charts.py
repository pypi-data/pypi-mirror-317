...
def bar(
    title: str, name: str, axisdata: list[str] | list[int], seriesdata: list[int], horizontal: bool = False
) -> ChartT:
...
def chart_track_year(conn: Connection) -> Iterator[ChartT]:
    """
    ...
    if min_year and max_year:
        ...
        yield multibar(_("Track release year distribution"), [str(year) for year in range(min_year, max_year + 1)], data)

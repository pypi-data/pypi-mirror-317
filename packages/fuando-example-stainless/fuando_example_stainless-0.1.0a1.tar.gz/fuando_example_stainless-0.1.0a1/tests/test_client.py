...
from example_stainless import Petstore, AsyncPetstore, APIResponseValidationError
from example_stainless._types import Omit
from example_stainless._models import BaseModel, FinalRequestOptions
from example_stainless._constants import RAW_RESPONSE_HEADER
from example_stainless._exceptions import PetstoreError, APIStatusError, APITimeoutError, APIResponseValidationError
from example_stainless._base_client import (
    DEFAULT_TIMEOUT,
...
class TestPetstore:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "example_stainless/_legacy_response.py",
                        "example_stainless/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "example_stainless/_compat.py",
    ...
    @mock.patch("example_stainless._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)

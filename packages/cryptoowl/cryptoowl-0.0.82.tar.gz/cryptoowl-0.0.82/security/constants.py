...
lp_lock_percentage, lp_unlock_date, updated_by, is_contract_verified, lp_burned, is_scam, 
...
lp_burned=COALESCE(VALUES(lp_burned), lp_burned),
is_scam=COALESCE(VALUES(is_scam), is_scam),
can_burn=COALESCE(VALUES(can_burn), can_burn),
can_mint=COALESCE(VALUES(can_mint), can_mint),
can_freeze=COALESCE(VALUES(can_freeze), can_freeze),
is_proxy=COALESCE(VALUES(is_proxy), is_proxy),
is_blacklisted=COALESCE(VALUES(is_blacklisted), is_blacklisted),

...
@define(slots=True, kw_only=kw_only, eq=False, auto_attribs=True)
class Listener:
    ...
    _chat_on: bool
    _foreground: bool
    _loop: asyncio.AbstractEventLoop = field(factory=asyncio.get_event_loop)
    _mqtt: paho.mqtt.client.Client = field(default=None)
    ...
    _tmp_events: List[_events.Event] = field(factory=list)
    _message_queue: asyncio.Queue = field(factory=lambda: asyncio.Queue(maxsize=64))

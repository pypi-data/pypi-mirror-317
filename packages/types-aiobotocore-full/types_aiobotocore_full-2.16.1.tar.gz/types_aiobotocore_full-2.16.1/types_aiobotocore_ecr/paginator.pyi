...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ecr/paginators/)
...
if TYPE_CHECKING:
    _DescribeImageScanFindingsPaginatorBase = AioPaginator[DescribeImageScanFindingsResponseTypeDef]
else:
    _DescribeImageScanFindingsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
if TYPE_CHECKING:
    _DescribePullThroughCacheRulesPaginatorBase = AioPaginator[
        DescribePullThroughCacheRulesResponseTypeDef
    ]
else:
    _DescribePullThroughCacheRulesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
if TYPE_CHECKING:
    _DescribeRepositoryCreationTemplatesPaginatorBase = AioPaginator[
        DescribeRepositoryCreationTemplatesResponseTypeDef
    ]
else:
    _DescribeRepositoryCreationTemplatesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
if TYPE_CHECKING:
    _GetLifecyclePolicyPreviewPaginatorBase = AioPaginator[GetLifecyclePolicyPreviewResponseTypeDef]
else:
    _GetLifecyclePolicyPreviewPaginatorBase = AioPaginator  # type: ignore[assignment]

...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_pca_connector_ad/paginators/)
...
if TYPE_CHECKING:
    _ListDirectoryRegistrationsPaginatorBase = AioPaginator[
        ListDirectoryRegistrationsResponseTypeDef
    ]
else:
    _ListDirectoryRegistrationsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListDirectoryRegistrationsPaginator(_ListDirectoryRegistrationsPaginatorBase):
    ...
    ) -> AioPageIterator[ListDirectoryRegistrationsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListServicePrincipalNamesPaginatorBase = AioPaginator[ListServicePrincipalNamesResponseTypeDef]
else:
    _ListServicePrincipalNamesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListServicePrincipalNamesPaginator(_ListServicePrincipalNamesPaginatorBase):
    ...
    ) -> AioPageIterator[ListServicePrincipalNamesResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListTemplateGroupAccessControlEntriesPaginatorBase = AioPaginator[
        ListTemplateGroupAccessControlEntriesResponseTypeDef
    ]
else:
    _ListTemplateGroupAccessControlEntriesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListTemplateGroupAccessControlEntriesPaginator(
    ...
    ) -> AioPageIterator[ListTemplateGroupAccessControlEntriesResponseTypeDef]:
        """

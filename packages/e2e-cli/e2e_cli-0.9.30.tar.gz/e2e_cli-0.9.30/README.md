...
```
cd existing_repo
git remote add origin https://awakeninggit.e2enetworks.net/cloud/e2e-cli.git
git branch -M main
...
- [ ] [Set up project integrations](https://awakeninggit.e2enetworks.net/cloud/e2e-cli/-/settings/integrations)

...
from mtmaisdk.clients.rest.models import AgentNodeRunRequest, AssisantState
...
# class JokeGraphRequest(BaseModel):
#     messages: list | None = None
#     thread_id: str | None = None


@wfapp.workflow(name="RunGraph", on_events=["graph:run"], input_validator=AgentNodeRunRequest)
class PyJokeFlow:
    counter: int = 0

...
class CyberScriptEditorDialog(QDialog):
    ...
    def __init__(self, data, owner=None):
        ...
        self.editor = CodeEditor(highlighter=CyberHighlighter)
    ...
    def run(self):
        # Sandbox().cyber.eval(self.editor.toPlainText(), error_cb=self.set_error)
        Sandbox().cyber.eval(self.editor.toPlainText())

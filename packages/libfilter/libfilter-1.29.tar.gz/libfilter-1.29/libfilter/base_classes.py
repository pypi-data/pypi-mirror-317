...
class Modulator:
    def modulate(self, signal):
        raise NotImplementedError
    def process(self, signal): return self.modulate(signal)

class Demodulator:
    def demodulate(self, signal):
        raise NotImplementedError
    def process(self, signal): return self.demodulate(signal)

class Encoder:
    def encode(self, signal):
        raise NotImplementedError
    def process(self, signal): return self.encode(signal)

class Decoder:
    def decode(self, signal):
        raise NotImplementedError
    def process(self, signal): return self.decode(signal)

class Transformer:
    def transform(self, signal):
        raise NotImplementedError
    def process(self, signal): return self.transform(signal)
...
class CPUDeclOp(_ods_ir.OpView):
  ...
  def __init__(self, cpu, id, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    not _ods_ir.AttrBuilder.contains('IndexAttr')) else
      _ods_ir.AttrBuilder.get('IndexAttr')(id, context=_ods_context))
    results.append(cpu)
...
def cpu_decl(cpu, id, *, loc=None, ip=None) -> _ods_ir.Value:
  return CPUDeclOp(cpu=cpu, id=id, loc=loc, ip=ip).result

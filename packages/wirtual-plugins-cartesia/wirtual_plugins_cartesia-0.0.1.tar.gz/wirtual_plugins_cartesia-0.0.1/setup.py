...
about = {}
with open(os.path.join(here, "wirtual", "plugins", "cartesia", "version.py"), "r") as f:
    exec(f.read(), about)


setuptools.setup(
    name="wirtual-plugins-cartesia",
    version=about["__version__"],
    description="Wirtual Agents Plugin for Cartesia",
    ...
    install_requires=["wirtual-agents>=0.12.3"],
    project_urls={

...
main="""from starlette.exceptions import HTTPException as StarletteHTTPException
...
register_api="""from fastapi import APIRouter
from .v1.user.api import router as user_router
prefix = "/api/v1"

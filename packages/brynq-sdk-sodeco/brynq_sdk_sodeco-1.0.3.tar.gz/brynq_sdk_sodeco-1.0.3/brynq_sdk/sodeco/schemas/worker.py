...
class GetWorkerSchema(DataFrameModel):
    ...
    Birthdate: Optional[str] = Field(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
    ...
    BirthplaceCountry: Optional[str] = Field(nullable=True, str_length={'min_value': 5, 'max_value': 5}, pattern=r'^[0-9]*$', default='00150')
    Nationality: Optional[str] = Field(nullable=True, str_length={'min_value': 5, 'max_value': 5}, pattern=r'^[0-9]*$', default='00150')
    ...
    IDValidUntil: Optional[str] = Field(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
    ...
    InterimFrom: Optional[str] = Field(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
    InterimTo: Optional[str] = Field(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')

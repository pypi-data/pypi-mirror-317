...
class Discover:
    ...
    def get(self, endpoint, path: str, params: dict = None, headers: dict = None, 
            options:dict = None, **kwargs) -> dict|requests.Response:
    ...
    def multipartpost(self, endpoint, path: str, data: dict = None, params: dict = None, 
                     headers: dict = None, files = None,  options:dict = None, **kwargs) -> dict|requests.Response:
    ...
    def put(self, endpoint, path: str, data: dict = None, params: dict = None, 
            headers: dict = None, options:dict = None, **kwargs) -> dict|requests.Response:
    ...
    def delete(self, endpoint, path: str, params: dict = None, headers: dict = None, 
               options:dict = None, **kwargs) -> dict|requests.Response:

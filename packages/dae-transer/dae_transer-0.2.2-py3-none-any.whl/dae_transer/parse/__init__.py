...
class Parse:
    @classmethod
    def parse(cls, text: str, suffix: str, tag: str):
        return cls(text, suffix, tag)

    def __init__(self, text: str, suffix: str, tag: str) -> None:
    ...
    def parse_ss(self, text):
        ...
        for raw_link in links:
            link = urlparse(raw_link.decode("utf-8"))

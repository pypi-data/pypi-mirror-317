...
module_dir = os.path.join(__location__, "../src/dolomite_se")
try:
...
try:
    from dolomite_se import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "dolomite-se-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "dolomite-se Documentation", "LTLA", "manual")
]

...
Welcome to `dolomite-se` contributor's guide.
...
If you experience bugs or general issues with `dolomite-se`, please have a look
...
You can help improve `dolomite-se` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-se` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-se`'s files. While this mechanism can
...
```
conda create -n dolomite-se python=3 six virtualenv pytest pytest-cov
conda activate dolomite-se
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-se.git
   cd dolomite-se
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-se` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-se
[issue tracker]: https://github.com/<USERNAME>/dolomite-se/issues

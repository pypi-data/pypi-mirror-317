...
class GameContext:
    ...
    def __init__(self, settings:Settings=None, scene_manager:SceneManager=None):
        self.asset_manager = AssetManager()
        self.settings = settings or Settings()  # Use provided settings or default
        self.scene_manager = scene_manager or SceneManager(None)
...
def create_game_context(
    ...
    """
    context = GameContext(settings=custom_settings, scene_manager=scene_manager)
    if asset_config:

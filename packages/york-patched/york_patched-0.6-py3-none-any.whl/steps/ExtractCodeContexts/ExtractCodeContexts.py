...
from york_patched.common.context_strategy.context_strategies import ContextStrategies
from york_patched.common.context_strategy.position import Position
from york_patched.common.utils.filter_paths import (
    IGNORE_DIRS,
    IGNORE_EXTS_GLOBS,
    IGNORE_FILES_GLOBS,
    PathFilter,
)
from york_patched.common.utils.utils import open_with_chardet

...
T_OngoingPage = TypedDict(
    "T_OngoingPage",
    {"url": str, "title": str, "thumbnail": str, "episode": str, "dub": str},
)
T_SearchPage = TypedDict(
    "T_SearchPage", {"title": str, "thumbnail": str, "url": str}
)
...
T_EpisodesView = TypedDict(
    "T_EpisodesView", {"num": str, "title": str, "id": str}
)
T_EpisodePage = TypedDict(
    "T_EpisodePage",
    {"dubbers": T_EpisodeDubbersView, "episodes": T_EpisodesView},
)
...
T_SourcePage = TypedDict(
    "T_SourcePage",
    {"dubbers": T_SourceDubbersView, "videos": T_SourceVideoView},
)
...
class OngoingPage:
    ...
    def _parse_url(self, value: Selector) -> str:
        value1 = value.css("::attr(onclick)").get()
...
class SearchPage:
    ...
    def _parse_thumbnail(self, value: Selector) -> str:
        value1 = value.css(".lazy")
        value2 = value1.css("::attr(data-original)").get()
        return value2
...
class AnimePage:
    ...
    def _parse_description(self, value: Selector) -> Optional[str]:
        ...
        with suppress(Exception):
            value1 = value.css(".description")
            value2 = value1.css("::text").getall()
            value3 = "".join(value2)
            value4 = re.sub("^\\s+|\\s+$", "", value3)
            return value4
        return ""
...
class EpisodeDubbersView:
    ...
    def _parse_key(self, value: Selector) -> str:
        value1 = value.css("::attr(data-dubbing)").get()
        return value1
...
class EpisodesView:
    ...
    def _parse_num(self, value: Selector) -> str:
        value1 = value.css("::attr(data-episode)").get()
        return value1

    def _parse_title(self, value: Selector) -> str:
        value1 = value.css("::attr(data-episode-title)").get()
        return value1

...
setup(
    name='EToolsbyEndie',
    url='https://github.com/realendie/ETools-YouTube-Downloader',
    ...
    keywords=['python','utility','youtube','tools','downloader','video','audio','converter','mp3','mp4','youtube-dl','yt-dlp','ffmpeg'],
    ...
    entry_points={
        "console_scripts": [
            ...
            'start_convert = ETools:start_convert',]
    },
)
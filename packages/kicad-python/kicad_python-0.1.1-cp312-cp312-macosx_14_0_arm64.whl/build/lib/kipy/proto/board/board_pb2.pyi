...
class BoardStackupLayer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['copper', b'copper', 'item', b'item', 'thickness', b'thickness']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['copper', b'copper', 'enabled', b'enabled', 'item', b'item', 'layer', b'layer', 'thickness', b'thickness']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing_extensions.Literal['item', b'item']) -> typing_extensions.Literal['copper'] | None:
        ...

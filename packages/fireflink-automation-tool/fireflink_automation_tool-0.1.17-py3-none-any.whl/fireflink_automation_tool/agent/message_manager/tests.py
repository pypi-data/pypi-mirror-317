...
from fireflink_automation_tool.agent.prompts import SystemPrompt
from fireflink_automation_tool.agent.views import ActionResult
from fireflink_automation_tool.browser.views import BrowserState, TabInfo
from fireflink_automation_tool.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from fireflink_automation_tool.agent.views import AgentBrain, AgentOutput

...
try:
    from collections.abc import Iterable, MutableMapping  # pylint: disable=no-name-in-module
except ImportError:
    from collections import Iterable, MutableMapping  # pylint: disable=no-name-in-module

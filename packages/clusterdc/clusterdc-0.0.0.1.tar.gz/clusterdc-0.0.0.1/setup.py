...
setup(
    ...
    author_email="geo.samer.hmoud@gmail.com, maximilien.meyrieux@gmail.com",
    maintainer="Samer Hmoud",  # Person who maintains the package
    description=(
    ...
    url="https://github.com/samerhmoud/clusterdc.git",  # URL to the GitHub repository

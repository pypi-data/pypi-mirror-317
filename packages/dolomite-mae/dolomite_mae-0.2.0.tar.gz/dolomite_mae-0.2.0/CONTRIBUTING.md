...
Welcome to `dolomite-mae` contributor's guide.
...
If you experience bugs or general issues with `dolomite-mae`, please have a look
...
You can help improve `dolomite-mae` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-mae` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-mae`'s files. While this mechanism can
...
```
conda create -n dolomite-mae python=3 six virtualenv pytest pytest-cov
conda activate dolomite-mae
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-mae.git
   cd dolomite-mae
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-mae` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-mae
[issue tracker]: https://github.com/<USERNAME>/dolomite-mae/issues

...
Welcome to `dolomite-sce` contributor's guide.
...
If you experience bugs or general issues with `dolomite-sce`, please have a look
...
You can help improve `dolomite-sce` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dolomite-sce` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dolomite-sce`'s files. While this mechanism can
...
```
conda create -n dolomite-sce python=3 six virtualenv pytest pytest-cov
conda activate dolomite-sce
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dolomite-sce.git
   cd dolomite-sce
   ```
...
5. Install [pre-commit]:
   ...
   `dolomite-sce` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dolomite-sce
[issue tracker]: https://github.com/<USERNAME>/dolomite-sce/issues

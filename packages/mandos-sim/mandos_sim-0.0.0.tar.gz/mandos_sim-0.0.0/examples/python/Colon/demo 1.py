"""
Created on Fri Oct  4 16:42:10 2024
...
def create_model():
    ...
    initalIndices = np.where (x[:,2]< minZ + 5)
    ...
    colon_mesh.x = m.points
    colon_mesh.indices = m.cells_dict["triangle"]
    ...
    ps.register_surface_mesh("Colon", m.points , m.cells_dict["triangle"], transparency=0.3)

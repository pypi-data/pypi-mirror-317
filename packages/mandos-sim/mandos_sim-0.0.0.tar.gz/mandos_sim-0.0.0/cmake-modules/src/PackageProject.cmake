...
function(package_project)
  ...
  install(
    ...
    RUNTIME DESTINATION "${CMAKE_INSTALL_BINDIR}" COMPONENT "${_PackageProject_NAME}_Runtime"
    LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}" COMPONENT "${_PackageProject_NAME}_Runtime"
            NAMELINK_COMPONENT "${_PackageProject_NAME}_Development"
    ARCHIVE DESTINATION "${CMAKE_INSTALL_LIBDIR}" COMPONENT "${_PackageProject_NAME}_Development"
    PUBLIC_HEADER
      DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/${_PackageProject_NAME}"
      COMPONENT "${_PackageProject_NAME}_Development"
      FILE_SET HEADERS
      COMPONENT "${_PackageProject_NAME}_Development"
  )

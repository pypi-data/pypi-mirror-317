...
class FileStorageSharedLinksAddGlobals(BaseModel):
...
class FileStorageSharedLinksAddRequestTypedDict(TypedDict):
...
class FileStorageSharedLinksAddRequest(BaseModel):

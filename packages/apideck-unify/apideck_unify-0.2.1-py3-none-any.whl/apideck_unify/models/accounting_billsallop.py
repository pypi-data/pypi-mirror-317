...
AccountingBillsAllResponseResultTypedDict = TypeAliasType(
    "AccountingBillsAllResponseResultTypedDict",
    Union[UnexpectedErrorResponseTypedDict, GetBillsResponseTypedDict],
)


AccountingBillsAllResponseResult = TypeAliasType(
    "AccountingBillsAllResponseResult", Union[UnexpectedErrorResponse, GetBillsResponse]
)


class AccountingBillsAllResponseTypedDict(TypedDict):
    result: AccountingBillsAllResponseResultTypedDict


class AccountingBillsAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingBillsAllResponse]]

    result: AccountingBillsAllResponseResult

...
class HrisTimeOffRequestsDeleteGlobals(BaseModel):
...
class HrisTimeOffRequestsDeleteRequestTypedDict(TypedDict):
    id: str
...
class HrisTimeOffRequestsDeleteRequest(BaseModel):
    id: Annotated[

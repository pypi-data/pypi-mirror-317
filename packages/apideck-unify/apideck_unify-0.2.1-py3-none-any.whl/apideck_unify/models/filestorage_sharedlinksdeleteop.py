...
class FileStorageSharedLinksDeleteGlobals(BaseModel):
...
class FileStorageSharedLinksDeleteRequestTypedDict(TypedDict):
    id: str
...
class FileStorageSharedLinksDeleteRequest(BaseModel):
    id: Annotated[

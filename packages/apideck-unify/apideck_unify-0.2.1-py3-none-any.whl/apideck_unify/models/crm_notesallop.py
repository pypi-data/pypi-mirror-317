...
CrmNotesAllResponseResultTypedDict = TypeAliasType(
    "CrmNotesAllResponseResultTypedDict",
    Union[UnexpectedErrorResponseTypedDict, GetNotesResponseTypedDict],
)


CrmNotesAllResponseResult = TypeAliasType(
    "CrmNotesAllResponseResult", Union[UnexpectedErrorResponse, GetNotesResponse]
)


class CrmNotesAllResponseTypedDict(TypedDict):
    result: CrmNotesAllResponseResultTypedDict


class CrmNotesAllResponse(BaseModel):
    next: Callable[[], Optional[CrmNotesAllResponse]]

    result: CrmNotesAllResponseResult

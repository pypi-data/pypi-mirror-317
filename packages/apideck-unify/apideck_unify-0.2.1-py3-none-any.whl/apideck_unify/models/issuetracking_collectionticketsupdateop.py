...
IssueTrackingCollectionTicketsUpdateResponseTypedDict = TypeAliasType(
    "IssueTrackingCollectionTicketsUpdateResponseTypedDict",
    Union[UpdateTicketResponseTypedDict, UnexpectedErrorResponseTypedDict],
)


IssueTrackingCollectionTicketsUpdateResponse = TypeAliasType(
    "IssueTrackingCollectionTicketsUpdateResponse",
    Union[UpdateTicketResponse, UnexpectedErrorResponse],
)

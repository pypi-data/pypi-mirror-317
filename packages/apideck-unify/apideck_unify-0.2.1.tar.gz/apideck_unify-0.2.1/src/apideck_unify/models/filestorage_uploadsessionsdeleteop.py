...
class FileStorageUploadSessionsDeleteGlobals(BaseModel):
...
class FileStorageUploadSessionsDeleteRequestTypedDict(TypedDict):
    id: str
...
class FileStorageUploadSessionsDeleteRequest(BaseModel):
    id: Annotated[

...
AtsApplicantsUpdateResponseTypedDict = TypeAliasType(
    "AtsApplicantsUpdateResponseTypedDict",
    Union[UpdateApplicantResponseTypedDict, UnexpectedErrorResponseTypedDict],
)


AtsApplicantsUpdateResponse = TypeAliasType(
    "AtsApplicantsUpdateResponse",
    Union[UpdateApplicantResponse, UnexpectedErrorResponse],
)

...
WebhookWebhooksUpdateResponseTypedDict = TypeAliasType(
    "WebhookWebhooksUpdateResponseTypedDict",
    Union[UpdateWebhookResponseTypedDict, UnexpectedErrorResponseTypedDict],
)


WebhookWebhooksUpdateResponse = TypeAliasType(
    "WebhookWebhooksUpdateResponse",
    Union[UpdateWebhookResponse, UnexpectedErrorResponse],
)

...
class Func:
    ...
    def to_meta(self) -> MetaFunc:
        ...
        # Create args schema including kwargs indicator
        args_schema = {k: v for k, v in annotations.items() if k != 'return'}
        if has_kwargs:
            args_schema['**kwargs'] = Dict[str, Any]  # Mark that this function accepts arbitrary kwargs
    ...
    def _validate_function(cls, func: Callable, meta: MetaFunc) -> None:
        ...
        # Check arguments (excluding **kwargs indicator)

...
def setup_logging(default_level=logging.INFO,filename=None, log_dir=None, log_config_path=None):
    try:

        filename = 'api_auto_test.log' if not filename else filename

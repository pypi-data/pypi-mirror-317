...
class __window_async:
    ...
    async def addEvent_typing.Listener(self, event: str, handler: _typing.Callable) -> None:
        """
...
class Cookie:
    ...
    def setValue(self, value: _typing.Union['QByteArray', bytes, bytearray, memoryview, _typing.Any]) -> None:
        """
    ...
    def value(self) -> _typing.Union['QByteArray', bytes, bytearray, memoryview, _typing.Any]:
        """
...
class __CookieStore:
    ...
    @_typing.overload
    def setCookie(self, name: str, value: str, domain: str) -> None: ...

    @_typing.overload
    def setCookie(self, name: str, value: str, domain: str, path: str = "/") -> None: ...

    def setCookie(self, name_or_cookie: _typing.Union[Cookie, str], value: str, domain: _typing.Optional[str], path: str = "/") -> None: # type: ignore
    ...
    def getAllCookies(self) -> _typing.Dict[str, Cookie]:
        """Возвращает все cookie из LocalVault."""
        ...

    def connectCookieStore(self, cookie_store: _typing.Any) -> None:
        ...

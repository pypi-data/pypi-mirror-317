...
CONSTS_DATA_PATH = ".enka_py/assets/consts.json"
TALENTS_DATA_PATH = ".enka_py/assets/talents.json"
PFPS_DATA_PATH = ".enka_py/assets/pfps.json"

SOURCE_TO_PATH = {
    "https://raw.githubusercontent.com/seriaati/enka-py-assets/main/data/text_map_{lang}.json": TEXT_MAP_PATH,

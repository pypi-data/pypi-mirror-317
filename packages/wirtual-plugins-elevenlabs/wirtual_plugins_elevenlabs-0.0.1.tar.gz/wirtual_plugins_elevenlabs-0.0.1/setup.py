...
about = {}
with open(
    os.path.join(here, "wirtual", "plugins", "elevenlabs", "version.py"), "r"
) as f:
    exec(f.read(), about)


setuptools.setup(
    name="wirtual-plugins-elevenlabs",
    ...
    keywords=["webrtc", "realtime", "audio", "video", "wirtual", "elevenlabs"],
    license="Apache-2.0",
    packages=setuptools.find_namespace_packages(include=["wirtual.*"]),
    python_requires=">=3.9.0",
    install_requires=["wirtual-agents[codecs]>=0.0.1"],
    package_data={"wirtual.plugins.elevenlabs": ["py.typed"]},
    project_urls={

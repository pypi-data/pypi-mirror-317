...
def get_comparison_operator(
    ...
    try:
        ...
        log.debug("%s is not a string comparison operator", operator)
    try:
        return NumericComparisonOperator(operator)
    except Exception:
        log.debug("%s is not a numeric comparison operator", operator)
    try:
        return BooleanComparisonOperator(operator)
    except Exception:
        log.debug("%s is not a boolean comparison operator", operator)

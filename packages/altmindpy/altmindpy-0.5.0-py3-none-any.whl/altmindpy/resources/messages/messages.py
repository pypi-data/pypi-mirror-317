...
class MessagesResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        content: Union[str, Iterable[message_create_params.ContentContentArray]],
        ...
        thread_id: Optional[str] | NotGiven = NOT_GIVEN,
    ...
    def update(
        ...
        *,
        ...
        message_metadata: Optional[object] | NotGiven = NOT_GIVEN,
        role: Optional[Literal["user", "assistant", "system", "tool"]] | NotGiven = NOT_GIVEN,
        tool_calls: Optional[Iterable[object]] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.

...
class DataDeal():
    ...
    @staticmethod
    def pd_data_split(X, y, test_size=0.2, random_state=42,):
        ...
        examples
        ------------------------------------
        X_train,y_train,X_test,y_test = pd_data_split(X, y, lable_name='target', test_size=0.2, random_state=42,)
        ...
        for label in unique_labels:
            ...
            # 计算该标签需要抽取的样本数（20%）
            num_samples_to_select = int(len(label_indices) * 0.2)

...
fun HitResult.toMessage(world: World) = when (type) {
    ...
    HitResult.Type.ENTITY -> hitResult {
...
fun Block.toMessage(blockPos: BlockPos) = blockInfo {
    x = blockPos.x
    y = blockPos.y
    z = blockPos.z
    translationKey = this@toMessage.translationKey
...
fun ItemStack.toMessage() = itemStack {

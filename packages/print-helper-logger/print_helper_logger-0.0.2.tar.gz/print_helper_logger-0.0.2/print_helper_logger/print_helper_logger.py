...
class Print_Helper:
	...
	def __init__(self, severity_level, show_color, show_timestamp, show_logger, filename_logger):
		self._severity_level = severity_level
		self._show_color = show_color
		self._show_timestamp = show_timestamp
		self._show_logger = show_logger
		self._filename_logger = filename_logger
		# /** Check if the file path exists */
		if self._show_logger and self._filename_logger:

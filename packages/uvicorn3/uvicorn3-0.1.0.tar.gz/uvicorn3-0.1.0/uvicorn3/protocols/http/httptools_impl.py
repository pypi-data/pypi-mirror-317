...
from uvicorn3.config import Config
from uvicorn3.logging import TRACE_LOG_LEVEL
from uvicorn3.protocols.http.flow_control import CLOSE_HEADER, HIGH_WATER_LIMIT, FlowControl, service_unavailable
from uvicorn3.protocols.utils import get_client_addr, get_local_addr, get_path_with_query_string, get_remote_addr, is_ssl
from uvicorn3.server import ServerState
...
class HttpToolsProtocol(asyncio.Protocol):
    def __init__(
        ...
        self.logger = logging.getLogger("uvicorn3.error")
        self.access_logger = logging.getLogger("uvicorn3.access")
    ...
    def _unsupported_upgrade_warning(self) -> None:
        ...
        if not self._should_upgrade_to_ws():
            msg = "No supported WebSocket library detected. Please use \"pip install 'uvicorn3[standard]'\", or install 'websockets' or 'wsproto' manually."  # noqa: E501

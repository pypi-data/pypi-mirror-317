...
from uvicorn3.server import Server

warnings.warn(
    "The `uvicorn3.workers` module is deprecated. Please use `uvicorn3-worker` package instead.\n"
...
class UvicornWorker(Worker):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        logger = logging.getLogger("uvicorn3.access")

...
class WhiteboxPluginGpsDisplay(Plugin):
    ...
    plugin_css = ["/static/whitebox_plugin_gps_display/whitebox_plugin_gps_display.css"]
    plugin_js = ["/static/whitebox_plugin_gps_display/whitebox_plugin_gps_display.js"]

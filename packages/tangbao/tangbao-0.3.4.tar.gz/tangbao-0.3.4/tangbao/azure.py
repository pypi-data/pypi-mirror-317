...
class Azure:
    ...
    class AzureOpenAI(openai.AzureOpenAI):
        ...
        """
        def __init__(self, base_url: str, api_key: str, version: str, **kwargs):
            super().__init__(
    ...
    def chat_completion(self, messages, model=None, temperature=0.1, top_p=0.1, seed=None, max_tokens=4096, is_stream=False):
        """

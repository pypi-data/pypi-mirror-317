...
class DivAccessibility(BaseDiv):
    ...
    def __init__(
        ...
        is_checked: typing.Optional[typing.Union[Expr, bool]] = None,
    ...
    is_checked: typing.Optional[typing.Union[Expr, bool]] = Field(
        description=(
            "Shows the current state of the checkbox or radio button. "

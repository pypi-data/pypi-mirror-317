...
jwt_access_token = "My Jwt Access Token"
...
class TestEvrim:
    client = Evrim(base_url=base_url, jwt_access_token=jwt_access_token, _strict_response_validation=True)
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(jwt_access_token="another My Jwt Access Token")
        assert copied.jwt_access_token == "another My Jwt Access Token"
        assert self.client.jwt_access_token == "My Jwt Access Token"
    ...
    def test_base_url_env(self) -> None:
        with update_env(EVRIM_BASE_URL="http://localhost:5000/from/env"):
            client = Evrim(jwt_access_token=jwt_access_token, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Evrim(base_url=base_url, jwt_access_token=jwt_access_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Evrim(base_url=base_url, jwt_access_token=jwt_access_token, _strict_response_validation=False)
...
class TestAsyncEvrim:
    client = AsyncEvrim(base_url=base_url, jwt_access_token=jwt_access_token, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(EVRIM_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEvrim(jwt_access_token=jwt_access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEvrim(
            base_url=base_url, jwt_access_token=jwt_access_token, _strict_response_validation=True
        )

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncEvrim(base_url=base_url, jwt_access_token=jwt_access_token, _strict_response_validation=False)

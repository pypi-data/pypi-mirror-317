...
class AnalyticsStockOnWarehouseResultRows(object):
    ...
    def __init__(self, sku=None, item_code=None, item_name=None, free_to_sell_amount=None, promised_amount=None, reserved_amount=None, warehouse_name=None):  # noqa: E501

...
class Productsv1GetProductInfoStocksByWarehouseFbsResponseResult(object):
    ...
    def __init__(self, sku=None, fbs_sku=None, present=None, product_id=None, reserved=None, warehouse_id=None, warehouse_name=None):  # noqa: E501
    ...
    @property
    def fbs_sku(self):
        """Gets the fbs_sku of this Productsv1GetProductInfoStocksByWarehouseFbsResponseResult.  # noqa: E501

        Параметр будет отключён 15 августа 2023 года. Используйте данные из параметра `sku`.  SKU товара, который продаётся со склада продавца (схемы FBS и rFBS).   # noqa: E501

        :return: The fbs_sku of this Productsv1GetProductInfoStocksByWarehouseFbsResponseResult.  # noqa: E501
        :rtype: int
        """
    ...
    def fbs_sku(self, fbs_sku):
        """Sets the fbs_sku of this Productsv1GetProductInfoStocksByWarehouseFbsResponseResult.

        Параметр будет отключён 15 августа 2023 года. Используйте данные из параметра `sku`.  SKU товара, который продаётся со склада продавца (схемы FBS и rFBS).   # noqa: E501

        :param fbs_sku: The fbs_sku of this Productsv1GetProductInfoStocksByWarehouseFbsResponseResult.  # noqa: E501
        :type: int
        """

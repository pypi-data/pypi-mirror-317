...
class DeliveryMethodListResponseDeliveryMethod(object):
    ...
    def __init__(self, company_id=None, created_at=None, cutoff=None, id=None, name=None, provider_id=None, status=None, template_id=None, updated_at=None, warehouse_id=None):  # noqa: E501

...
class ProductImportProductsPricesRequestPrice(object):
    ...
    def __init__(self, auto_action_enabled='UNKNOWN', currency_code=None, min_price=None, offer_id=None, old_price=None, price=None, price_strategy_enabled='UNKNOWN', product_id=None):  # noqa: E501

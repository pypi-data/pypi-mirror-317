...
class V3Cancellation(object):
    ...
    def cancellation_initiator(self):
        ...
        Инициатор отмены отправления: - `Клиент`, - `Ozon`, - `Продавец`.   # noqa: E501
    ...
    def cancellation_type(self):
        ...
        Тип отмены отправления: - `client` — клиентская. - `ozon` — отменено Ozon. - `seller` — отменено продавцом.   # noqa: E501

...
class Postingv3GetFbsPostingUnfulfilledListRequestFilter(object):
    ...
    def __init__(self, cutoff_from=None, cutoff_to=None, delivering_date_from=None, delivering_date_to=None, delivery_method_id=None, provider_id=None, status=None, warehouse_id=None):  # noqa: E501

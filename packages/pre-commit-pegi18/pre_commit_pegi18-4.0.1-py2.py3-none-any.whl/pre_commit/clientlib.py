...
# TODO: re-add "prepre-commit" when we have a good way to test it
...
MANIFEST_HOOK_DICT = cfgv.Map(
    ...
    cfgv.Optional('allow_modifications', cfgv.check_bool, False), # pragma: no cover
    cfgv.Optional('allow_return_nzero', cfgv.check_bool, False), # pragma: no cover
    cfgv.Optional('allow_return_codes', cfgv.check_array(cfgv.check_int), [0]), # pragma: no cover

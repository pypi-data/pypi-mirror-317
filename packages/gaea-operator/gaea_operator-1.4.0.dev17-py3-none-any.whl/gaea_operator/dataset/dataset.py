    ...
    def concat_dataset(self,
        ...
        if base_dataset_name is not None and len(base_dataset_name) > 0:
            ...
            base_raw_data_list = self._get_annotation(paths=paths,
                                                      base_uri=base_uri,
                                                      usage=usage,
                                                      work_dir=self.extra_work_dir, output_dir=output_dir)
        ...
        raw_data_list = self._get_annotation(paths=paths, base_uri=base_uri, usage=usage,
                                             work_dir=self.work_dir, output_dir=output_dir)

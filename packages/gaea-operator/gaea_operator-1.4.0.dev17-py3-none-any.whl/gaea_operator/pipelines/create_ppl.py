...
if __name__ == "__main__":
    ...
    parser.add_argument("--create-base-only", type=str, default="true")
    ...
    for name, category in name_to_category.items():
        if args.create_base_only == "true" and name not in base_pipeline:
            bcelogger.info("Only create base pipeline, skip pipeline {}".format(name))
            continue

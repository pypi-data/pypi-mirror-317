    ...
    def _retrieve_online_features_table_data_exact_match(
        ...
        _response = requests.get(
            ...
            headers=_define_request_headers(
                oauth_token=oauth_token, accept_profile=self.settings_config.DATABRICKS_ACCEPT_PROFILE
            ),
            params={
                **columns_selection,
        ...
        if not _response.json():
            ...
            return {**output_dict, **{"tenure_tradie": -1, "value_cap": 149, "credit_available": 201,}}

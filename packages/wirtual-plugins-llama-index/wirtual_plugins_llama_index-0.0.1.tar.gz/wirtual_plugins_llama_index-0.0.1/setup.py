...
about = {}
with open(
    os.path.join(here, "wirtual", "plugins", "llama_index", "version.py"), "r"
) as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    description="Llama Index plugin for Wirtual Agents",
    ...
    package_data={"wirtual.plugins.llama_index": ["py.typed"]},
    project_urls={

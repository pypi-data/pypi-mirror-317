...
class MogoModel(BaseModel):
    """mogo基础类"""
    _id:str=StringConstraints(min_length=1,max_length=64)
    create_user:str=StringConstraints(None,min_length=1,max_length=50)
    update_user:str=StringConstraints(None,min_length=1,max_length=50)

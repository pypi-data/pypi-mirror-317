...
PRIDE_FLAGS = {
    ...
    "pan": ["#F7A8B8", "#FFB6D1", "#F7A8B8", "#FFD800", "#00ADEF", "#FF0A9E"],
    "asexual": ["#000000", "#A3A3A3", "#FFFFFF", "#810082"],
    "genderfluid": ["#B5A2D4", "#F47C3C", "#06A77D", "#6A4C93", "#F3A2E2"],
    "lesbian": ["#D62E00", "#FF9A56", "#FFB8B8", "#9B4F96", "#6A2D92"],
    "aromantic": ["#A8D08D", "#A8D08D", "#3A713B", "#0E2D21"],
    "intersex": ["#FFD800", "#9B4F96"],
    "two_spirit": ["#3EAEF7", "#3D59B9", "#FFD300", "#F7006A", "#F7B300", "#A31C71"],
    "queer": ["#E6007A", "#9B4F96", "#6A1D94", "#F9A8D4", "#5A0A2A"],
    "demiboy": ["#7E9BFA", "#5C7DE3", "#3A53B5"],
    "demigirl": ["#F7A8D4", "#F56BA4", "#F29AC6"],
    "transfemme": ["#F7A8B8", "#55CDFC", "#F7A8B8"],
    "transmasc": ["#55CDFC", "#F7A8B8", "#55CDFC"],
    "mlm": ["#F56DA8", "#E6007A", "#9B4F96", "#6A1D94"],
    "wlw": ["#9B4F96", "#F56DA8", "#E6007A", "#6A1D94"],

...
defaultSettings = (
    ...
    ('anthropic_vertexai_project_id', config.vertexai_project_id if hasattr(config, "vertexai_project_id") else ""),
    ('anthropic_vertexai_service_location', "us-east5"),
    ('anthropic_vertexai_model', "claude-3-5-sonnet-v2@20241022"), # claude-3-5-sonnet-v2@20241022, claude-3-5-haiku@20241022
    ('anthropic_vertexai_max_output_tokens', 8192),

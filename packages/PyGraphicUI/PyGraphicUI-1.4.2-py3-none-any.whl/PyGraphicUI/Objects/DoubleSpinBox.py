...
class DoubleSpinBoxInit(WidgetInit):
    ...
    Attributes:
        ...
        minimum_size (ObjectSize | None): The minimum size of the spin box. Defaults to None.
        maximum_size (ObjectSize | None): The maximum size of the spin box. Defaults to None.
        fixed_size (ObjectSize | None): The fixed size of the spin box. Defaults to None.
        size_policy (QSizePolicy | None): The size policy of the spin box. Defaults to None.
        graphic_effect (QGraphicsEffect | None): The graphic effect to apply to the spin box. Defaults to None.

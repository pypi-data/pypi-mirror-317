...
class WidgetInit:
    ...
    Attributes:
        ...
        minimum_size (ObjectSize | None): The minimum size of the widget. Defaults to None.
        maximum_size (ObjectSize | None): The maximum size of the widget. Defaults to None.
        fixed_size (ObjectSize | None): The fixed size of the widget. Defaults to None.
        size_policy (QSizePolicy | None): The size policy of the widget. Defaults to None.
        graphic_effect (QGraphicsEffect | None): The graphic effect to apply to the widget. Defaults to None.
    """
...
class PyWidgetWithVerticalLayout(PyWidget):
    ...
    def __init__(
        ...
        Args:
            ...
            instances (list[LinearLayoutItem] | None): a list of LinearLayoutItem objects to be added to the layout.
        """
...
class PyWidgetWithHorizontalLayout(PyWidget):
    ...
    def __init__(
        ...
        self.horizontal_layout = PyHorizontalLayout(
            layout_init=widget_with_layout_init.layout_init, instances=instances
        )
...
class PyWidgetWithGridLayout(PyWidget):
    ...
    def __init__(
        ...
        Args:
            widget_with_layout_init (WidgetWithLayoutInit): Widget and layout initialization parameters.
            instances (list[GridLayoutItem] | None): A list of GridLayoutItem objects to be added to the layout.
        """
        super().__init__(widget_init=widget_with_layout_init.widget_init)

...
class ScrollAreaInit(WidgetInit):
    ...
    Attributes:
        ...
        minimum_size (ObjectSize | None): The minimum size of the scroll area. Defaults to None.
        maximum_size (ObjectSize | None): The maximum size of the scroll area. Defaults to None.
        fixed_size (ObjectSize | None): The fixed size of the scroll area. Defaults to None.
        size_policy (QSizePolicy | None): The size policy of the scroll area. Defaults to None.
        graphic_effect (QGraphicsEffect | None): The graphic effect to apply to the scroll area. Defaults to None.
...
class PyVerticalScrollArea(QScrollArea, PyWidget):
    ...
    def __init__(
        self, scroll_area_init: ScrollAreaInit = ScrollAreaInit(), instances: list[LinearLayoutItem] | None = None
    ):
        """
        ...
        Args:
            ...
            instances (list[LinearLayoutItem] | None): A list of items to add to the scroll area content. Defaults to None.
        """
        ...
        self.vertical_scroll = PyWidgetWithVerticalLayout(
            widget_with_layout_init=scroll_area_init.central_widget_init, instances=instances
        )
    ...
    def get_all_instances(self) -> typing.Generator[QWidget | QLayout, typing.Any, None]:
        ...
        Returns:
            typing.Generator[QWidget | QLayout, typing.Any, None]: A generator yielding each widget and layout.
        """
    ...
    def get_instance(self, index: int) -> QWidget | QLayout:
        ...
        Returns:
            QWidget | QLayout: The widget at the specified index, or None if the index is out of range.
        """
...
class PyHorizontalScrollArea(QScrollArea, PyWidget):
    ...
    def __init__(
        ...
        Args:
            scroll_area_init (ScrollAreaInit): Scroll area initialization parameters.
            instances (list[LinearLayoutItem] | None): A list of items to add to the scroll area's content. Defaults to None.
        """
        super().__init__(widget_init=scroll_area_init)
    ...
    def get_instance(self, index: int) -> QWidget | QLayout:
        ...
        Returns:
            QWidget | QLayout: The instance at the given index, or None if the index is out of range.
        """
    ...
    def remove_instance(self, instance: QWidget | QLayout | int | QLayoutItem):
        ...
        Args:
            instance (QWidget | QLayout | int | QLayoutItem):  The instance to be removed from the layout.
        """
...
class GridScrollArea(QScrollArea, PyWidget):
    ...
    def __init__(
        self, scroll_area_init: ScrollAreaInit = ScrollAreaInit(), instances: list[GridLayoutItem] | None = None
    ):
        """
        Initializes a GridScrollArea.

        Args:
            scroll_area_init (ScrollAreaInit): Scroll area initialization parameters.
            instances (list[GridLayoutItem] | None): A list of GridLayoutItems to add to the scroll area content. Defaults to None.
        """
        super().__init__(widget_init=scroll_area_init)
    ...
    def get_all_instances(self) -> typing.Generator[QWidget | QLayout, typing.Any, None]:
        ...
        Returns:
            typing.Generator[QWidget | QLayout, typing.Any, None]: A generator that yields all widget and layout instances.
        """
    ...
    def get_instance(self, index: int) -> QWidget | QLayout:
        ...
        Returns:
            QWidget | QLayout: The instance at the specified index or None if the index is out of range.
        """
    ...
    def remove_instance(self, instance: QWidget | QLayout | int | QLayoutItem):
        ...
        Args:
            instance (QWidget | QLayout | int | QLayoutItem): The instance to remove. Can be a widget, layout, index, or layout item.
        """

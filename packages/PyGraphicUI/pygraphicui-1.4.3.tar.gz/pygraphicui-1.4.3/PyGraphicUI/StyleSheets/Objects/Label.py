...
class LabelStyleSheet(BaseStyleSheet):
    ...
    def __init__(self, label_style: LabelStyle | list[LabelStyle] | None = None):
        """
        Initializes a LabelStyleSheet object.

        Args:
            label_style (LabelStyle | list[LabelStyle] | None): A LabelStyle object or list of LabelStyle objects representing the styles to be applied to the QLabel objects.
        """
        super().__init__()
...
class ChainLabelStyle(BaseStyle):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            parent_css_object (ObjectOfStyle | list[ObjectOfStyle]): The style sheet object or list of objects that the style is applied to, from which the QLabel will inherit styles.
        ...
        new_parent_objects = get_new_parent_objects(
            parent_css_object, widget_selector, ("QLabel", Selector(SelectorFlag.Descendant))
        )

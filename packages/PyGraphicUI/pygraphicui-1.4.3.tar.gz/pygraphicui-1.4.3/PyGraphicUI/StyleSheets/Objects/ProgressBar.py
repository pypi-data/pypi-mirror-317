...
class ProgressBarStyleSheet(BaseStyleSheet):
    ...
    def __init__(self, progress_bar_style: ProgressBarStyle | list[ProgressBarStyle] | None = None):
        """
        Initialize a new ProgressBarStyleSheet instance.

        Args:
            progress_bar_style (ProgressBarStyle | list[ProgressBarStyle] | None): The style(s) to add to the style sheet. Defaults to None.
        """
        super().__init__()
...
class ChainProgressBarStyle(BaseStyle):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            parent_css_object (ObjectOfStyle | list[ObjectOfStyle]): The object of style for the parent widget.
        ...
        new_parent_objects = get_new_parent_objects(
            parent_css_object, widget_selector, ("QProgressBar", Selector(SelectorFlag.Descendant))
        )

...
class FontSize:
    ...
    def __init__(self, length_string: PX | PT | EM | EX):
        ...
        Args:
            length_string (PX | PT | EM | EX): The font size value.
        """
        self.font_size = ""
    ...
    def set_font_size(self, length_string: PX | PT | EM | EX):
        ...
        Args:
            length_string (PX | PT | EM | EX): The font size value to set.
...
class Font:
    ...
    def __init__(
        self, font_style: FontStyle, font_weight: FontWeight, font_size: FontSize, font_family: FontFamily = None
    ):
        """
    ...
    def set_font(
        self, font_weight: FontWeight, font_style: FontStyle, font_size: FontSize, font_family: FontFamily = None
    ):
        """
        Sets the font value.

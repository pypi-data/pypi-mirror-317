...
class TreeViewStyleSheet(BaseStyleSheet):
    ...
    def __init__(self, tree_view_style: TreeViewStyle | list[TreeViewStyle] | None = None):
        """
        Initializes a TreeViewStyleSheet object.

        Args:
            tree_view_style (TreeViewStyle | list[TreeViewStyle] | None): A TreeViewStyle object or list of  TreeViewStyle objects representing the styles to be applied to the QTreeView objects.
        """
        super().__init__()
...
class ChainTreeViewStyle(BaseStyle):
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            parent_css_object (ObjectOfStyle | list[ObjectOfStyle]): The style sheet object or list of objects that the style is applied to, from which the QTreeView will inherit styles.
        ...
        new_parent_objects = get_new_parent_objects(
            parent_css_object, widget_selector, ("QTreeView", Selector(SelectorFlag.Descendant))
        )

...
class ProgressBarInit(WidgetInit):
    ...
    Attributes:
        ...
        minimum_size (ObjectSize | None): The minimum size of the progress bar. Defaults to None.
        maximum_size (ObjectSize | None): The maximum size of the progress bar. Defaults to None.
        fixed_size (ObjectSize | None): The fixed size of the progress bar. Defaults to None.
        size_policy (QSizePolicy | None): The size policy of the progress bar. Defaults to None.
        graphic_effect (QGraphicsEffect | None): The graphic effect to apply to the progress bar. Defaults to None.
        font (QFont | None): The font to use for the progress bar text. Defaults to None.
    ...
    def __init__(
        ...
        Args:
            ...
            font (QFont | None): The font for the text.

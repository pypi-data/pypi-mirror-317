...
from deepkeep.modules.model.consts import IntegrationModels
...
class AzureOpenAI(BaseModule):
    source = IntegrationModels.Azure_OpenAI.value
    ...
    def create(self, title: str, model_framework: str, model_purpose: str, description: str = "Default description",
               ...
               output_categories: list[dict] = None, max_tokens: int = 100, temperature: float = 0.5,
               infer_path: str = "/openai/deployments", connect_path: str = "/chat/completions", **kwargs):
        """
        ...
        :param infer_path: integration models infer path
        :param connect_path: integration models connect path
        ...
        data, initialize_data = pop_keys_from_dict(arrange_locals(locals()),
                                                   ["max_tokens", "temperature", "infer_path", "connect_path"])

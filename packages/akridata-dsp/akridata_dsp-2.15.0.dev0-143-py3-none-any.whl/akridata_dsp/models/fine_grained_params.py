...
class FineGrainedParams(object):
    ...
    def slice_size(self, slice_size):
        ...
        if (self.local_vars_configuration.client_side_validation and
                slice_size is not None and slice_size > 1):  # noqa: E501
            raise ValueError("Invalid value for `slice_size`, must be a value less than or equal to `1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                slice_size is not None and slice_size < 0):  # noqa: E501
            raise ValueError("Invalid value for `slice_size`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def overlap_ratio(self, overlap_ratio):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                overlap_ratio is not None and overlap_ratio > 1):  # noqa: E501
            raise ValueError("Invalid value for `overlap_ratio`, must be a value less than or equal to `1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                overlap_ratio is not None and overlap_ratio < 0):  # noqa: E501
            raise ValueError("Invalid value for `overlap_ratio`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def border_extend_frac(self, border_extend_frac):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                border_extend_frac is not None and border_extend_frac > 1):  # noqa: E501
            raise ValueError("Invalid value for `border_extend_frac`, must be a value less than or equal to `1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                border_extend_frac is not None and border_extend_frac < 0):  # noqa: E501
            raise ValueError("Invalid value for `border_extend_frac`, must be a value greater than or equal to `0`")  # noqa: E501

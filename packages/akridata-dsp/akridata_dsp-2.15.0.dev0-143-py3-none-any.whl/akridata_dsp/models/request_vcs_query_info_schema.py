...
class RequestVCSQueryInfoSchema(object):
    ...
    def __init__(self, query_id=None, query_json=None, first_table_alias=None, num_rows=None, catalog_table_name=None, view_id=None, catalog_table_info=None, view_info=None, local_vars_configuration=None):  # noqa: E501

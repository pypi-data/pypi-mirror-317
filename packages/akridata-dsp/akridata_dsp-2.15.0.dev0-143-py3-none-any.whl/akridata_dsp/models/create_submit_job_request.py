...
class CreateSubmitJobRequest(object):
    ...
    def __init__(self, distance_metric=None, patches=None, tunables=None, job_type=None, data_source=None, src=None, request_source_meta=None, advanced_config=None, vseq_config=None, manual_labeling_config=None, saliency_map_config=None, labeling_config=None, local_vars_configuration=None):  # noqa: E501

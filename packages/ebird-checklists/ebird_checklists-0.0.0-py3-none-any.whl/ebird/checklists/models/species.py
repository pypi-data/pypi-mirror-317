...
class Species(models.Model):
    ...
    local_name = models.TextField(
        ...
        help_text=_("The species name in the local language.")
    )
    ...
    family_local_name = models.TextField(
        blank=True,
        verbose_name=_("family local name"),
        help_text=_("The family name in the local language.")
    )
    ...
    subspecies_local_name = models.TextField(
        blank=True,
        verbose_name=_("Local name"),
        help_text=_("The subspecies, group or form name in the local language.")
    )

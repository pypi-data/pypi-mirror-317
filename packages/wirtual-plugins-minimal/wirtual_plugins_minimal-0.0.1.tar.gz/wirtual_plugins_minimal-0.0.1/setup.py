...
about = {}
with open(os.path.join(here, "wirtual", "plugins", "minimal", "version.py"), "r") as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    description="Minimal plugin template for Wirtual Agents",
    ...
    install_requires=["wirtual-agents>=0.0.1"],
    package_data={"wirtual.plugins.minimal": ["py.typed"]},
    project_urls={

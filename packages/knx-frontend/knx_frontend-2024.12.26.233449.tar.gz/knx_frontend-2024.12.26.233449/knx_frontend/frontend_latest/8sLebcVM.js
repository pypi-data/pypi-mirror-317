...
export const id=3399;export const ids=[3399];export const modules={80106:(e,r,i)=>{i.d(r,{d:()=>a});const a=e=>{switch(e.language){case"cz":case"de":case"fi":case"fr":case"sk":case"sv":return" ";default:return""}}},96287:(e,r,i)=>{var a=i(85461),t=i(69534),s=(i(8774),i(98597)),n=i(196),o=i(69760),l=i(33167),d=(i(66494),i(96396),i(80106)),c=i(96041);const p="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",m="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M13.5,16V19H10.5V16H8L12,12L16,16H13.5M13,9V3.5L18.5,9H13Z";(0,a.A)([(0,n.EM)("ha-file-upload")],(function(e,r){class i extends r{constructor(...r){super(...r),e(this)}}return{F:i,d:[{kind:"field",decorators:[(0,n.MZ)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,n.MZ)()],key:"accept",value:void 0},{kind:"field",decorators:[(0,n.MZ)()],key:"icon",value:void 0},{kind:"field",decorators:[(0,n.MZ)()],key:"label",value:void 0},{kind:"field",decorators:[(0,n.MZ)()],key:"secondary",value:void 0},{kind:"field",decorators:[(0,n.MZ)()],key:"supports",value:void 0},{kind:"field",decorators:[(0,n.MZ)({type:Object})],key:"value",value:void 0},{kind:"field",decorators:[(0,n.MZ)({type:Boolean})],key:"multiple",value(){return!1}},{kind:"field",decorators:[(0,n.MZ)({type:Boolean,reflect:!0})],key:"disabled",value(){return!1}},{kind:"field",decorators:[(0,n.MZ)({type:Boolean})],key:"uploading",value(){return!1}},{kind:"field",decorators:[(0,n.MZ)({type:Number})],key:"progress",value:void 0},{kind:"field",decorators:[(0,n.MZ)({type:Boolean,attribute:"auto-open-file-dialog"})],key:"autoOpenFileDialog",value(){return!1}},{kind:"field",decorators:[(0,n.wk)()],key:"_drag",value(){return!1}},{kind:"field",decorators:[(0,n.P)("#input")],key:"_input",value:void 0},{kind:"method",key:"firstUpdated",value:function(e){(0,t.A)(i,"firstUpdated",this,3)([e]),this.autoOpenFileDialog&&this._openFilePicker()}},{kind:"method",key:"render",value:function(){return s.qy`
      ${this.uploading?s.qy`<div class="container">
            <div class="row">
              ...
              >
              ${this.progress?s.qy`<span class="progress"
            ...
            class="container ${(0,o.H)({dragged:this._drag,multiple:this.multiple,value:Boolean(this.value)})}"
            @drop=${this._handleDrop}
            @dragenter=${this._handleDragStart}
            @dragover=${this._handleDragStart}
            @dragleave=${this._handleDragEnd}
            @dragend=${this._handleDragEnd}
            >${this.value?"string"==typeof this.value?s.qy`<div class="row">
                    ...
                    <ha-icon-button
                      ...
                      .path=${p}
                    ></ha-icon-button>
                  </div>`:(this.value instanceof FileList?Array.from(this.value):(0,c.e)(this.value)).map((e=>s.qy`<div class="row">
                        <div class="value" @click=${this._openFilePicker}>
                          <ha-svg-icon
                            .path=${this.icon||m}
                          ></ha-svg-icon>
                          ${e.name} - ${((e=0,r=2)=>{if(0===e)return"0 Bytes";r=r<0?0:r;const i=Math.floor(Math.log(e)/Math.log(1024));return`${parseFloat((e/1024**i).toFixed(r))} ${["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"][i]}`})(e.size)}
                        </div>
                        <ha-icon-button
                          @click=${this._clearValue}
                          .label=${this.hass?.localize("ui.common.delete")||"Delete"}
          ...
          /></label>`}
    `}},{kind:"method",key:"_openFilePicker",value:function(){this._input?.click()}},{kind:"method",key:"_handleDrop",value:function(e){e.preventDefault(),e.stopPropagation(),e.dataTransfer?.files&&(0,l.r)(this,"file-picked",{files:this.multiple||1===e.dataTransfer.files.length?Array.from(e.dataTransfer.files):[e.dataTransfer.files[0]]}),this._drag=!1}},{kind:"method",key:"_handleDragStart",value:function(e){e.preventDefault(),e.stopPropagation(),this._drag=!0}},{kind:"method",key:"_handleDragEnd",value:function(e){e.preventDefault(),e.stopPropagation(),this._drag=!1}},{kind:"method",key:"_handleFilePicked",value:function(e){0!==e.target.files.length&&(this.value=e.target.files,(0,l.r)(this,"file-picked",{files:e.target.files}))}},{kind:"method",key:"_clearValue",value:function(e){e.preventDefault(),this._input.value="",this.value=void 0,(0,l.r)(this,"change")}},{kind:"get",static:!0,key:"styles",value:function(){return s.AH`
      :host {
        display: block;
        height: 240px;
      }
    ...
    `}}]}}),s.WF)},47385:(e,r,i)=>{var a=i(85461),t=i(98597),s=i(196),n=i(33167),o=i(43799),l=i(10377),d=i(31447);const c=()=>Promise.all([i.e(4857),i.e(2e3)]).then(i.bind(i,12e3));i(66494),i(73279),i(96287);(0,a.A)([(0,s.EM)("ha-picture-upload")],(function(e,r){return{F:class extends r{constructor(...r){super(...r),e(this)}},d:[{kind:"field",key:"hass",value:void 0},{kind:"field",decorators:[(0,s.MZ)()],key:"value",value(){return null}},{kind:"field",decorators:[(0,s.MZ)()],key:"label",value:void 0},{kind:"field",decorators:[(0,s.MZ)()],key:"secondary",value:void 0},{kind:"field",decorators:[(0,s.MZ)()],key:"supports",value:void 0},{kind:"field",decorators:[(0,s.MZ)()],key:"currentImageAltText",value:void 0},{kind:"field",decorators:[(0,s.MZ)({type:Boolean})],key:"crop",value(){return!1}},{kind:"field",decorators:[(0,s.MZ)({attribute:!1})],key:"cropOptions",value:void 0},{kind:"field",decorators:[(0,s.MZ)({type:Boolean})],key:"original",value(){return!1}},{kind:"field",decorators:[(0,s.MZ)({type:Number})],key:"size",value(){return 512}},{kind:"field",decorators:[(0,s.wk)()],key:"_uploading",value(){return!1}},{kind:"method",key:"render",value:function(){return this.value?t.qy`<div class="center-vertical">
      <div class="value">
        <img
          .src=${this.value}
        ...
        ></ha-file-upload>
      `}},{kind:"method",key:"_handleChangeClick",value:function(){this.value=null,(0,n.r)(this,"change")}},{kind:"method",key:"_handleFilePicked",value:async function(e){const r=e.detail.files[0];this.crop?this._cropFile(r):this._uploadFile(r)}},{kind:"method",key:"_handleFileCleared",value:async function(){this.value=null}},{kind:"method",key:"_cropFile",value:async function(e){var r,i;["image/png","image/jpeg","image/gif"].includes(e.type)?(r=this,i={file:e,options:this.cropOptions||{round:!1,aspectRatio:NaN},croppedCallback:e=>{this._uploadFile(e)}},(0,n.r)(r,"show-dialog",{dialogTag:"image-cropper-dialog",dialogImport:c,dialogParams:i})):(0,d.K$)(this,{text:this.hass.localize("ui.components.picture-upload.unsupported_format")})}},{kind:"method",key:"_uploadFile",value:async function(e){if(["image/png","image/jpeg","image/gif"].includes(e.type)){this._uploading=!0;try{const r=await(0,l.mF)(this.hass,e);this.value=(0,l.Q0)(r.id,this.size,this.original),(0,n.r)(this,"change")}catch(r){(0,d.K$)(this,{text:r.toString()})}finally{this._uploading=!1}}else(0,d.K$)(this,{text:this.hass.localize("ui.components.picture-upload.unsupported_format")})}},{kind:"get",static:!0,key:"styles",value:function(){return[o.RF,t.AH`
        :host {
          display: block;
          height: 240px;
        }
      ...
      <div>
        ...
        ${this.showUpload?s.qy`
              <ha-picture-upload
                .hass=${this.hass}
                .value=${this.value?.startsWith(l.fO)?this.value:null}
    ...
    `}},{kind:"method",key:"_radioGroupPicked",value:function(e){this.showUpload="upload"===e.target.value}},{kind:"method",key:"_pictureChanged",value:function(e){const r=e.target.value;(0,o.r)(this,"value-changed",{value:r??void 0})}},{kind:"method",key:"_handleChange",value:function(e){let r=e.target.value;this.value!==r&&(""!==r||this.required||(r=void 0),(0,o.r)(this,"value-changed",{value:r}))}},{kind:"get",static:!0,key:"styles",value:function(){return s.AH`
      :host {
        display: block;
        position: relative;
      }

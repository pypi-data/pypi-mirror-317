export const id=810;export const ids=[810];export const modules={67905:(e,t,i)=>{i.d(t,{I:()=>n});class s{constructor(e=window.localStorage){this.storage=void 0,this._storage={},this._listeners={},this.storage=e,e===window.localStorage&&window.addEventListener("storage",(e=>{e.key&&this.hasKey(e.key)&&(this._storage[e.key]=e.newValue?JSON.parse(e.newValue):e.newValue,this._listeners[e.key]&&this._listeners[e.key].forEach((t=>t(e.oldValue?JSON.parse(e.oldValue):e.oldValue,this._storage[e.key]))))}))}addFromStorage(e){if(!this._storage[e]){const t=this.storage.getItem(e);t&&(this._storage[e]=JSON.parse(t))}}subscribeChanges(e,t){return this._listeners[e]?this._listeners[e].push(t):this._listeners[e]=[t],()=>{this.unsubscribeChanges(e,t)}}unsubscribeChanges(e,t){if(!(e in this._listeners))return;const i=this._listeners[e].indexOf(t);-1!==i&&this._listeners[e].splice(i,1)}hasKey(e){return e in this._storage}getValue(e){return this._storage[e]}setValue(e,t){const i=this._storage[e];this._storage[e]=t;try{void 0===t?this.storage.removeItem(e):this.storage.setItem(e,JSON.stringify(t))}catch(s){}finally{this._listeners[e]&&this._listeners[e].forEach((e=>e(i,t)))}}}const o={},n=e=>t=>{const i=e.storage||"localStorage";let n;i&&i in o?n=o[i]:(n=new s(window[i]),o[i]=n);const a=String(t.key),r=e.key||String(t.key),d=t.initializer?t.initializer():void 0;n.addFromStorage(r);const l=!1!==e.subscribe?e=>n.subscribeChanges(r,((i,s)=>{e.requestUpdate(t.key,i)})):void 0,c=()=>n.hasKey(r)?e.deserializer?e.deserializer(n.getValue(r)):n.getValue(r):d;return{kind:"method",placement:"prototype",key:t.key,descriptor:{set(i){((i,s)=>{let o;e.state&&(o=c()),n.setValue(r,e.serializer?e.serializer(s):s),e.state&&i.requestUpdate(t.key,o)})(this,i)},get(){return c()},enumerable:!0,configurable:!0},finisher(i){if(e.state&&e.subscribe){const e=i.prototype.connectedCallback,t=i.prototype.disconnectedCallback;i.prototype.connectedCallback=function(){e.call(this),this[`__unbsubLocalStorage${a}`]=l?.(this)},i.prototype.disconnectedCallback=function(){t.call(this),this[`__unbsubLocalStorage${a}`]?.(),this[`__unbsubLocalStorage${a}`]=void 0}}e.state&&i.createProperty(t.key,{noAccessor:!0,...e.stateOptions})}}}},80920:(e,t,i)=>{var s=i(85461),o=i(69534),n=(i(27350),i(98597)),a=i(196),r=i(10),d=i(22994);(0,s.A)([(0,a.EM)("ha-button-menu")],(function(e,t){class i extends t{constructor(...t){super(...t),e(this)}}return{F:i,d:[{kind:"field",key:d.Xr,value:void 0},{kind:"field",decorators:[(0,a.MZ)()],key:"corner",value(){return"BOTTOM_START"}},{kind:"field",decorators:[(0,a.MZ)()],key:"menuCorner",value(){return"START"}},{kind:"field",decorators:[(0,a.MZ)({type:Number})],key:"x",value(){return null}},{kind:"field",decorators:[(0,a.MZ)({type:Number})],key:"y",value(){return null}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"multi",value(){return!1}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"activatable",value(){return!1}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"disabled",value(){return!1}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"fixed",value(){return!1}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean,attribute:"no-anchor"})],key:"noAnchor",value(){return!1}},{kind:"field",decorators:[(0,a.P)("mwc-menu",!0)],key:"_menu",value:void 0},{kind:"get",key:"items",value:function(){return this._menu?.items}},{kind:"get",key:"selected",value:function(){return this._menu?.selected}},{kind:"method",key:"focus",value:function(){this._menu?.open?this._menu.focusItemAtIndex(0):this._triggerButton?.focus()}},{kind:"method",key:"render",value:function(){return n.qy`
      ...
      >
        <ha-dialog-header slot="heading">
          ...
          <div slot="title">
            ...
            >
              ...
              ${this._pipelines?.map((e=>n.qy`<ha-list-item
                  ...
                  >
                    ${e.name}${e.id===this._preferredPipeline?n.qy`
                          <ha-svg-icon
                            slot="meta"
              ...
              ${this.hass.user?.is_admin?n.qy`<li divider role="separator"></li>
          ...
          <a
            href=${(0,p.o)(this.hass,"/docs/assist/")}
            slot="actionItems"
            target="_blank"
        ...
        <div class="messages">
          <div class="messages-container" id="scroll-container">
            ${this._conversation.map((e=>n.qy`
                <div class=${this._computeMessageClasses(e)}>${e.text}</div>
              `))}
          </div>
        </div>
          ...
          >
            <span slot="trailingIcon">
              ${this._showSendButton||!i?n.qy`
                  ...
                  `:n.qy`
                    ${this._audioRecorder?.active?n.qy`
                          <div class="bouncer">
    ...
    `}},{kind:"method",key:"willUpdate",value:function(e){(e.has("_pipelineId")||e.has("_opened")&&!0===this._opened)&&this._getPipeline()}},{kind:"method",key:"_getPipeline",value:async function(){try{this._pipelinePromise=(0,c.mp)(this.hass,this._pipelineId),this._pipeline=await this._pipelinePromise}catch(e){"not_found"===e.code&&(this._pipelineId=void 0)}}},{kind:"method",key:"_loadPipelines",value:async function(){if(this._pipelines)return;const{pipelines:e,preferred_pipeline:t}=await(0,c.nx)(this.hass);this._pipelines=e,this._preferredPipeline=t||void 0}},{kind:"method",key:"_selectPipeline",value:async function(e){this._pipelineId=e.currentTarget.pipeline,this._conversation=[{who:"hass",text:this.hass.localize("ui.dialogs.voice_command.how_can_i_help")}],await this.updateComplete,this._scrollMessagesBottom()}},{kind:"method",key:"updated",value:function(e){(0,o.A)(i,"updated",this,3)([e]),(e.has("_conversation")||e.has("results"))&&this._scrollMessagesBottom()}},{kind:"method",key:"_addMessage",value:function(e){this._conversation=[...this._conversation,e]}},{kind:"method",key:"_handleKeyUp",value:function(e){const t=e.target;"Enter"===e.key&&t.value&&(this._processText(t.value),t.value="",this._showSendButton=!1)}},{kind:"method",key:"_handleInput",value:function(e){const t=e.target.value;t&&!this._showSendButton?this._showSendButton=!0:!t&&this._showSendButton&&(this._showSendButton=!1)}},{kind:"method",key:"_handleSendMessage",value:function(){this._messageInput.value&&(this._processText(this._messageInput.value.trim()),this._messageInput.value="",this._showSendButton=!1)}},{kind:"method",key:"_processText",value:async function(e){this._audio?.pause(),this._addMessage({who:"user",text:e});const t={who:"hass",text:"…"};this._addMessage(t);try{const i=await(0,c.vU)(this.hass,(e=>{if("intent-end"===e.type){this._conversationId=e.data.intent_output.conversation_id;const s=e.data.intent_output.response.speech?.plain;s&&(t.text=s.speech),this.requestUpdate("_conversation"),i()}"error"===e.type&&(t.text=e.data.message,t.error=!0,this.requestUpdate("_conversation"),i())}),{start_stage:"intent",input:{text:e},end_stage:"intent",pipeline:this._pipeline?.id,conversation_id:this._conversationId})}catch{t.text=this.hass.localize("ui.dialogs.voice_command.error"),t.error=!0,this.requestUpdate("_conversation")}}},{kind:"method",key:"_handleListeningButton",value:function(e){e.stopPropagation(),e.preventDefault(),this._toggleListening()}},{kind:"method",key:"_toggleListening",value:function(){u.isSupported?this._audioRecorder?.active?this._stopListening():this._startListening():this._showNotSupportedMessage()}},{kind:"method",key:"_showNotSupportedMessage",value:async function(){this._addMessage({who:"hass",text:n.qy`${this.hass.localize("ui.dialogs.voice_command.not_supported_microphone_browser")}
      ...
      `]}}]}}),n.WF)},18168:(e,t,i)=>{e.exports=i.p+"18168-eFEjbRoE_Rg.js"}};
//# sourceMappingURL=wJIwTL_6.js.map
export const id=8957;export const ids=[8957];export const modules={28957:(t,e,i)=>{i.r(e),i.d(e,{HaMediaSelector:()=>u});var a=i(85461),s=i(98597),o=i(196),d=i(69760),l=i(33167),n=i(60222),r=i(61792),c=i(93728),m=i(47424);i(91074),i(93259);const h=[{name:"media_content_id",required:!1,selector:{text:{}}},{name:"media_content_type",required:!1,selector:{text:{}}}];let u=(0,a.A)([(0,o.EM)("ha-selector-media")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[(0,o.MZ)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,o.MZ)({attribute:!1})],key:"selector",value:void 0},{kind:"field",decorators:[(0,o.MZ)({attribute:!1})],key:"value",value:void 0},{kind:"field",decorators:[(0,o.MZ)()],key:"label",value:void 0},{kind:"field",decorators:[(0,o.MZ)()],key:"helper",value:void 0},{kind:"field",decorators:[(0,o.MZ)({type:Boolean,reflect:!0})],key:"disabled",value(){return!1}},{kind:"field",decorators:[(0,o.MZ)({type:Boolean,reflect:!0})],key:"required",value(){return!0}},{kind:"field",decorators:[(0,o.wk)()],key:"_thumbnailUrl",value:void 0},{kind:"method",key:"willUpdate",value:function(t){if(t.has("value")){const e=this.value?.metadata?.thumbnail,i=t.get("value")?.metadata?.thumbnail;if(e===i)return;e&&e.startsWith("/")?(this._thumbnailUrl=void 0,(0,r.e0)(this.hass,e).then((t=>{this._thumbnailUrl=t.path}))):e&&e.startsWith("https://brands.home-assistant.io")?this._thumbnailUrl=(0,m.MR)({domain:(0,m.a_)(e),type:"icon",useFallback:!0,darkOptimized:this.hass.themes?.darkMode}):this._thumbnailUrl=e}}},{kind:"method",key:"render",value:function(){const t=this.value?.entity_id?this.hass.states[this.value.entity_id]:void 0,e=!this.value?.entity_id||t&&(0,n.$)(t,c.vj.BROWSE_MEDIA);return s.qy`<ha-entity-picker
        .hass=${this.hass}
      ...
      ${e?s.qy`<ha-card
          ...
          >
            <div
              class="thumbnail ${(0,d.H)({portrait:!!this.value?.metadata?.media_class&&"portrait"===c.EC[this.value.metadata.children_media_class||this.value.metadata.media_class].thumbnail_ratio})}"
            >
              ${this.value?.metadata?.thumbnail?s.qy`
                    <div
                      class="${(0,d.H)({"centered-image":!!this.value.metadata.media_class&&["app","directory"].includes(this.value.metadata.media_class)})}
                        image"
                  ...
                  `:s.qy`
                    <div class="icon-holder image">
                      <ha-svg-icon
                        class="folder"
                        .path=${this.value?.media_content_id?this.value?.metadata?.media_class?c.EC["directory"===this.value.metadata.media_class&&this.value.metadata.children_media_class||this.value.metadata.media_class].icon:"M19 3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.89 20.1 3 19 3M10 16V8L15 12":"M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"}
                      ></ha-svg-icon>
                    </div>
                  `}
            </div>
            ...
            ></ha-form>`}`}},{kind:"field",key:"_computeLabelCallback",value(){return t=>this.hass.localize(`ui.components.selectors.media.${t.name}`)}},{kind:"method",key:"_entityChanged",value:function(t){t.stopPropagation(),(0,l.r)(this,"value-changed",{value:{entity_id:t.detail.value,media_content_id:"",media_content_type:""}})}},{kind:"method",key:"_pickMedia",value:function(){var t,e;t=this,e={action:"pick",entityId:this.value.entity_id,navigateIds:this.value.metadata?.navigateIds,mediaPickedCallback:t=>{(0,l.r)(this,"value-changed",{value:{...this.value,media_content_id:t.item.media_content_id,media_content_type:t.item.media_content_type,metadata:{title:t.item.title,thumbnail:t.item.thumbnail,media_class:t.item.media_class,children_media_class:t.item.children_media_class,navigateIds:t.navigateIds?.map((t=>({media_content_type:t.media_content_type,media_content_id:t.media_content_id})))}}})}},(0,l.r)(t,"show-dialog",{dialogTag:"dialog-media-player-browse",dialogImport:()=>Promise.all([i.e(480),i.e(4538),i.e(5426),i.e(2293)]).then(i.bind(i,92293)),dialogParams:e})}},{kind:"get",static:!0,key:"styles",value:function(){return s.AH`
      ha-entity-picker {
        display: block;
        margin-bottom: 16px;
      }

...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_forecast/paginators/)
...
if TYPE_CHECKING:
    _ListExplainabilitiesPaginatorBase = AioPaginator[ListExplainabilitiesResponseTypeDef]
else:
    _ListExplainabilitiesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListExplainabilitiesPaginator(_ListExplainabilitiesPaginatorBase):
    ...
    ) -> AioPageIterator[ListExplainabilitiesResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListExplainabilityExportsPaginatorBase = AioPaginator[ListExplainabilityExportsResponseTypeDef]
else:
    _ListExplainabilityExportsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListExplainabilityExportsPaginator(_ListExplainabilityExportsPaginatorBase):
    ...
    ) -> AioPageIterator[ListExplainabilityExportsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListForecastExportJobsPaginatorBase = AioPaginator[ListForecastExportJobsResponseTypeDef]
else:
    _ListForecastExportJobsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListForecastExportJobsPaginator(_ListForecastExportJobsPaginatorBase):
    ...
    ) -> AioPageIterator[ListForecastExportJobsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListForecastsPaginatorBase = AioPaginator[ListForecastsResponseTypeDef]
else:
    _ListForecastsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListForecastsPaginator(_ListForecastsPaginatorBase):
    ...
    ) -> AioPageIterator[ListForecastsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListMonitorEvaluationsPaginatorBase = AioPaginator[ListMonitorEvaluationsResponseTypeDef]
else:
    _ListMonitorEvaluationsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListMonitorEvaluationsPaginator(_ListMonitorEvaluationsPaginatorBase):
    ...
    ) -> AioPageIterator[ListMonitorEvaluationsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListPredictorBacktestExportJobsPaginatorBase = AioPaginator[
        ListPredictorBacktestExportJobsResponseTypeDef
    ]
else:
    _ListPredictorBacktestExportJobsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListPredictorBacktestExportJobsPaginator(_ListPredictorBacktestExportJobsPaginatorBase):
    ...
    ) -> AioPageIterator[ListPredictorBacktestExportJobsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListPredictorsPaginatorBase = AioPaginator[ListPredictorsResponseTypeDef]
else:
    _ListPredictorsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListPredictorsPaginator(_ListPredictorsPaginatorBase):
    ...
    ) -> AioPageIterator[ListPredictorsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListWhatIfAnalysesPaginatorBase = AioPaginator[ListWhatIfAnalysesResponseTypeDef]
else:
    _ListWhatIfAnalysesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListWhatIfAnalysesPaginator(_ListWhatIfAnalysesPaginatorBase):
    ...
    ) -> AioPageIterator[ListWhatIfAnalysesResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListWhatIfForecastExportsPaginatorBase = AioPaginator[ListWhatIfForecastExportsResponseTypeDef]
else:
    _ListWhatIfForecastExportsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListWhatIfForecastExportsPaginator(_ListWhatIfForecastExportsPaginatorBase):
    ...
    ) -> AioPageIterator[ListWhatIfForecastExportsResponseTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListWhatIfForecastsPaginatorBase = AioPaginator[ListWhatIfForecastsResponseTypeDef]
else:
    _ListWhatIfForecastsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListWhatIfForecastsPaginator(_ListWhatIfForecastsPaginatorBase):
    ...
    ) -> AioPageIterator[ListWhatIfForecastsResponseTypeDef]:
        """

...
from dguard.asr.aliasr.frontends.wav_frontend import WavFrontend
from dguard.asr.aliasr.tokenizer.sentencepiece_tokenizer import SentencepiecesTokenizer
...
class AutoModel:
    ...
    def __init__(self, **kwargs):
        ...
        try:
            from dguard.asr.aliasr.utils.version_checker import check_for_update

            check_for_update(disable=kwargs.get("disable_update", True))
        except:
            pass
        ...
        cb_kwargs = (
            {}
            if spk_kwargs.get("cb_kwargs", {}) is None
            else spk_kwargs.get("cb_kwargs", {})
        )

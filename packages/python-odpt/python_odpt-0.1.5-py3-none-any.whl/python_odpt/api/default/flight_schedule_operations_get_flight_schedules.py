...
from ...models.flight_schedule import FlightSchedule
...
) -> Optional[Union[Any, List["FlightSchedule"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["FlightSchedule"]]]:
    return Response(

...
from ...models.busstop_pole import BusstopPole
...
def _get_kwargs(
    *,
    ...
    params["odpt:busstopPoleNumber"] = odptbusstop_pole_number

    params["odpt:platformNumber"] = odptplatform_number

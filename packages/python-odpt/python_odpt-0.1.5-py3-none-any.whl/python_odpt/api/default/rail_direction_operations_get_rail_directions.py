...
from ...models.rail_direction import RailDirection
...
) -> Optional[Union[Any, List["RailDirection"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["RailDirection"]]]:
    return Response(

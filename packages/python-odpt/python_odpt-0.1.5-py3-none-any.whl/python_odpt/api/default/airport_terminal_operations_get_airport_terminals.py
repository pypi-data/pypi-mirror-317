...
from ...models.airport_terminal import AirportTerminal
...
def _get_kwargs(
    *,
    ...
    odptairport: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    params["odpt:airport"] = odptairport

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/odpt:AirportTerminal",
        "params": params,
    }
...
) -> Optional[Union[Any, List["AirportTerminal"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["AirportTerminal"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['AirportTerminal']]
    """

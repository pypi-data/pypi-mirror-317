...
from ...models.passenger_survey import PassengerSurvey
...
) -> Optional[Union[Any, List["PassengerSurvey"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["PassengerSurvey"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['PassengerSurvey']]
    """

...
from ...models.station_timetable import StationTimetable
...
def _get_kwargs(
    *,
    ...
    params["odpt:station"] = odptstation

    params["odpt:railway"] = odptrailway

    params["odpt:operator"] = odptoperator

    params["odpt:railDirection"] = odptrail_direction
...
) -> Optional[Union[Any, List["StationTimetable"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["StationTimetable"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['StationTimetable']]
    """

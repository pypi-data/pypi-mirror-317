...
def recortar_video(ruta_video):
    ...
    inicio_recorte = 0.13  # Recortar 13 milésimas de segundo del inicio
    final_recorte = 0.15  # Recortar 15 milésimas de segundo del final
    ...
    # Ruta temporal para guardar el archivo recortado
    temp_output_path = "temp_" + os.path.basename(ruta_video)

    # Guardar el nuevo video sin recomprimir
    nuevo_clip.write_videofile(
        temp_output_path, 
        codec="copy",  # Copia los datos de video sin recomprimir
        audio_codec="copy"  # Copia los datos de audio sin recomprimir
    )

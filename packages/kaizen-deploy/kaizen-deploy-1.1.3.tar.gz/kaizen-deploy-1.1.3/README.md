...
[![kaizen-deploy](https://img.shields.io/static/v1?label=gandalf-cmt&message=v1.1.3&color=yellowgreen)](https://pypi.org/project/kaizen-deploy/)
[![release](https://img.shields.io/static/v1?label=release&message=v1.1.3&color=orange)](https://pypi.org/project/kaizen-deploy/1.1.3/)

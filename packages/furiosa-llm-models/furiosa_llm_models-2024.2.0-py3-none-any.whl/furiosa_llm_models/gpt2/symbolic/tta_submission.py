...
# FuriosaAI: fix
def get_prefill_attn_weights(
    attn_weights: torch.Tensor, causal_mask: Optional[torch.Tensor] = None
) -> torch.Tensor:
    return attn_weights + causal_mask  # in prefill, causal_mask is used as a mask
...
# FuriosaAI: fix
# from ...gptj.paged_attention_optimized_packed_rope.make_causal_mask
def make_causal_mask(
    mask: torch.Tensor,
    dtype: torch.dtype,
    device: torch.device,
):
    # TODO: Proxy has dim = 2?
...
def load_tf_weights_in_gpt2(model, config, gpt2_checkpoint_path):
    ...
    try:
        ...
        logger.error(
            "Loading a TensorFlow model in PyTorch, requires TensorFlow to be installed. Please see "  # noqa: E501
...
class GPT2Attention(nn.Module):
    ...
    def _attn(
        self, query, key, value, is_prefill, attention_mask=None, causal_mask=None, head_mask=None
    ):
        ...
        #     mask_value = torch.full([], mask_value, dtype=attn_weights.dtype).to(attn_weights.device)  # noqa: E501
        #     attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)  # noqa: E501

        # FuriosaAI: fix
        if is_prefill:
            attn_weights = get_prefill_attn_weights(attn_weights, causal_mask)
        else:
        ...
        if head_mask is not None:
            raise NotImplementedError("head_mask should be None for now")
...
class GPT2PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        #   > the weights of residual layers at initialization by a factor of 1/√N where N is the # of residual layers.  # noqa: E501
...
@add_start_docstrings(
    "The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top.",  # noqa: E501
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        warnings.warn(
            "`GPT2Model.parallelize` is deprecated and will be removed in v5 of Transformers, you should load your"  # noqa: E501
    ...
    def forward(
        ...
        if input_ids is not None and inputs_embeds is not None:
            ...
            batch_size = inputs_embeds.shape[0]  # noqa: F841
        ...
        for i, block in enumerate(self.h):
            ...
            if self.model_parallel:
                ...
                if layer_past is not None:  # noqa: F821
                    layer_past = tuple(  # noqa: F841
                        past_state.to(hidden_states.device)
                        for past_state in layer_past  # noqa: F821
                    )
...
class GPT2LMHeadModel(GPT2PreTrainedModel, CausalLMSymbolicTrace):
    ...
    def parallelize(self, device_map=None):
        warnings.warn(
            "`GPT2LMHeadModel.parallelize` is deprecated and will be removed in v5 of Transformers, you should load"  # noqa: E501
            " your model with `device_map='balanced'` in the call to `from_pretrained`. You can also provide your own"  # noqa: E501
            " `device_map` but it needs to be a dictionary module_name to device, so for instance {'transformer.h.0':"  # noqa: E501
            " 0, 'transformer.h.1': 1, ...}",
            FutureWarning,
        )
        self.device_map = (
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        warnings.warn(
            "`GPT2DoubleHeadsModel.parallelize` is deprecated and will be removed in v5 of Transformers, you should"  # noqa: E501
            " load your model with `device_map='balanced'` in the call to `from_pretrained`. You can also provide your"  # noqa: E501
            " own `device_map` but it needs to be a dictionary module_name to device, so for instance"  # noqa: E501
    ...
    def forward(
        ...
        if self.config.pad_token_id is None:
            ...
            if input_ids is not None:
                ...
                sequence_lengths = -1
                logger.warning(
                    f"{self.__class__.__name__} will not detect padding tokens in `inputs_embeds`. Results may be "  # noqa: E501

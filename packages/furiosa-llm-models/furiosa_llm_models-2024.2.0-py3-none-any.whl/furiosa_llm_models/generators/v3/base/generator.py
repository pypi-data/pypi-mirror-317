...
class GeneratorForDecoderOnlyModels(BaseGenerator):
    ...
    def _generate(
        ...
        **model_kwargs: Dict,
        ...
        pad_token_id = generation_config.pad_token_id or self.model.config.pad_token_id
        eos_token_id = generation_config.eos_token_id or self.model.config.eos_token_id

...
from ...gptj.kv_caching import kv_page_update_do_input_select_with_past_kv_indices_verify
...
class NewLlamaAttention(FastLlamaAttention):
    def forward(
        ...
        sp_len: int = 1,
        kv_update_method: Callable = kv_page_update_do_input_select_with_past_kv_indices_verify,
    ) -> Tuple[torch.Tensor]:
...
class LlamaPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["NewLlamaDecoderLayer", "NewLlamaDecoderLayerLast"]
